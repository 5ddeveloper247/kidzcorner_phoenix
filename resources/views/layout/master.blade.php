...
<body>
    ...
    <div id="exitPopup"
        ...
        <div class="w-[60vw] relative h-[40vw] bg-contain bg-no-repeat bg-center flex flex-col justify-center items-center rounded-lg "
            ...
            <p class="text-[2vw] text-white stroke ">Are you sure you want to exit?</p>
            <div class="flex justify-around items-center w-[30vw] mt-[2vw]">
                <a href="#" id="exitNo"
                    class="text-[#59967D] text-[3vw]  stroke hover:scale-110 transition-transform cursor-pointer">No</a>
                <a href="#" id="exitYes"
                    class="text-[#F8473A] text-[3vw]  stroke hover:scale-110 transition-transform cursor-pointer">Yes</a>
            </div>
