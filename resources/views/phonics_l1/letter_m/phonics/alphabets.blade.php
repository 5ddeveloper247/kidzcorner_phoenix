...
@section('content')
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_m/milk.png') }}" class="w-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">m</span>ilk</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">m</span>onkey</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">m</span>oon</h1>
        </div>
