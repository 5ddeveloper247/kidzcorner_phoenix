...
@section('content')
    ...
    <div class="phonics-panel info-panel-2 space-y-[2vw]">
        <div class="flex flex-col items-center relative justify-between h-[25vw]">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_m/moon.png') }}"
                class="w-[15vw] absolute  left-0 rotate-[20deg]" />
            <div class="text-center text-white text-[2.8vw]">
                <h3>moon' begins with /m/.</h3>
                <h3>'moon' begins with /m/.</h3>
                <h3>'moon' begins with /m/ /m/ /m/.</h3>
                <h3>'moon' begins with /m/.</h3>
    ...
    <div class="phonics-panel info-panel-9 flex flex-col items-center h-[80%] justify-between self-end">
        ...
        <p class="p-note">Tips: Use this Song Chart with the song. Substitute with other words beginning with the /m/ sound.
            <br>
    ...
    <div class="phonics-panel info-panel-3 flex flex-col items-center justify-between">
        <h2 class="top-title stroke">I’ve got the Letter ‘m’</h2>
    ...
    <div class="phonics-panel info-panel-6 flex flex-col justify-between h-full">
        ...
        <div class="flex flex-col items-center relative">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_m/monkeys.png') }}" class="h-[10vw]" />
        </div>
        <div class="text-center text-white text-[2.5vw]">
