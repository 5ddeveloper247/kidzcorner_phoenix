    ...
    @section('content')
        ...
        <div class="phonics-panel info-panel-1 flex flex-col mt-[-2vw] gap-y-[2vw]">
            ...
            <div class="flex items-start">
                <div class="flex flex-col justify-around h-100">
                    ...
                    <p class="text-white">Adams, M.J. (1990). Beginning to Read: Thinking and Learning About Print.
        ...
        <div class="phonics-panel info-panel-2 flex flex-col items-center h-full justify-between">
            <img src="{{ asset('assets/images/phonicsl1/letter_a/a1.gif') }}" class="w-[18vw] h-[20vw]" />
