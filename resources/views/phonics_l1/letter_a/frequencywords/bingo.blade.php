...
@section('content')
    ...
    <div class="phonics-panel info-panel-1 ">
        <img src="{{ asset('assets/images/phonicsl1/letter_a/bs-1.png') }}" class="w-[40vw]">
    </div>
    ...
    <div class="phonics-panel info-panel-1 flex flex-col items-center h-full justify-between ">
        <img src="{{ asset('assets/images/phonicsl1/letter_a/bs-ans1.png') }}" class="w-[40vw]">
    ...
    <div class="phonics-panel info-panel-2 ">
        <img src="{{ asset('assets/images/phonicsl1/letter_a/bs-2.png') }}" class="w-[40vw]">
    </div>
    ...
    <div class="phonics-panel info-panel-2 flex flex-col items-center h-full justify-between ">
        <img src="{{ asset('assets/images/phonicsl1/letter_a/bs-ans2.png') }}" class="w-[40vw]">
        <p class="p-note">Tip: Ask children to shout "Bingo" and to draw a line across the 3 words that appear in a straight
            line.</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_a') }}?view=words";
            const doneURL = "{{ url('/phonics_l1/letter_a') }}?view=words";
