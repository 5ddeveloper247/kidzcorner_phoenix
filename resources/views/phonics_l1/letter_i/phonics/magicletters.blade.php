...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            <a class="info-btn2 inline-flex w-auto large-title stroke">i</a>

            <img src="{{ asset('assets/images/phonicsl1/global/click.png') }}"
                class="w-[27vw] h-fit absolute top-[-18%] right-[-20%]" />
        </div>
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="i">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[5vw]">insect</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">i</h1>
                <h1 class="text-white text-[5vw]">itch</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_i/itch.png') }}" class="h-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">i</h1>
                <h1 class="text-white text-[5vw]">ill</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">i</h1>
                <h1 class="text-white text-[4vw]">injection</h1>
            </div>
