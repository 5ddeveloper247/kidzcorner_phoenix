...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex relative w-fit h-fit" data-slide-audio="{{ asset('assets/audio/phonics_audio/alphahouse.m4a') }}">
            <h1 class="text-[#f7b94a] text-[6vw] bottom-[13%] left-[26%] stroke leading-none absolute hover:text-[#757571]">
                i</h1>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_i/insect.png') }}" class="w-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">i</span>nsect</h1>
        </div>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="insect">
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_i/ill.png') }}" class="h-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">i</span>ll</h1>
        </div>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="ill">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_i/itch.png') }}" class="h-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">i</span>tch</h1>
        </div>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="itch">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_i/injection.png') }}" class="w-[20VW]" />
            <h1 class="text-white text-[5vw]"> <span class="text-[#f7b94a]">i</span>njection</h1>
        </div>
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="injection">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
                ...
                <div class="grid grid-cols-2 gap-x-[4vw] gap-y-[1.5vw] place-items-center mb-[3vw]">
                    ...
                    <div class="flex items-start">
                        <a class="hover:brightness-110" id="true">
                            <img src="{{ asset('assets/images/phonicsl1/letter_i/insect.png') }}" class="w-[6.5vw]" />
                        </a>
                        {{-- sound Button --}}
...
document.addEventListener("DOMContentLoaded", function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            closeBtn.addEventListener('click', function(e) {
                ...
                window.location.href = '{{ url('/phonics_l1/letter_i') }}?view=phonics';
            });
