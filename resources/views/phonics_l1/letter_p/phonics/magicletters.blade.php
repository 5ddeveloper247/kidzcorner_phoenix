...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit p-0 m-0">p</a>

            <img src="{{ asset('assets/images/phonicsl1/global/click.png') }}"
                class="w-[27vw] h-fit absolute top-[-17%] right-[-20%]" />
        </div>
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        <h1 class="large-title stroke">p</h1>
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="p">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">p</h1>
                <h1 class="text-white text-[4vw]">parrot</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_p/parrot.png') }}" class="w-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">p</h1>
                <h1 class="text-white text-[4vw]">pill</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_p/pill.png') }}" class="w-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">p</h1>
                <h1 class="text-white text-[4vw]">pink</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_p/pink.png') }}" class="w-[25vw]" />
        </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">p</h1>
                <h1 class="text-white text-[4vw]">pick</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_p/pick.png') }}" class="w-[25vw]" />
