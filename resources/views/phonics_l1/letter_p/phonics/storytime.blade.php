...
@section('content')
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative w-fit">
            ...
            <h1 class="text-white text-[3.5vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">What pet does <br>
                Peace keep?</h1>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative">
            ...
            <h1 class="text-white text-[3vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">Why does she <br>
                call Doctor Pat?</h1>
            <p class="p-note absolute bottom-[1vw] left-[35%]">Tip: Elicit response from children.</p>
        </div>
    </div>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative">
            ...
            <h1 class="text-white text-[3vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">How does the <br>
                doctor make the <br>
                bird well again?</h1>
            <p class="p-note absolute bottom-[1vw] left-[35%]">Tip: Elicit response from children.</p>
        </div>
