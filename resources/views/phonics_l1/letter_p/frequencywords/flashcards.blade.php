...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="flex items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_p/up.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/she.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/call.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_p/she.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/call.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/calls.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_p/call.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/calls.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/it.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_p/calls.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/it.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/can.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_p/it.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/can.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/want.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_p/can.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/want.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/wants.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_p/want.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/wants.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_p/do.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start mt-[2vw]">
            ...
            <div class="col-span-3 flex justify-center">
                <img src="{{ asset('assets/images/phonicsl1/letter_p/by.png') }}" class="w-[14vw]" />
            </div>
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
