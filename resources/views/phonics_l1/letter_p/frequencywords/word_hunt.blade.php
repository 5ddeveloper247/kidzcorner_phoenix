...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">Peace’s pet parrot is sick.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.7vw]">Peace’s pet parrot <span class="text-[#f7b94a]">is</span> sick.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">Peace picks up the phone. She calls Doctor Pat.</h1>
        <p class="p-note w-[70%]">Tip: Ask children to circle the words that appear in the story on their Activity Sheet.
            Check result on next slide.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.2vw]">Peace picks <span class="text-[#f7b94a]">up </span> phone. <span
                class="text-[#f7b94a]">She calls</span> Doctor Pat.</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">He gives it a pink pill.</h1>
        <p class="p-note w-[70%]">Tip: Ask children to circle the words that appear in the story on their Activity Sheet.
            Check result on next slide.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.2vw]">He gives <span class="text-[#f7b94a]">it</span> a pink pill.</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">The parrot can sing again.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">The parrot <span class="text-[#f7b94a]">can</span> sing again.</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    </div>
