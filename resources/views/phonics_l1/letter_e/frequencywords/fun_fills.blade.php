...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center gap-y-[1vw]"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-e/funfills.m4a') }}">
        <h2 class="text-white text-[1.5vw]">Listen to these words:</h2>
        <img src="{{ asset('assets/images/phonicsl1/letter_e/wall.png') }}" class="w-[40vw]">
    ...
    <div class="phonics-panel flex flex-col items-center justify-between gap-y-[1vw]">
        ...
        <h2 class="stroke panel-title">Eddy elephant <span class="text-underline">_____</span> out of bed.</h2>

        <img src="{{ asset('assets/images/phonicsl1/letter_e/wake.gif') }}" class="w-[15vw]">
        <img src="{{ asset('assets/images/phonicsl1/letter_e/line1.png') }}">
    ...
    <div class="phonics-panel flex flex-col items-center justify-center gap-[1vw]">
        <div class="h-fit relative">
            <span class="text-white text-[2vw] absolute left-[47%] top-[-1vw]"> gets</span>
            <h2 class="stroke panel-title">Eddy elephant <span class="text-underline">_____</span> out of bed.</h2>
        </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-center">
        ...
        <h2 class="stroke panel-title">Cluck, cluck, cluck goes <span class="text-underline">_____</span> red hen.</h2>

        <img src="{{ asset('assets/images/phonicsl1/letter_e/cluck.gif') }}" class="w-[20vw]">
        <img src="{{ asset('assets/images/phonicsl1/letter_e/line2.png') }}">
        <p class="p-note">Tips: Use this slide to guide children to select the correct word to fill in the blank.
            Check result on next slide.</p>
    ...
    <div class="phonics-panel flex flex-col items-center justify-center">
        <div class="h-fit relative">
            <span class="text-white text-[2vw] absolute right-[23%] top-[-1vw]">little</span>
            <h2 class="stroke panel-title">Cluck, cluck, cluck goes <span class="text-underline">_____</span> red hen.</h2>
        </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between">
        ...
        <h2 class="stroke panel-title">She lays <span class="text-underline">____</span> eggs.</h2>


        <img src="{{ asset('assets/images/phonicsl1/letter_e/eggs.gif') }}" class="w-[15vw]">
        <img src="{{ asset('assets/images/phonicsl1/letter_e/line3.png') }}">
        <p class="p-note">Tips: Use this slide to guide children to select the correct word to fill in the blank.
            Check result on next slide.</p>
    ...
    <div class="phonics-panel flex flex-col items-center justify-center gap-y-[2vw]">
        <div class="h-fit relative">
            <span class="text-white text-[2vw] absolute right-[30%] top-[-1vw]">her</span>
            <h2 class="stroke panel-title">She lays <span class="text-underline">____</span> eggs.</h2>
        </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_e') }}?view=words";
            const doneURL = "{{ url('/phonics_l1/letter_e') }}?view=words";
