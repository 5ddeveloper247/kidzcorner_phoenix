...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw]">
            <a href="" class="info-btn2 inline-flex w-auto h-fit p-0 m-0 self-end">
                <h1 class="large-title stroke leading-none ">e</h1>
            </a>
    ...
    <div class="phonics-panel info-panel-2">
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="e">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[5vw]">egg</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_e/egg.png') }}" class="w-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">e</h1>
                <h1 class="text-white text-[5vw]">elephant</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_e/elephant.png') }}" class="w-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">e</h1>
                <h1 class="text-white text-[5vw]">hen</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_e/hen.png') }}" class="w-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">e</h1>
                <h1 class="text-white text-[5vw]">bed</h1>
            </div>
