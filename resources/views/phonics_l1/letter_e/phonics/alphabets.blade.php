...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex relative w-fit h-fit" data-slide-audio="{{ asset('assets/audio/phonics_audio/alphahouse.m4a') }}">
            <h1 class="text-[#f7b94a] text-[8vw] bottom-[10%] left-[24%] stroke leading-none absolute hover:text-[#757571]">
                e</h1>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_e/elephant.png') }}" class="w-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">e</span>lephant</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_e/egg-1.png') }}" class="w-[25vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">e</span>gg</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_e/hen.png') }}" class="h-[20vw]" />
            <h1 class="text-white text-[5vw]">h<span class="text-[#f7b94a]">e</span>n</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_e/bed.png') }}" class="w-[25vw]" />
...
document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_e') }}?view=phonics-slide";
