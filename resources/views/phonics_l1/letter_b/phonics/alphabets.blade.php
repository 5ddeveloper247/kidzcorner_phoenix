...
@section('content')
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_b/bee.png') }}" class="w-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">b</span>ee</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_b/bird.png') }}" class="w-[25vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">b</span>ird</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">b</span>utterfly</h1>
        </div>
                ...
                <div class="grid grid-cols-2 gap-x-[4vw] gap-y-[1vw] place-items-center mb-[3vw]">
                    ...
                    <div class="flex items-start">
                        <a class="hover:brightness-110" id="false">
                            <img src="{{ asset('assets/images/phonicsl1/letter_a/cat.png') }}" class="w-[6.5vw]" />
                        </a>
                        {{-- sound Button --}}
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_b') }}?view=phonics-slide";
