...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw]">
            <a href="" class="info-btn2 inline-flex w-auto h-fit p-0 m-0 self-end">
                <h1 class="large-title stroke leading-none ">b</h1>
            </a>
    ...
    {{-- Side Info Panel --}}
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-b/b1.mp3') }}">
        <h1 class="large-title stroke">b</h1>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-[40%] w-[5vw]" id="soundButton"
            data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-b/b2.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>

        <button class="absolute left-[-10vw] top-[60%] w-[5vw]" id="soundButton"
            data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-b/b-sound.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-2"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-b/b-bird.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">b</h1>
                <h1 class="text-white text-[5vw]">bird</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_b/bird.png') }}" class="w-[20vw]" />
    ...
    {{-- ==== 2 --}}
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-b/b-bear.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">b</h1>
                <h1 class="text-white text-[5vw]">bear</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_b/bear.png') }}" class="w-[25vw]" />
    ...
    {{-- === 3 --}}
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-b/b-bee.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">b</h1>
                <h1 class="text-white text-[5vw]">bee</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_b/bee.png') }}" class="w-[15vw]" />
    ...
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-b/b-butterfly.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">b</h1>
                <h1 class="text-white text-[5vw]">butterfly</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_b/butterfly.png') }}" class="h-[20vw]" />
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_b') }}?view=phonics";
            const doneURL = "{{ url('/phonics_l1/letter_b') }}?view=phonics";
