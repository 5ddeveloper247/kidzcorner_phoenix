    ...
    <div class="phonics-panel flex flex-col justify-between h-full">
        <div class="flex flex-col items-center justify-center gap-[2vw]">
            <div class="flex items-end gap-9">
                <img src="{{ asset('assets/images/phonicsl1/letter_b/bat.png') }}" class="h-[18vw]" />
                <h2 class="text-white text-[5vw]">bat</h2>
            </div>
            <h1 class="text-[2vw] text-[#f7b94a]">Bill buys a bat and a ball.</h1>
        </div>
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-b/readalong-b.mp3') }}">
                ...
                <div class="bg-no-repeat bg-center bg-contain h-[30vw] w-[28vw] mt-[-7vw]
                    ...
                    <div class="grid grid-cols-2 gap-x-[4vw] gap-y-[1vw] place-items-center mb-[3vw]">
                        ...
                        <div class="flex items-start mb-[1vw]">
                            ...
                            {{-- sound Button --}}
                            <button class="w-[3vw]" id="soundButton"
                                data-audio="{{ asset('assets/audio/phonics_audio/letter-a/apple.mp3') }}">
                                <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                            </button>
                        </div>
