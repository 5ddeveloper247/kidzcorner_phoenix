...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="flex items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_l/long.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/time.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/more.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_l/time.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/more.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/a.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_l/more.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/a.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/some.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_l/a.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/some.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/then.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_l/some.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/then.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/go.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_l/then.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/go.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/goes.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_l/go.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/goes.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_l/we.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start mt-[2vw]">
            ...
            <div class="col-span-3 flex justify-center">
                <img src="{{ asset('assets/images/phonicsl1/letter_l/our.png') }}" class="w-[14vw]" />
            </div>
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
