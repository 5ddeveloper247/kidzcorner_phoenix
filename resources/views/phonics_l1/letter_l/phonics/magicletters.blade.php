...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="l">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[5vw]">lemon</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_l/lemon.png') }}" class="h-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">l</h1>
                <h1 class="text-white text-[5vw]">lollipop</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_l/lollipop.png') }}" class="w-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">l</h1>
                <h1 class="text-white text-[5vw]">long</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_l/pencil.png') }}" class="h-[20vw]" />
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            closeBtn.addEventListener('click', function(e) {
                ...
                window.location.href = '{{ url('/phonics/letter_l') }}?view=phonics';
            });
