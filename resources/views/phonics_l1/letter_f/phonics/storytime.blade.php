...
@section('content')
    ...
    <div class="phonics-panel relative flex flex-col h-full items-center"
        ...
        <div class="flex items-end">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_f/bucket.png') }}" class="w-[15vw]" />
        </div>
        <h1 class="text-white text-[2.5vw]">The <span class="text-[#f7b94a]">f</span>ox from the <span
                class="text-[#f7b94a]">f</span>orest eats up one.</h1>
    </div>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative w-fit">
            ...
            <h1 class="text-white text-[3.5vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">Who catches <br>
                the five <br>
                fish?</h1>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative">
            ...
            <h1 class="text-white text-[3.5vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">What happens <br>
                to one of the <br>
                fishes?</h1>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative">
            ...
            <h1 class="text-white text-[3vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">How many fishes <br>
                are left?</h1>
