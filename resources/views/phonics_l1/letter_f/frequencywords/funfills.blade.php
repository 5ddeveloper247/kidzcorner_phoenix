...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center justify-center">
        ...
        <h2 class="stroke panel-title">One, <span class="text-underline">________</span>, three, four, five.</h2>
        <h2 class="stroke panel-title">Faith catches five fish!</h2>

        <img src="{{ asset('assets/images/phonicsl1/letter_f/fihing.png') }}" class="h-[15vw]">
        <img src="{{ asset('assets/images/phonicsl1/letter_f/line.png') }}">
    ...
    <div class="phonics-panel flex flex-col items-center justify-center">
        <div class="h-fit relative">
            <span class="text-white text-[2vw] absolute left-[22%] top-[-1vw]"> two</span>
            <h2 class="stroke panel-title">One,______, three, four, five.</h2>
            <h2 class="stroke panel-title">Faith catches five fish!</h2>
        </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-center">
        ...
        <h2 class="stroke panel-title">The fox from the forest eats <span class="text-underline">_____</span>one.</h2>

        <img src="{{ asset('assets/images/phonicsl1/letter_f/eat.gif') }}" class="h-[20vw]">
        <img src="{{ asset('assets/images/phonicsl1/letter_f/line2.png') }}">
        <p class="p-note">Tips: Use this slide to guide children to select the correct word to fill in the blank.
            Check result on next slide.</p>
    ...
    <div class="phonics-panel flex flex-col items-center justify-center">
        <div class="h-fit relative">
            <span class="text-white text-[2vw] absolute right-[15%] top-[-1vw]"> up</span>

            <h2 class="stroke panel-title">The fox from the forest eats <span class="text-underline">______</span>one.</h2>
        </div>
    ...
    {{-- treasure Panel --}}
     <div class="phonics-panel flex flex-col items-center justify-center">
        ...
        <h2 class="stroke panel-title">Now  <span class="text-underline">_____</span> are only four fish for Faith.</h2>

        <img src="{{ asset('assets/images/phonicsl1/letter_f/angry.png') }}" class="rounded-[1vw] h-[16vw]">
        <img src="{{ asset('assets/images/phonicsl1/letter_f/line3.png') }}">
        <p class="p-note">Tips: Use this slide to guide children to select the correct word to fill in the blank.
            Check result on next slide.</p>
    ...
    {{-- treasure panel --}}
       <div class="phonics-panel flex flex-col items-center justify-center">
        <div class="h-fit relative">
            <span class="text-white text-[2vw] absolute left-[15%] top-[-1vw]"> there</span>

        <h2 class="stroke panel-title">Now  <span class="text-underline">_____</span> are only four fish for Faith.</h2>
        </div>

        <img src="{{ asset('assets/images/phonicsl1/letter_f/angry.png') }}" class="rounded-[1vw] h-[20vw]">
    </div>
