...
@section('content')
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">j</span>og</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">j</span>ar</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_j/jump.png') }}" class="h-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">j</span>ump</h1>
        </div>
