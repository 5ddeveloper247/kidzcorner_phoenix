...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw]">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit p-0 m-0 self-end">j</a>
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="j">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[5vw]">jar</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_j/jar.png') }}" class="h-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">j</h1>
                <h1 class="text-white text-[5vw]">jump</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_j/jump.png') }}" class="h-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">j</h1>
                <h1 class="text-white text-[5vw]">jellies</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_j/jellies.png') }}" class="w-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">j</h1>
                <h1 class="text-white text-[4vw]">jog</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_j/jog.gif') }}" class="h-[20vw]" />
        </div>
