...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/like.mp3') }}">
        <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
    ...
    {{-- Panel 3 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/two.m4a') }}">
        <div class="flex items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 4 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/for.mp3') }}">
        <div class="flex items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/for.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 5 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/on.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/for.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/on.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 6 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/look.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/for.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/on.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/look.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 7 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/call.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/for.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/on.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/look.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/call.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 8 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/calls.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/for.png') }}" class="w-[14vw]" />
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_o/look.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/call.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/calls.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 9 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/can.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/for.png') }}" class="w-[14vw]" />
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_o/call.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/calls.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/can.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 10 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/will.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_o/like.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/two.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/for.png') }}" class="w-[14vw]" />
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_o/calls.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/can.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_o/will.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 11 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-o/flashcard/may.m4a') }}">
        <div class="grid grid-cols-3 items-start mt-[2vw]">
            ...
            <div class="col-span-3 flex justify-center">
                <img src="{{ asset('assets/images/phonicsl1/letter_o/may.png') }}" class="w-[14vw]" />
            </div>
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_o') }}?view=words";
            const doneURL = "{{ url('/phonics_l1/letter_o') }}?view=words";
