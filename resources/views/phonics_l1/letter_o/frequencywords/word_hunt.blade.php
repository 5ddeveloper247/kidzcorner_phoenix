...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">Ox and ostrich like oranges.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.7vw]">Ox and ostrich <span class="text-[#f7b94a]">like</span> oranges.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">Two oranges for ox and ostrich.</h1>
        <p class="p-note w-[70%]">Tip: Ask children to circle the words that appear in the story on their Activity Sheet.
            Check result on next slide.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.2vw]"><span class="text-[#f7b94a]">Two</span> oranges <span
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">Ox sits on the oranges.</h1>
        <p class="p-note w-[70%]">Tip: Ask children to circle the words that appear in the story on their Activity Sheet.
            Check result on next slide.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.2vw]">Ox sits <span class="text-[#f7b94a]">on</span> the oranges.</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">Oh, look! Orange juice!</h1>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">Oh, <span class="text-[#f7b94a]">look</span>! Orange juice!</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
            ...
            const itemAudioPaths = {
                'ietm-1': "{{ asset('assets/audio/phonics_audio/letter-o/ost2.m4a') }}",
                'ietm-2': "{{ asset('assets/audio/phonics_audio/letter-o/ost3.m4a') }}",
                'ietm-3': "{{ asset('assets/audio/phonics_audio/letter-o/ost4.m4a') }}",
                'ietm-4': "{{ asset('assets/audio/phonics_audio/letter-o/ost5.m4a') }}"
            };
