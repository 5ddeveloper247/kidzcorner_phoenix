...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit p-0 m-0">o</a>
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="o">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[4vw]">orange</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_o/orange.png') }}" class="w-[20vw]" />

        </div>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="orange">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">o</h1>
                <h1 class="text-white text-[4vw]">ostrich</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_o/ostrich.png') }}" class="h-[25vw]" />

        </div>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="ostrich">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">o</h1>
                <h1 class="text-white text-[4vw]">ox</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_o/ox.png') }}" class="w-[25vw]" />
        </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">o</h1>
                <h1 class="text-white text-[4vw]">octopus</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_o/octopus.png') }}" class="w-[25vw]" />

        </div>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="octopus">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            closeBtn.addEventListener('click', function(e) {
                ...
                window.location.href = '{{ url('/phonics/letter_o') }}?view=phonics';
            });
