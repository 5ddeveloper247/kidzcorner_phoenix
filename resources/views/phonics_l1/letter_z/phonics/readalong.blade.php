...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-[80%] self-end">
        <div class="flex flex-col items-center justify-center gap-[2vw]">
            <img src="{{ asset('assets/images/phonicsl1/letter_z/z-zebra.png') }}" class="w-[25vw]" />
            <h1 class="text-[2vw] text-[#f7b94a]">Zak plays with the zebra.</h1>
        </div>
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-z/z-zebra.m4a') }}">
        ...
        <div class="flex gap-x-[4vw] items-center justify-center">
           <div class="w-fit h-fit">
                <div class="relative ml-[10vw] w-fit h-fit">
                    ...
                    <h2 class="text-[1.2vw] !text-[#B76E33] absolute top-1/2 left-1/2 -translate-1/2 text-nowrap">Help me complete  the
                        sentence
            ...
            <div class="flex flex-col items-center">
                    ...
                    <div class="grid grid-cols-2 gap-x-[4vw] gap-y-[1.5vw] place-items-center mb-[3vw]">
                        ...
                        <div class="flex items-start">
                            <a class="hover:brightness-110" id="true">
                                <img src="{{ asset('assets/images/phonicsl1/letter_z/zoo.png') }}" class="w-[6.5vw]" />
                            </a>
                            {{-- sound Button --}}
                            <button class="w-[3vw]" id="soundButton" data-letter="zoo">
                                <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                            </button>
                        </div>
                ...
                <h2 class="text-white text-[1.5vw]">We are going to the _____.</h2>
