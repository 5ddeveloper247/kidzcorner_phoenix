...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit p-0 m-0">z</a>
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="z">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[4vw]">zebra</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">z</h1>
                <h1 class="text-white text-[4vw]">zoo</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_z/zoo.png') }}" class="w-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">z</h1>
                <h1 class="text-white text-[4vw]">zero</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_z/zero.png') }}" class="h-[25vw]" />
        </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">z</h1>
                <h1 class="text-white text-[4vw]">zigzag</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="y">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
