...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-u/flashcard/and.mp3') }}">
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="flex items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_u/and.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/i.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/it.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_u/i.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/it.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/from.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_u/it.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/from.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/an.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_u/from.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/an.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/up1.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_u/an.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/up1.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/what.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_u/up1.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/what.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/very.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_u/what.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/very.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_u/could.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        ...
        <div class="grid grid-cols-3 items-start mt-[2vw]">
            ...
            <div class="col-span-3 flex justify-center">
                <img src="{{ asset('assets/images/phonicsl1/letter_u/where.png') }}" class="w-[14vw]" />
            </div>
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_u') }}?view=words";
            const doneURL = "{{ url('/phonics_l1/letter_u') }}?view=words";
