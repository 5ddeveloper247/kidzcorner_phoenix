...
@section('content')
    ...
    <div class="phonics-panel info-panel-2 space-y-[2vw]">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="text-center text-white text-[2.8vw]">
                <h3>'up' begins with /u/.</h3>
                <h3>'up' begins with /u/.</h3>
                <h3>'up' begins with /u/ /u/ /u/.</h3>
                <h3>'up' begins with /u/.</h3>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-u/us1.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-9 flex flex-col items-center h-[80%] justify-between self-end">
        ...
        <p class="p-note">Tips: Use this Song Chart with the song. Substitute with other words beginning with the /u/ sound.
            <br>
    ...
    <div class="phonics-panel info-panel-3 flex flex-col items-center justify-between">
        ...
        <div class="flex flex-col items-center gap-[1vw] relative">
            ...
            <div class="text-center text-white text-[3vw]">
                <h3>I've got the letter 'u' for up.</h3>
                <h3>I've got the letter 'u' for up.</h3>
                <h3>I've got the letter 'u' for up.</h3>
                <h3>'u' goes /u/ /u/ /u/.</h3>
            </div>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-u/us2.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-4">
        ...
        <div class="flex flex-col items-center gap-[1vw]">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_u/jump.png') }}" class="w-[15vw]" />
            <div class="text-center text-white text-[2.5vw]">
                <h3>Here we go up and down the hump.</h3>
                <h3>Down the hump. Down the hump.</h3>
                <h3>Here we go up and down the hump.</h3>
                <h3>Hump goes /u/ /u/ /u/ /u/ /u/.</h3>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-u/us3.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-5">
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-u/us4.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-6 flex flex-col gap-[1vw]">
        ...
        <img src="{{ asset('assets/images/phonicsl1/letter_u/umbrellas.png') }}" />
        <div class="text-center text-white text-[2vw]">
            <h3>One little, two little, three little umbrellas.</h3>
            <h3>Four little, five little, six little umbrellas.</h3>
            <h3>Seven little, eight little, nine little umbrellas</h3>
            <h3>Ten little umbrellas.</h3>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-u/us5.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-7 flex flex-col gap-y-[3vw]">
        ...
        <div class="flex flex-col items-center gap-y-[2vw]">
            ...
            <div>
                <img src="{{ asset('assets/images/phonicsl1/letter_u/group.png') }}" class="w-[45vw]" />
            </div>
        </div>
        <p class="p-note">Tip: Music will be automatically played twice. Click on the sound icon to repeat music.</p>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-u/us6.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-8 flex flex-col h-full">
        ...
        <div class="flex flex-col items-center justify-between h-full">
            <h4 class="text-white text-[1vw]">(Tune: Bingo)</h4>
            <div class="flex">
                <img src="{{ asset('assets/images/phonicsl1/letter_u/bunnies.png') }}" class="h-[15vw]" />
                <div class="text-center text-white text-[2vw]">
                    <h3>I like bunnies, yes I do.</h3>
                    <h3>I like bunnies, yes I do.</h3>
                    <h3>I like bunnies, yes I do.</h3>
                    <h3>Do you like bunnies too?</h3>
                </div>
                <img src="{{ asset('assets/images/phonicsl1/letter_u/bunnies.png') }}" class="h-[15vw]" />
            </div>
            <p class="p-note">Tip: Music will be automatically played twice. Click on the sound icon to repeat music.</p>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-u/us7.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
