...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit p-0 m-0">u</a>
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        <h1 class="large-title stroke">u</h1>
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-u/u1.m4a') }}">
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">u</h1>
                <h1 class="text-white text-[4vw]">under</h1>
            </div>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-u/u2.m4a') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">u</h1>
                <h1 class="text-white text-[4vw]">umbrella</h1>
            </div>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-u/u3.m4a') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">u</h1>
                <h1 class="text-white text-[4vw]">bug</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_u/bug.png') }}" class="w-[20vw]" />
        </div>

        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-u/u4.m4a') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">u</h1>
                <h1 class="text-white text-[4vw]">sun</h1>
            </div>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-u/u5.m4a') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
