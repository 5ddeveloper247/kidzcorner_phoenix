...
@section('content')
    ...
    <div class="phonics-panel info-panel-2 space-y-[2vw]">
        ...
        <div class="flex flex-col items-center">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_q/queen.png') }}" class="h-[10vw]" />
            <div class="text-center text-white text-[2.8vw]">
                <h3>queen' begins with /q/.</h3>
                <h3>'queen' begins with /q/.</h3>
                <h3>'queen' begins with /q/ /q/ /q/.</h3>
                <h3>'queen' begins with /q/.</h3>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/qs1.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-9 flex flex-col items-center h-[80%] justify-between self-end">
        ...
        <p class="p-note">Tips: Use this Song Chart with the song. Substitute with other words beginning with the /q/ sound.
            <br>
    ...
    <div class="phonics-panel info-panel-3 flex flex-col items-center justify-between">
        <h2 class="top-title stroke">I’ve got the Letter ‘q’</h2>
        <div class="flex flex-col items-center gap-[1vw] relative">
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_q/quilt.png') }}" class="w-[10vw]" />
            <div class="text-center text-white text-[3vw]">
                <h3>I've got the letter 'q' for quilt.</h3>
                <h3>I've got the letter 'q' for quilt.</h3>
                <h3>I've got the letter 'q' for quilt.</h3>
                <h3>'q' goes /q/ /q/ /q/.</h3>
            </div>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/qs2.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-4">
        ...
        <div class="flex flex-col items-center gap-[1vw]">
            ...
            <div class="flex w-full justify-between items-center">
                <img src="{{ asset('assets/images/phonicsl1/letter_q/quack.png') }}" class="w-[10vw]" />
                <img src="{{ asset('assets/images/phonicsl1/letter_q/quack.png') }}" class="w-[10vw]" />
            </div>
            <div class="text-center text-white text-[2.5vw]">
                <h3>The quarrelsome ducks go quack, quack, quack.</h3>
                <h3>Quack, quack, quack. Quack, quack, quack.</h3>
                <h3>The quarrelsome ducks go quack, quack, quack.</h3>
                <h3>Quacking all the way.</h3>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/qs3.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-5">
        ...
        <div class="flex flex-col items-center justify-between relative h-[28vw]">
            <h4 class="text-white text-[1vw]">(Tune: The Wheels On The Bus Go Round And Round)</h4>
            <img src="{{ asset('assets/images/phonicsl1/letter_q/quill.png') }}" class="h-[20vw] absolute left-[-17%]" />
            <div class="text-center text-white text-[3vw]">
                <h3>The 'q' in quill goes /q/ /q/ /q/.</h3>
                <h3>/q/ /q/ /q/ /q/ /q/ /q/</h3>
                <h3>The 'q' in quill goes /q/ /q/ /q/.</h3>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/qs4.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    {{-- Infpo Panel 6 --}}
    <div class="phonics-panel info-panel-6 flex flex-col">
        <h2 class="top-title stroke">One Little, Two Little</h2>
        <h4 class="text-white text-[1vw]">(Tune: Ten Little Indian Boys)</h4>
        <img src="{{ asset('assets/images/phonicsl1/letter_q/pens.png') }}" />
        <div class="text-center text-white text-[2.5vw]">
            <h3>One little, two little, three little quill pens.</h3>
            <h3>Four little, five little, six little quill pens.</h3>
            <h3>Seven little, eight little, nine little quill pens</h3>
            <h3>Ten quill pens for the queen.</h3>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/qs5.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-7 flex flex-col gap-y-[3vw]">
        ...
        <div class="flex flex-col items-center gap-y-[2vw]">
            ...
            <div>
                <img src="{{ asset('assets/images/phonicsl1/letter_q/group.png') }}" class="w-[45vw]" />
            </div>
        </div>
        <p class="p-note">Tip: Music will be automatically played twice. Click on the sound icon to repeat music.</p>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/qs6.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    <div class="phonics-panel info-panel-8 flex flex-col h-full">
        ...
        <div class="flex flex-col items-center justify-between h-full">
            <h4 class="text-white text-[1vw]">(Tune: Bingo)</h4>
            <div class="flex flex-col items-center">
                <img src="{{ asset('assets/images/phonicsl1/letter_q/eggs.png') }}" class="w-[10vw]" />
                <div class="text-center text-white text-[2.5vw]">
                    <h3>I like quail eggs, yes I do.</h3>
                    <h3>I like quail eggs, yes I do.</h3>
                    <h3>I like quail eggs, yes I do.</h3>
                    <h3>Do you like quail eggs too?</h3>
                </div>
            </div>
            <p class="p-note">Tip: Music will be automatically played twice. Click on the sound icon to repeat music.</p>
        </div>
        ...
        {{-- sound Button --}}
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/qs7.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics/letter_q') }}?view=phonics";
            const doneURL = "{{ url('/phonics/letter_q') }}?view=phonics";
