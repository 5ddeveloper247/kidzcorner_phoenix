...
@section('content')
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_q/quill.png') }}" class="h-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">q</span>uill</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_q/queen.png') }}" class="h-[20vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">q</span>ueen</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">q</span>uack</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            <img src="{{ asset('assets/images/phonicsl1/letter_q/quilt.png') }}" class="w-[20vw]" />
