...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-[80%] self-end">
        <div class="flex flex-col items-center justify-center gap-[2vw]">
            <img src="{{ asset('assets/images/phonicsl1/letter_q/q-queen.png') }}" class="w-[25vw]" />
            <h1 class="text-[2vw] text-[#f7b94a]">The quarrelsome queen walks
                quickly.</h1>
        </div>
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-q/q-queen.m4a') }}">
    ...
    <div class="phonics-panel done-hide next-hide">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <div class="relative ml-[10vw]">
                    ...
                    <h2 class="text-[1.2vw] !text-[#B76E33] absolute top-[2vw] right-[2vw]">Help me complete <br> the
                        sentence
                        with <br> a word beginning <br> with ‘p’.</h2>
                </div>
            ...
            <div class="flex flex-col items-center">
                        ...
                        <div class="col-span-2 flex justify-center ">
                            <div class="flex items-start gap-x-[1vw]">
                                <a class="hover:brightness-110" id="true">
                                    <img src="{{ asset('assets/images/phonicsl1/letter_q/queen.png') }}"
                                        class="h-[7vw] " />
                                </a>
                                {{-- sound Button --}}
                ...
                <h2 class="text-white text-[1.5vw]">The __________ likes cakes.</h2>
