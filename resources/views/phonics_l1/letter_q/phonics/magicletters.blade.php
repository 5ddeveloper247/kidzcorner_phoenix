...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            ...
            <img src="{{ asset('assets/images/phonicsl1/global/click.png') }}" class="w-[27vw] h-fit absolute top-[-17%] right-[-23%]" />
        </div>
    ...
    <div class="phonics-panel flex justify-center items-center info-panel-2">
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton" data-letter="q">
