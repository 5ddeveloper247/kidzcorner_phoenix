...
@section('content')
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative w-fit h-fit">
            ...
            <img src="{{ asset('assets/images/phonicsl1/global/gifs/lili.gif') }}"
             ...
             <h1 class="text-white text-[3.5vw] absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 text-center">Who gets <br>
                the quill pen?</h1>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative w-fit h-fit">
            ...
            <h1 class="text-white text-[3vw] absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 text-center">Who gets <br>
                the quilt?</h1>
            <p class="p-note absolute bottom-[1vw] left-[35%]">Tip: Elicit response from children.</p>
        </div>
    </div>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative w-fit h-fit">
            ...
            <h1 class="text-white text-[3vw] absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 text-center">Do they like what <br>
                they get? <br>
                Why?</h1>
            <p class="p-note absolute bottom-[1vw] left-[35%]">Tip: Elicit response from children.</p>
        </div>
