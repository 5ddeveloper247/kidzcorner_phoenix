...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">The day is getting dark.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.7vw]"><span class="text-[#f7b94a]">The</span> day <span class="text-[#f7b94a]">is
                getting</span> dark.</h1>
