...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw]">
            <a href="" class="info-btn2 inline-flex w-auto h-fit p-0 m-0 self-end">
                <h1 class="large-title stroke leading-none ">d</h1>
            </a>
    ...
    {{-- Side Info Panel --}}
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-d/d1.mp3') }}">
        <h1 class="large-title stroke">d</h1>

        <button class="absolute left-[-10vw] top-[40%] w-[5vw]" id="soundButton"
            data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-d/d-letter.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>

        <button class="absolute left-[-10vw] top-[60%] w-[5vw]" id="soundButton"
            data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-d/d-sound.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
    ...
    {{-- == 1 --}}
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-d/d-dog.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">d</h1>
                <h1 class="text-white text-[5vw]">dog</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_d/dog.png') }}" class="w-[20vw]" />
    ...
    {{-- ==== 2 --}}
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-d/d-duck.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">d</h1>
                <h1 class="text-white text-[5vw]">duck</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_d/duck.png') }}" class="w-[25vw]" />
    ...
    {{-- === 3 --}}
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-d/d-dinner.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">d</h1>
                <h1 class="text-white text-[5vw]">dinner</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_d/dinner.png') }}" class="w-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2" data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-d/d-dark.mp3') }}">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height: 66%;">d</h1>
                <h1 class="text-white text-[5vw]">dark</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_d/dark.jpg') }}" class="w-[33vw] rounded-[1vw]" />
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_d') }}?view=phonics";
            const doneURL = "{{ url('/phonics_l1/letter_d') }}?view=phonics";
