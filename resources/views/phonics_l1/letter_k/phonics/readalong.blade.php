...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-[80%] self-end">
        <div class="flex flex-col items-center justify-center gap-[2vw]">
            <img src="{{ asset('assets/images/phonicsl1/letter_k/k-kangaro.png') }}" class="w-[30vw]" />
            <h1 class="text-[2vw] text-[#f7b94a]">The kangaroo kicks the kitten.</h1>
        </div>
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-k/k-kangaro.m4a') }}">
                    ...
                    <div class="grid grid-cols-2 gap-x-[4vw] gap-y-[1.5vw] place-items-center mb-[3vw]">
                        ...
                        <div class="flex items-start mb-[1vw]">
                            ...
                            <a class="w-[6vw] hover:brightness-110 " id="true">
                                <img src="{{ asset('assets/images/phonicsl1/letter_k/kitten.png') }}" />
                            </a>
                            {{-- sound Button --}}
                            <button class="w-[3vw]" id="soundButton" data-letter="kitten">
                                <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                            </button>
                        </div>
