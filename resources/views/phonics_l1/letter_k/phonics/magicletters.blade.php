...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit pt-[2vw] self-end">k</a>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[5vw]">kite</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">k</h1>
                <h1 class="text-white text-[5vw]">kangaroo</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_k/kangaroo.png') }}" class="h-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">k</h1>
                <h1 class="text-white text-[5vw]">kick</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_k/kick.png') }}" class="w-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:90%;">k</h1>
                <h1 class="text-white text-[4vw]">kitten</h1>
            </div>
       ...
       <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            closeBtn.addEventListener('click', function(e) {
                ...
                window.location.href = '{{ url('/phonics_l1/letter_K') }}?view=phonics';
            });
        });
    </script>
@endpush
