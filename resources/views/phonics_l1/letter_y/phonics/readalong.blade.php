...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-[80%] self-end">
        <div class="flex flex-col items-center justify-center gap-[2vw]">
            <img src="{{ asset('assets/images/phonicsl1/letter_y/y-yoyo.png') }}" class="w-[25vw]" />
            <h1 class="text-[2vw] text-[#f7b94a]">Yenny has a yellow yo-yo.</h1>
        </div>
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-y/y-yoyo.m4a') }}">
    ...
    <div class="phonics-panel done-hide next-hide">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div class="w-fit h-fit">
                <div class="relative ml-[10vw] w-fit h-fit">
                   ...
                   <h2 class="text-[1.2vw] !text-[#B76E33] absolute top-1/2 left-1/2 -translate-1/2 text-nowrap">Help me complete <br> the
                        sentence
                        with <br> a word beginning <br> with ‘y’.</h2>
                </div>
            ...
            <div class="flex flex-col items-center">
                ...
                <h2 class="text-white text-[1.5vw]">She has a ________.</h2>
