...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw] relative">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit p-0 m-0">y</a>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[4vw]">yo-yo</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">y</h1>
                <h1 class="text-white text-[4vw]">yellow</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_y/yellow.png') }}" class="w-[25vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">y</h1>
                <h1 class="text-white text-[4vw]">yard</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">y</h1>
                <h1 class="text-white text-[4vw]">young</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_y/young.png') }}" class="h-[25vw]" />
