...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2vw]">The vet visits Victor in the village.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2vw]">The vet visits Victor <span class="text-[#f7b94a]">in</span> the village.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">To see his sick cat.</h1>
        <p class="p-note w-[70%]">Tip: Ask children to circle the words that appear in the story on their Activity Sheet.
            Check result on next slide.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.2vw]"><span class="text-[#f7b94a]">To see his </span> sick cat.</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">He wraps it in a very big blanket.</h1>
        <p class="p-note w-[70%]">Tip: Ask children to circle the words that appear in the story on their Activity Sheet.
            Check result on next slide.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center justify-between h-full"
        ...
        <h1 class="text-white text-[2.2vw]"><span class="text-[#f7b94a]">He</span> wraps <span class="text-[#f7b94a]">it
                in</span> a <span class="text-[#f7b94a]"> very </span> big blanket.</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">And puts it in his van.</h1>
    ...
    <div class="phonics-panel flex flex-col items-center"
        ...
        <h1 class="text-white text-[2.2vw]">And puts <span class="text-[#f7b94a]">it in his</span> van.</h1>
        <p class="p-note">Tip: Highlight that the beginning letter in a sentence is written in uppercase.</p>
    </div>
