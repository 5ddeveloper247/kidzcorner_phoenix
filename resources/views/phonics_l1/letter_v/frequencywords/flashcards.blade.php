...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/in.m4a') }}">
        <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
    ...
    {{-- Panel 3 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/to.m4a') }}">
        <div class="flex items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 4 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/see.m4a') }}">
        <div class="flex items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/see.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 5 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/his.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/see.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/his.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 6 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/he.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/see.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/his.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/he.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 7 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/it.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/see.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/his.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/he.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/it.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 8 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/very.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/see.png') }}" class="w-[14vw]" />
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_v/he.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/it.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/very.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 9 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/would.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/see.png') }}" class="w-[14vw]" />
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_v/it.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/very.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/would.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 10 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/was.m4a') }}">
        <div class="grid grid-cols-3 items-start">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/in.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/to.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/see.png') }}" class="w-[14vw]" />
            ...
            <img src="{{ asset('assets/images/phonicsl1/letter_v/very.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/would.png') }}" class="w-[14vw]" />
            <img src="{{ asset('assets/images/phonicsl1/letter_v/was.png') }}" class="w-[14vw]" />
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
    ...
    {{-- Panel 11 --}}
    <div class="phonics-panel flex flex-col justify-between h-full"
        data-slide-audio="{{ asset('assets/audio/phonics_audio/letter-v/flashcard/were.m4a') }}">
        <div class="grid grid-cols-3 items-start mt-[2vw]">
            ...
            <div class="col-span-3 flex justify-center">
                <img src="{{ asset('assets/images/phonicsl1/letter_v/were.png') }}" class="w-[14vw]" />
            </div>
        </div>
        <p class="p-note">Tip: These are 10 words on the list. Guide children to read each word.</p>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_v') }}?view=words";
            const doneURL = "{{ url('/phonics_l1/letter_v') }}?view=words";
