...
@section('content')
    ...
    {{-- Panel 2 --}}
    <div class="phonics-panel flex flex-col justify-center">
        <div class="flex flex-col items-center justify-center gap-[2vw]">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/v-vase.png') }}" class="w-[25vw]" />
            <h1 class="text-[2vw] text-[#f7b94a]">Vic has a vase in his van.</h1>
        </div>
        ...
        <button class="absolute left-[-10vw] top-1/2 w-[5vw]" id="soundButton"
            data-audio="{{ asset('assets/audio/phonics_audio/letter-v/v-vase.m4a') }}">
    ...
    <div class="phonics-panel done-hide next-hide">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div class="w-fit h-fit">
                <div class="relative ml-[10vw] w-fit h-fit">
                   ...
                   <h2 class="text-[1.2vw] !text-[#B76E33] absolute top-1/2 left-1/2 -translate-1/2">Help me complete <br> the
                        sentence
                        with <br> a word beginning <br> with ‘v’.</h2>
                </div>
            ...
            <div class="flex flex-col items-center">
                        ...
                        <div class="col-span-2 flex justify-center ">
                            <div class="flex items-start gap-x-[1vw]">
                                <a class="hover:brightness-110" id="true">
                                    <img src="{{ asset('assets/images/phonicsl1/letter_v/van.png') }}"
                ...
                <h2 class="text-white text-[1.5vw]">Vic is in the  ________.</h2>
