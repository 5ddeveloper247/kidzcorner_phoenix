...
@section('content')
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">v</span>an</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div>
            ...
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">v</span>et</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div class="flex flex-col items-center">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/visit.png') }}" class="w-[22vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">v</span>isit</h1>
        </div>
    ...
    <div class="phonics-panel">
        <div class="flex flex-col items-center">
            <img src="{{ asset('assets/images/phonicsl1/letter_v/village.png') }}" class="w-[22vw] rounded-[1vw]" />
            <h1 class="text-white text-[5vw]"><span class="text-[#f7b94a]">v</span>illage</h1>
        </div>
        {{-- sound Button --}}
    ...
    <div class="phonics-panel">
        <div class="flex gap-x-[4vw] items-center justify-center">
            ...
            flex justify-center items-end"
                ...
                <h2 class="text-white text-[2vw] absolute top-[15%]">van</h2>
                    ...
                    <div class="col-span-2 flex justify-center ">
                        <div class="flex items-start gap-x-[1vw]">
                            <a class=" hover:brightness-110" id="true">
                                <img src="{{ asset('assets/images/phonicsl1/letter_v/van.png') }}" class="w-[6vw]" />
                            </a>
                            {{-- sound Button --}}
                            <button class="w-[3vw]" id="soundButton" data-letter="van">
                                <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                            </button>
                        </div>
                    </div>
