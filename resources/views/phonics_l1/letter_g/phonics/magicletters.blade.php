...
@section('content')
    ...
    <div class="phonics-panel">
        <div class="flex h-[28vw]">
            <a class="info-btn2 inline-flex w-auto large-title stroke h-fit p-0 m-0 self-end">g</a>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                ...
                <h1 class="text-white text-[5vw]">goose</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_g/goose.png') }}" class="w-[20vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">g</h1>
                <h1 class="text-white text-[5vw]">goat</h1>
            </div>
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">g</h1>
                <h1 class="text-white text-[5vw]">girl</h1>
            </div>
            <img src="{{ asset('assets/images/phonicsl1/letter_g/girl.png') }}" class="h-[30vw]" />
    ...
    <div class="phonics-panel info-panel-2">
        <div class="flex gap-x-[4vw] items-center justify-center">
            <div>
                <h1 class="large-title stroke h-fit" style="line-height:100%;">g</h1>
                <h1 class="text-white text-[5vw]">gift</h1>
            </div>
