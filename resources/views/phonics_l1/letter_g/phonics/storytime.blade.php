...
@section('content')
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative w-fit">
            ...
            <h1 class="text-white text-[3.5vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">Who is receiving
                <br>
                the gift?
            </h1>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative">
            ...
            <h1 class="text-white text-[3.5vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">Why do you <br>
                think she <br>
                giggles?</h1>
    ...
    <div class="phonics-panel no-bg mb-[2vw]"
        ...
        <div class="relative">
            ...
            <h1 class="text-white text-[3vw] absolute top-[10vw] left-1/2 -translate-x-1/2 text-center">What do you <br>
