...
@section('content')
    ...
    <div class="text-white flex  flex-col justify-start gap-y-10 text-start text-2xl slide hidden">
        ...
        <div>
            <h2 class="font-bold">Black Light In The Black Box</h2>
    ...
    <div class="absolute  bottom-[80px] z-[99]">
        <button
            class="cursor-pointer doneButton w-66 h-[75px] relative bg-[#F8A23A] rounded-[30px] flex justify-center items-center overflow-hidden">
            <div class="bg-white w-[27px] h-[18px] absolute top-[9px] left-[19px]"></div>
            <div class="absolute left-[8.22px] top-[3.17px] "> <img src="/assets/images/pptimages/Vector4.png" />
            </div>
            <span class="stroke flex items-center  text-white text-5xl font-bold ">DONE</span>
        </button>
    </div>
