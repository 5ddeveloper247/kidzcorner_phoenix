    ...
    <ul class="list-disc">
      <li>
        ...
        <ul class="list-decimal">
          <li>Flashlights</li>
          <li>Items that can form shadows such as Solid toy figurines Blocks Books Construction/coloured paper or card</li>
        </ul>
      </li>
    </ul>
    <img src="{{ asset('assets/images/pptimages/fish.png') }}" alt="" class="w-[50%]" />
  </div>
  <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="" class="absolute right-0 bottom-[-50px]" />
...
<div class="text-white relative flex w-[75%] gap-y-20 flex-col text-start text-2xl slide hidden">
  <div>
    <h2 class="font-bold">Preparations for Class Activity I:</h2>
    <ul class="list-disc">
      <li>3) Translucent items that forms coloured shadows such as coloured plastic cups, translucent toys, red/yellow plastic bags, coloured plastic sheets, cellophane paper etc.</li>
    </ul>
...
<div class="text-white relative flex w-[75%] gap-y-20 flex-col text-start text-2xl slide hidden">
  <div>
    <h2 class="font-bold">Preparations for Class Activity I:</h2>
    <ul class="list-disc">
      <li>4. Transparent items such as transparent plastic cups, water bottles, goggles, magnifying glass or ziplock bag etc. Teacher to point out which parts do not have shadows as light is able to shine through.</li>
    </ul>
    <img src="{{ asset('assets/images/pptimages/lens.png') }}" alt="" class="w-[50%]" />
  </div>
  <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="" class="absolute right-0 bottom-[-50px]" />
  <div class="h-fit w-[60%]">
    <p>Important Notes: </br>Teacher to remind children not to shine light directly into their eyes or their friend's eyes. Explain to them that it will damage their eyes. Teacher can use simple words to explain translucent and transparent.</p>
  </div>
</div>
...
<div class="flex w-[75%] flex-col text-start text-2xl text-white slide hidden">
  <div>
    ...
    <ul class="list-decimal pl-6">
      <li>Pre-cut puppet templates of a face <span class="block text-lg">(You may use paper plates for the head and cut out the eyes and mouth portion)</span></li>
      <li>Allow children to freely paste the materials on their template and let them discover the shadow formed with the materials.</li>
    </ul>
...
<div class="text-white flex w-[75%] flex-col justify-start gap-y-10 text-start text-2xl slide hidden">
  <h1 class="title text-amber-300 text-[45px] text-center">Learning Center Idea</h1>
  <div>
