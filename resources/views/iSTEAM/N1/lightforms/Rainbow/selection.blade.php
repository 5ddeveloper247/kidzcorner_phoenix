...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-center text-center z-[99]relative   w-full">
        <h2 class="title text-[55px] stroke ">Rainbows </h2>
        <div class="flex items-center justify-between gap-[10vw]">
            ...
            {{-- Teacher Button --}}
            <a href="{{ route('rainbowteacher') }}" id="Lesson" class="flex flex-col gap-0">
    ...
    <div id="buttons" class="absolute  flex flex-row ">
        <!-- Return Button -->
        <a href="{{ route('rainbow') }}" id="returnButton">
