...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-center text-center z-[99] w-full">
        <h2 class="text-[50px] text-[#F7B94A] stroke">Glow in the Dark</h2>
        <div class="flex items-center justify-between gap-[10vw]">
            ...
            {{-- Teacher Button --}}
            <a href="{{ route('darkteacher') }}" id="Lesson" class="flex flex-col gap-0">
    ...
    <div id="buttons" class="absolute  flex flex-row ">
        ...
        <!-- Return Button -->
        <a href="{{ route('types') }}" id="returnButton">
