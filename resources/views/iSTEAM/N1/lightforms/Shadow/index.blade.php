...
@section('content')
    ...
    <d iv id="topDiv" class="flex flex-col  h-full justify-between items-center ">
        <h2 class="  text-[#F7B94A] text-[50px] font-extrabold stroke">Light and Shadow</h2>
        <h2 class="text-2xl sm:text-3xl lg:text-5xl text-white mb-20">
            Explore how lights create shadows; <br>
            develop awareness of different types of shadows.
        </h2>

        <button
            class="cursor-pointer nextButton w-62 h-[80px] relative bg-[#F8A23A] flex justify-center items-center  rounded-[30px] overflow-hidden">
