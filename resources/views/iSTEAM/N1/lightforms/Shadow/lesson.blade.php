...
@section('content')
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <img src="{{ asset('assets/images/pptimages/sh.png') }}" class="!max-w-[37vw] " />
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="stroke title">When you lift up your arms, <br> your <span class="text-white">shadow</span> does
            the same actions.</h2>
        <img src="{{ asset('assets/images/pptimages/newimg.png') }}" class="border border-4 border-[#eb9809]" />
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        ...
        <h2 class="title stroke">6. Follow the pictures below and make a <span class="text-white">shadow</span> of a bird.
        </h2>
        <img src="{{ asset('assets/images/pptimages/shadow14.png') }}" class="!max-w-[44vw] h-[14vw]" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        ...
        <h2 class="title stroke">8. Follow the pictures below and make a
            <span class="text-white">shadow</span> of a moose.
        </h2>
        <img src="{{ asset('assets/images/pptimages/shadow13.png') }}" class="!max-w-[44vw] h-[14vw]" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        ...
        <h2 class="title !text-white stroke">Let's do:</h2>
        <h2 class="title stroke">9. Try making the <span class="text-white">shadow</span> of a dog.</h2>
        <img src="{{ asset('assets/images/pptimages/shadow12.png') }}" class="!max-w-[44vw] h-[14vw] " />
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        ...
        <h2 class="title !text-white stroke">Let's do:</h2>
        <h2 class="title stroke">10. Try making the <span class="text-white">Shadow</span> of a duck.</h2>
        <img src="{{ asset('assets/images/pptimages/shadow11.png') }}" class="!max-w-[44vw] h-[14vw]" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <img src="{{ asset('assets/images/pptimages/gl5.png') }}" class="!max-w-[44vw] h-[14vw]" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="justify-start text-center title stroke ">The <span class="text-white">shadow</span> in the land is
            <span class="text-white"> long </span>, </br> but the <span class="text-white">shadow</span> on the tennis court
            is
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-start">
        <div class="text-start">
            ...
            <ul class="slide-ul title stroke space-y-[.5vw] text-start">
                <li>4. Draw the shadow on the paper and label it as A.</li>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <div class="0">
            <img src="{{ asset('assets/images/pptimages/shadow9.png') }}" class="!max-w-[44vw] h-[14vw]" />
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <div class="0">
            <img src="{{ asset('assets/images/pptimages/shadow10.png') }}" class="!max-w-[44vw] h-[14vw]" />
        </div>
