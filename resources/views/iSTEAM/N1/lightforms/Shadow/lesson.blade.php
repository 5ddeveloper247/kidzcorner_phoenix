...
<h2 class="title !text-[55px] stroke absolute top-[30px] z-[100]">Light and Shadow</h2>
    ...
    <!-- Slide 7 -->
    <div class="slide hidden flex flex-col items-center justify-center gap-5 px-4 text-center">
    ...
    <!-- Slide 8 -->
    <div class="slide hidden flex flex-col items-center justify-center gap-5 px-4 text-start">
    ...
    <div class="slide hidden flex flex-col items-center justify-center gap-5 px-4 text-center">
            ...
            <div class="title stroke">5. Make animal shadows with your hands.</div>
    ...
    <!-- Slide 19 -->
    <div class="slide hidden flex flex-col items-center justify-between gap-5 h-[60%] px-4 text-start">
        <ul class="list-decimal title stroke text-start">
            <h2 >Let's do: </h2>
    ...
    <!-- Slide 22 -->
    <div class="slide hidden flex flex-col items-center justify-center gap-5 px-2 space-y-10 text-start w-[90%]">
    ...
    <!-- Slide 24 -->
    <div class="slide hidden flex w-[90%] flex-col items-center justify-center gap-5 space-y-10 px-2 text-start">
        <h2 class="stroke title">
            Suggested Guiding Question:
        </h2>
        <ul class="list-disc title stroke">
    ...
    <!-- Slide 27 -->
    <div class="slide hidden flex w-[100%] flex-col items-center justify-center gap-5 text-center title">
    ...
    <!-- Slide 28 -->
    <div class="slide hidden flex w-[100%] flex-col items-center justify-center gap-5 t">
        <img src="{{ asset('assets/images/pptimages/shadow2.png') }}" class="w-[50%]" />
