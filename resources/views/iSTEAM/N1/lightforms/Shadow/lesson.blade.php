...
@section('content')
    ...
    <!-- Slide 4 -->
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="stroke title">When you stand in the sun, you are <span class="!text-white">blocking</span> the <span
                class="text-white">light</span> from the sun! This is how <span class="!text-white">shadows</span> are made.
        </h2>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="stroke title">The shape of your
            <span class="!text-white">shadow </span> looks like you <br> and it follows all your movements.
        </h2>
    ...
    <!-- Slide 5 -->
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="stroke title">When you jump, your <span class="!text-white">shadow</span> jumps.</h2>

        <img src="{{ asset('assets/images/pptimages/shadow2.png') }}" class="img-md" />
    </div>

    <!-- Slide 6 -->
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="stroke title">When you lift up your arms, <br> your <span class="!text-white">shadow</span> does
            the same actions.</h2>
        <img src="{{ asset('assets/images/pptimages/newimg.png') }}" class="border border-4 border-[#eb9809] img-md" />
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center text-center">
        ...
        <img src="{{ asset('assets/images/pptimages/shadow17.png') }}" class="img-md" />

        <h2 class="stroke title">Make animal <span class="!text-white">shadows</span> with your hands.</h2>

        <p class="note ">Note: Teacher to use light to shine towards a white wall. Ensure enough space <br>
    ...
    <div class="slide hidden flex flex-col items-center justify-between  ">
        ...
        <p class="note ">Note: Ensure children's safety while doing this activity. <br>Make sure the room
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        <div class="title stroke text-start">
            ...
            <ol class="list-decimal lesson-ul" start="5">
                <li>Look at the picture below. What animal is it?</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/pptimages/shadow16.png') }}" class="img-md" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        <div class="title stroke text-start">
            ...
            <ol class="list-decimal lesson-ul" start="6">
                <li>Follow the pictures below and make a <span class="!text-white">shadow</span> of a bird.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/pptimages/shadow14.png') }}" class="img-xl" />

        <p class="note ">Note: Guide children to follow the shadow of a bird.</p>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        ...
        <img src="{{ asset('assets/images/pptimages/shadow15.png') }}" class="img-md" />
        <p class="note ">Note: Encourage children to share their answers.</p>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        <div class="title stroke text-start">
            ...
            <ol class="list-decimal lesson-ul" start="8">
                <li>Follow the pictures below and make a <span class="!text-white">shadow</span> of a moose.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/pptimages/shadow13.png') }}" class="img-xl" />

        <p class="note ">Note: Guide children to follow the shadow of a moose.</p>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        <div class="title stroke text-start">
            ...
            <ol class="list-decimal lesson-ul" start="9">
                <li>Try making the <span class="!text-white">shadow</span> of a dog.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/pptimages/shadow12.png') }}" class="img-lg " />

        <p class="note ">Note: Guide and encourage children to try.</p>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-center">
        <div class="title stroke text-start">
            ...
            <ol class="list-decimal lesson-ul" start="10">
                <li>Try making the <span class="!text-white">Shadow</span> of a duck.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/pptimages/shadow11.png') }}" class="img-lg" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <img src="{{ asset('assets/images/pptimages/gl5.png') }}" class="img-xl" />
        <p class="note">Note: Guide and encourage children to answer.</p>
    </div>

    <!-- Slide 16 -->
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="justify-start text-center title stroke ">The <span class="!text-white">shadow</span> in the land is
            <span class="!text-white"> long </span>, </br> but the <span class="!text-white">shadow</span> on the tennis
            court
            is
    ...
    <!-- Slide 17 -->
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="stroke justify-start text-center title">Why are the <span class="!text-white">shadows</span> different?
        </h2>
        <img src="{{ asset('assets/images/pptimages/gl5.png') }}" class="img-xl" />
        <p class="note">Note: Guide and encourage children to share their thoughts.</p>
    </div>

    <!-- Slide 18 -->
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="justify-start text-center title !text-white stroke">CLASS ACTIVITY 2</h2>
        <img src="{{ asset('assets/images/pptimages/shadow6.png') }}" class="img-md" />

        <h2 class="stroke justify-start text-start title">
            Let's find out: <br />
            What changes the size of the shadows?
        </h2>
        <p class="note">Note: Teacher to prepapre materials for each group to explore.</p>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[45vh] ">
        ...
        <p class="note ">Note: Assist the children in each group to set up the paper on the wall.
    ...
    <div class="slide hidden flex flex-col items-center justify-center ">
        <div class="text-start title stroke">
            ...
            <ol class="list-decimal lesson-ul" start="3">
                <li>Put the flashlight at a distance from the blocks such that the shadow is projected on the wall.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/pptimages/shadow6.png') }}" class="img-sm"/>

        <p class="note ">Note: Assist the children in each group to set up and let children explore with
            the set up.</p>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center  text-star">
        <div class="text-start title stroke">
            ...
            <ol class="list-decimal lesson-ul" start="4">
                <li>Draw the shadow on the paper and label it as A.</li>
                <li>Paste a label A at the position where the flashlight is</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/pptimages/shadow7.png') }}" class="img-sm"  />
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[50vh] ">
        <div class="text-start title stroke">
            <h2 class="stroke title">Let's do:</h2>
            <ol class="list-decimal lesson-ul" start="6">
                <li>Move the position of the flashlight and observe the size of the shadows formed.</li>
                <li>Now try to make a shadow that is smaller/bigger than the one drawn on the paper.</li>
                <li>Draw the shadow and mark the position.</li>
            </ol>
        </div>

        <p class="note ">Note: Teacher to ask questions to lead children to explore how they can change
    ...
    <div class="slide hidden flex  flex-col items-center justify-center ">
        ...
        <p class="note ">Note: Teacher to facilitate each group and encourage them to explore how they can
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <div class="0">
            <img src="{{ asset('assets/images/pptimages/shadow9.png') }}" class="img-xl" />
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <div class="0">
            <img src="{{ asset('assets/images/pptimages/shadow10.png') }}" class="img-xl" />
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center text-center">
        ...
        <p class="note ">Note: Encourage children to sing along. Refer</p>
    </div>
    ...
    <!-- Slide 30 -->
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/pptimages/shadow8.png') }}" class="img-md" />
