            ...
            <ul class="list-disc">
                <li>
                    <ul class="list-disc space-y-1">
                        <li>Provide each group with a flashlight, mah-jong paper on wall, blocks and a table for children to work on.</li>
                        <li>Ensure enough space for children to place the tower and explore the position of the flashlight.</li>
                    </ul>
                </li>
                <li>
                    <strong>link to song:</strong>
                <li>• Hi Shadow - </li>
                <a href="https://www.youtube.com/watch?v=ZLph3HVJVFA " target="_blank" class="text-blue-300 underline">https://www.youtube.com/watch?v=ZLph3HVJVFA </a>
                </li>
            </ul>
        </div>
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="" />
    ...
    <div class="flex w-[100%] items-center justify-between">
        <div>
            ...
            <ul class="list-disc leading-relaxed">
                <li>
                    If you see
                    <span class="relative inline-block h-16 w-16 cursor-pointer rounded-[20px] bg-sky-500 shadow-[2px_3px_5px_rgba(0,0,0,0.25)] shadow-[inset_2px_-3px_3px_rgba(0,0,0,0.25)] outline outline-1 outline-cyan-900">
                        <!-- Decorative Vector -->
                        <img src="{{ asset('assets/images/pptimages/Vector4.png') }}" class="absolute top-[4px] left-[6px] h-6 w-[80%]" />
                        <!-- White Shape -->
                        <div class="absolute top-[7px] left-[12px] h-2.5 w-3.5 rounded-sm bg-white"></div>
                        <!-- Play Icon -->
                        <img src="{{ asset('assets/images/pptimages/play.png') }}" class="absolute top-[16px] left-[16px] h-8 w-8" />
                    </span>
                    next to a picture, click on the picture to watch the video.
                </li>
                <li>
                    If you see
                    <span class="relative inline-block h-16 w-16 cursor-pointer rounded-[20px] bg-amber-500 shadow-[2px_3px_5px_rgba(0,0,0,0.25)] shadow-[inset_2px_-3px_3px_rgba(0,0,0,0.25)] outline outline-1 outline-cyan-900">
                        <!-- Decorative Vector -->
                        <img src="{{ asset('assets/images/pptimages/Vector4.png') }}" class="absolute top-[4px] left-[6px] h-6 w-[80%]" />
                        <!-- White Shape -->
                        <div class="absolute top-[7px] left-[12px] h-2.5 w-3.5 rounded-sm bg-white"></div>
                        <!-- Play Icon -->
                        <img src="{{ asset('assets/images/pptimages/info.png') }}" class="absolute top-[16px] left-[16px] h-8 w-8" />
                    </span>
                    , click on it for additional information or activity.
                </li>
                <li>Always ask questions to encourage children to think and share their ideas first before giving out any information.</li>
                ...
                <li>
                    ...
                    <span class="relative inline-block h-16 w-16 cursor-pointer rounded-[20px] bg-sky-500 shadow-[2px_3px_5px_rgba(0,0,0,0.25)] shadow-[inset_2px_-3px_3px_rgba(0,0,0,0.25)] outline outline-1 outline-cyan-900">
                        ...
                        <div class="absolute top-[7px] left-[12px] h-2.5 w-3.5 rounded-sm bg-white"></div>
                        <!-- Play Icon -->
                        <img src="{{ asset('assets/images/pptimages/home-icon.png') }}" class="absolute top-[16px] left-[16px] h-8 w-8" />
                    </span>
...
<div class="slide hidden text-white flex  flex-col justify-start gap-y-10 text-start text-2xl">
    ...
    <div>
        ...
        <p>Prepare some flashlights and some toys such as cars, dinosaurs, animal figurines etc. Print out shadows of the objects for children to match. The shadows can be taller/bigger/smaller/shorter, depending on how the light was positioned.</p>
    </div>
    <div class="flex w-[100%] items-center justify-between">
        <div>
            <!-- What to do -->
...
{{-- done Button --}}
    <div class="absolute bottom-0">
        <button class="cursor-pointer doneButton w-66 h-[75px] relative bg-[#F8A23A] rounded-[30px]  shadow-[3px_4px_7.8px_0px_rgba(0,0,0,0.25)] shadow-[inset_3px_-4px_4px_0px_rgba(0,0,0,0.25)] 
            ...
            <span
                class="absolute left-[80px] top-[18px] flex items-center  text-white text-5xl font-bold ">DONE</span>
        </button>
    </div>
