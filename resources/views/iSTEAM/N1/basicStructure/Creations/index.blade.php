...
@section('content')
    ...
    <div id="topDiv" class="flex flex-col items-center gap-[7rem] ">
        <h2 class="  text-amber-300 text-[65px] font-extrabold stroke"> My Creations</h2>
        <h2 class="!text-white title"> Learn how to identify shapes of an item; explore and create a shape template and structure for an item</h2>
