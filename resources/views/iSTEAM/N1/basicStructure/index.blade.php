    ...
    <div class="board w-[1267px] h-[734px] flex flex-col justify-center items-center">
        ...
        <div class="grid grid-cols-1  gap-8 text-center sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="{{ route('shapes') }}"
                ...
                <span class="text-3xl text-[#AF6E39] absolute top-[1vw] right-[1vw]">1</span>
            </a>
            ...
            <a href="{{ route('identifyShapes') }}"
                ...
                <span class="text-3xl text-[#AF6E39] absolute top-[1vw] right-[1vw]">2</span>
            </a>
            ...
            <a href="{{ route('Shapes-Structure') }}"
                ...
                <span class="text-3xl text-[#AF6E39] absolute top-[1vw] right-[1vw]">3</span>
            </a>
            ...
            <a href="{{ route('Shape-around') }}"
                ...
                <span class="text-3xl text-[#AF6E39] absolute top-[1vw] right-[1vw]">4</span>
            </a>
            ...
            <a href="{{ route('Build-Structure') }}"
                ...
                <span class="text-3xl text-[#AF6E39] absolute top-[1vw] right-[1vw]">5</span>
            </a>
            ...
            <a href="{{ route('Creations') }}"
                ...
                <span class="text-3xl text-[#AF6E39] absolute top-[1vw] right-[1vw]">6</span>
            </a>
        </div>
    </div>
