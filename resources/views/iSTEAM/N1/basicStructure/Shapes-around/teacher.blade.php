...
@section('content')
    ...
    <div class="text-white flex flex-col text-start text-2xl slide hidden">
        <div>
            <h2 class="font-bold underline">Preparation for Class Activity 1 :</h2>
            <ul class="list-disc">
                <li>A squared shaped boxed. If you are unable to find, use the following template to create a cube.</li>
            </ul>
        </div>
        <div class="flex justify-between items-center">
            <img src="{{ asset('assets/images/pptimages/te1.png') }}" alt="" />
            <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt=""
    ...
    <div class="text-white flex flex-col text-start text-2xl slide hidden">
        ...
        <div class="flex justify-between items-center">
            <img src="{{ asset('assets/images/pptimages/te2.png') }}" alt="" class="w-[536px]" />
            <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt=""
                class="h-[350xp] object-contain" />
        </div>
    </div>
    ...
    <div class="text-white flex  flex-col justify-start gap-y-10 text-start text-2xl slide hidden">
        ...
        <div>
            <h2 class="font-bold">Creating Structures</h2>
    ...
    <div class="absolute bottom-[80px] z-[99]">
        <button
            ...
            <span
                class="absolute left-[80px] stroke top-[18px] flex items-center  text-white text-5xl font-bold ">DONE</span>
        </button>
    </div>
    ...
    <div class="absolute bottom-[80px] z-[99]">
        ...
        outline outline-1 outline-yellow-700 overflow-hidden">
            ...
            <span class="absolute stroke left-[80px] top-[18px] flex items-center  text-white text-5xl font-bold ">NEXT
            </span>
        </button>
    </div>
@endsection
