...
@section('content')
    ...
    <div id="topDiv" class="flex flex-col items-center gap-[7rem] ">
        <h2 class="  text-amber-300 text-[65px] font-extrabold stroke"> Shapes Around Us</h2>
        <h2 class="!text-white title"> Develop awareness that all things have shapes and structures; explore and create different structures using shapes. </h2>
