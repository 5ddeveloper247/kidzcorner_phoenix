...
@section('content')
    ...
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <div class="flex gap-10">
            <img src="/assets/images/K1/str/st24.png" />
            <img src="/assets/images/K1/str/st25.png" />
        </div>
    ...
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <div class="flex items-center justify-center gap-10">
            <img src="/assets/images/K1/str/st27.png" class="w-[500px]" />
            <img src="/assets/images/K1/str/st28.png" class="w-[500px]" />
        </div>
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        ...
        <img src="/assets/images//K1/str/st42.png" />
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        ...
        <img src="/assets/images//K1/str/st52.png" />
