...
@section('content')
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="/assets/images/K1/sm/screw/s1.png" class="img-md" />
    ...
    {{-- Slide 2 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="/assets/images/K1/sm/screw/s2.png" class="img-md" />
    ...
    <div class="slide flex flex-col items-center justify-center gap-0">
        <img src="/assets/images/K1/sm/screw/s4.png" class="img-md" />
    ...
    {{-- Slide 5 --}}
    <div class="slide flex flex-col items-center justify-center gap-0">
        <img src="/assets/images/K1/sm/screw/s5.png" class="img-md" />
    ...
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s6.png" class="img-md" />
    ...
    {{-- Slide 12 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s7.png" class="img-md" />
        <h2 class="title stroke">What is this? Where is the screw? What does it do?</h2>
    </div>
    ...
    {{-- Slide 14 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s8.png" class="img-md" />
        <h2 class="title stroke">What is this? Where is the screw? What does it do?</h2>
    </div>

    {{-- Slide 15 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/sl1.png" class="img-md" />
    ...
    {{-- Slide 16 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s9.png" class="img-h-md" />
        <h2 class="title stroke">What is this? Where is the screw? What does it do?</h2>
    </div>

    {{-- Slide 17 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/sl2.png" class="img-h-md" />
    ...
    {{-- Slide 18 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s10.png" class="img-h-md" />
        <h2 class="title stroke">What is this? Where is the screw? What does it do?</h2>
    </div>

    {{-- Slide 19 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/sl3.png" class="img-h-md" />
    ...
    {{-- Slide 20 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s11.png" class="img-lg" />
        <h2 class="title stroke">How do you (always) get holes punched in the paper?</h2>
    </div>

    {{-- Slide 21 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/sl4.png" class="img-lg" />
        <h2 class="title stroke">Arrange the books from small to big.</h2>
    </div>

    {{-- Slide 22 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s12.png" class="img-lg" />
        <h2 class="title stroke">What is this? Where is the screw? What does it do?</h2>
    </div>

    {{-- slide 23 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/sl5.png" class="img-lg" />
    ...
    {{-- slie 24 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s13.png" class="img-lg" />
        <h2 class="title stroke">What is this? Where is the screw? What does it do?</h2>
    </div>

    {{-- slide 25 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/sl6.png" class="img-lg" />
        <h2 class="title stroke">This is a special type of screw called <span class="!text-white">Archimedes’
                screw.</span>
        </h2>
    </div>
    ...
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s13.png" class="img-lg" />
        <h2 class="title stroke"><span class="!text-white">Archimedes’ screw.</span> is big and usually used in farms.
        </h2>
    </div>
    ...
    {{-- slide 31 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s16.png" class="img-lg" />
    ...
    {{-- slide 36 --}}
    <div class="slide flex flex-col items-center justify-start ">
        <img src="/assets/images/K1/sm/screw/s19.png" class="img-lg" />
