...
@section('content')
    ...
    {{-- slide 11 --}}
    <div class="slide flex flex-col items-center justify-center1">
    ...
    {{-- slide 33 --}}
    <div class="slide flex flex-col items-center justify-start  items-center ">
        <h2 class="!text-white title">Class Activity</h2>
        <img src="/assets/images/K1/sm/wheels/we16.png" class="large-img" />
    ...
    <div class="slide flex flex-col items-center justify-start  items-center ">
        ...
        <img class="large-img" src="/assets/images/K1/sm/wheels/we17.png" />
    </div>
    ...
    <div class="slide flex flex-col items-center justify-start  items-center ">
        ...
        <img class="large-img" src="/assets/images/K1/sm/wheels/we18.png" />
    </div>
    ...
    <div class="slide flex flex-col items-center justify-start  items-center ">
        ...
        <img class="large-img" src="/assets/images/K1/sm/wheels/we19.png" />
    </div>
    ...
    <div class="slide flex flex-col items-center justify-start  items-center ">
        ...
        <img class="large-img" src="/assets/images/K1/sm/wheels/we20.png" />
    </div>


    {{-- slide 38 --}}
    <div class="slide flex flex-col items-center justify-start  items-center ">
        <img class="large-img" src="/assets/images/K1/sm/wheels/we21.png" />
        <ul class="lesson-ul !text-start stroke title ">
    ...
    <div class="slide flex flex-col items-center justify-start  items-center ">
        <ul class="lesson-ul !text-start stroke title">
            <h2 class="stroke title">Let's do:</h2>
            <li>2. Take turns to test the water wheel by putting it on a big
    ...
    {{-- slide 40 --}}
    <div class="slide flex flex-col items-center justify-start  items-center ">
        <img class="large-img2" src="/assets/images/K1/sm/wheels/we22.png" />
        <ul class="lesson-ul !text-start stroke title ">
            <li class="!text-white">
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const doneButtonRoute = "{{ route('WheelsSelection') }}";
