...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-center text-center z-[999]  w-full">
        <h2 class="text-[50px] text-[#F7B94A] stroke">Pop a Balloon Machine</h2>
        <div class="flex items-center justify-between">

            {{-- Lesson Button --}}
            <a href="{{ route('BalloonLesson') }}" id="Lesson" class="flex flex-col gap-0">
            ...
            {{-- Teacher Button --}}
            <a href="{{ route('BalloonTeacher') }}" id="Lesson" class="flex flex-col gap-0">
