...
goes through the balloon and pops it.</h2> 
    ...
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        ...
        <h2 class="title stroke">A  <span class="!text-white">needle</span> is an example of a <span class="!text-white">simple machine</span> called <span class="!text-white">wedge</span>.</h2>
...
at the other edge.</h2> 
    ...
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/sm/balloon/ballon11.png" />
        <h2 class="title stroke">A <span class="!text-white">needle</span> is a <span class="!text-white">simple machine</span> 
