...
@section('content')
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K1/cm/cmg.png') }}" class="img-lg" />
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <h2 class="title stroke">
            Many people build their <span class="!text-white">Rube Goldberg Machines</span> with the
            ideas of the <span class="!text-white">simple machines</span>!</h2>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <div class="flex  text-[#f7b94a] gap-[10vw] stroke text-start">
            <ol class="text-[2vw]  list-decimal">
                <li>Ring a bell</li>
                <li>Raise a flag</li>
                <li>Recycle a bottle</li>
                <li>Other use</li>
            </ol>
            <ol class="text-[2vw] list-decimal" start="5">
                <li>Launch a Ball</li>
                <li>Throw a rubbish</li>
                <li>Trap an Animal</li>
            </ol>
        </div>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[28vw]">
        ...
        <div class="text-start">
            ...
            <h2 class="title stroke">Create a Rube Goldberg Machine that includes at least three simple machines!</h2>
        </div>
