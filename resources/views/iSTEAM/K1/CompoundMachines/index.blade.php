...
@section('content')
    ...
    <div id="buttons" class="absolute top-[30px] right-[60px] flex flex-row gap-6 z-90">
        ...
        <a href="{{ route('K1') }}" class="relative w-24 h-24 button-fade-in bg-slate-500 rounded-[30px] shadow-lg shadow-inner outline outline-1 outline-teal-800 cursor-pointer"
            id="returnButton">
