...
@section('content')
    ...
    {{-- sldie 14 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm44.png" />
    ...
    {{-- sldie 20 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm46.png" />
    ...
    {{-- sldie 21 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm47.png" />
    ...
    {{-- sldie 27 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm49.png" />
    ...
    {{-- sldie 34 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm51.png" />
    ...
    {{-- sldie 44 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm53.png" />
    ...
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <div class="flex">
            <img src="/assets/images/K1/cm/cm63.png" />
            <img src="/assets/images/K1/cm/cm62.png" class="w-[452px] h-[250px]" />
            <img src="/assets/images/K1/cm/cm64.png" />
        </div>
        <h2 class="title stroke">The screws hold the different parts
    ...
    {{-- sldie 67 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm65.png" />
        <h2 class="title stroke">The wheels and axles of the mobile crane allow us
            to move the crane around easily.</h2>
        <!-- Video Trigger Button -->
        <div data-property-1="Default"
    ...
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        ...
        <h2 class="title stroke">The shape of the front part of a car is a <span class="text-white">wedge</span>. This
            wedge
            allows the car cut through air and move forward easily.</h2>
    </div>
    ...
    {{-- sldie 76 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm67.png" />
    ...
    {{-- sldie 77 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm68.png" />
    ...
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <div class="flex items-center">
            <img src="/assets/images/K1/cm/cm69.png" />
            <img src="/assets/images/K1/cm/cm66.png" />
        </div>
        <h2 class="title stroke">The screws hold the different parts
    ...
    {{-- sldie 79 --}}
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <img src="/assets/images/K1/cm/cm70.png" />
    ...
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <div class="flex flex-wrap justify-center">
            <img src="/assets/images/K1/cm/cm43.png" class="w-[300px]" />
            <img src="/assets/images/K1/cm/cm45.png" class="w-[300px]" />
            <img src="/assets/images/K1/cm/cm52.png" class="w-[300px]" />
            <img src="/assets/images/K1/cm/cm50.png" class="w-[300px]" />
            <img src="/assets/images/K1/cm/cm48.png" class="w-[300px]" />
            <img src="/assets/images/K1/cm/cm54.png" class="w-[300px]" />
        </div>
    ...
    <div class=" slide hidden flex flex-col items-center justify-center gap-1">
        <div class="flex justify-center">
            <img src="/assets/images/K1/cm/cm62.png" class="w-[300px]" />
            <img src="/assets/images/K1/cm/cm66.png" class="w-[300px]" />
        </div>
