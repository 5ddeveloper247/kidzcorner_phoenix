...
@section('content')
    ...
    {{-- Slide 4 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K1/coding/sound/s2.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/K1/coding/sound/s3.png') }}" class="img-xs" />
            <img src="{{ asset('assets/images/K1/coding/sound/s5.png') }}" />
            <img src="{{ asset('assets/images/K1/coding/sound/s4.png') }}" class="img-sm" />
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/K1/coding/sound/s6.png') }}" class="img-xs" />
            <img src="{{ asset('assets/images/K1/coding/sound/s5.png') }}" />
            <img src="{{ asset('assets/images/K1/coding/sound/s7.png') }}" class="img-sm" />
        </div>
        <h2 class="title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of sounds.</h2>
        <p class="note">Note: Guide children to identify each type of sound by listening to the different choice of
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/K1/coding/sound/s8.png') }}" class="img-xs" />
            <img src="{{ asset('assets/images/K1/coding/sound/s5.png') }}" />
            <img src="{{ asset('assets/images/K1/coding/sound/s9.png') }}" class="img-sm" />
        </div>
        <h2 class="title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of sounds.</h2>
        <p class="note">Note: Guide children to identify each type of sound by listening to the different choice of
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/K1/coding/sound/s10.png') }}" class="img-xs" />
            <img src="{{ asset('assets/images/K1/coding/sound/s5.png') }}" />
            <img src="{{ asset('assets/images/K1/coding/sound/s11.png') }}" class="img-sm" />
        </div>
        <h2 class="title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of sounds.</h2>
        <p class="note">Note: Guide children to identify each type of sound by listening to the different choice of
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/K1/coding/sound/s12.png') }}" class="img-xs" />
            <img src="{{ asset('assets/images/K1/coding/sound/s5.png') }}" />
            <img src="{{ asset('assets/images/K1/coding/sound/s13.png') }}" class="img-sm" />
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s14.png') }}" class="img-xl" />
    ...
    {{-- Slide 13 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s15.png') }}" class="img-xl" />
    ...
    {{-- Slide 14 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s16.png') }}" class="img-xl" />
        <h2 class="text-center title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of lights.</h2>
        <p class="note text-center">Note: *Run the programme to let children observe how each choice of light runs on a
            robot.</p>
    ...
    {{-- Slide 15 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s17.png') }}" class="img-xl" />
        <h2 class="text-center title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of lights.</h2>
        <p class="note text-center">Note: *Run the programme to let children observe how each choice of light runs on a
            robot.</p>
    ...
    {{-- Slide 16 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s18.png') }}" class="img-xl" />
        <h2 class="text-center title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of lights.</h2>
        <p class="note text-center">Note: *Run the programme to let children observe how each choice of light runs on a
            robot.</p>
    ...
    {{-- Slide 17 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s19.png') }}" class="img-xl" />
        <h2 class="text-center title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of lights.</h2>
        <p class="note text-center">Note: *Run the programme to let children observe how each choice of light runs on a
            robot.</p>
    ...
    {{-- Slide 18 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s20.png') }}" class="img-xl" />
        <h2 class="text-center title stroke">Tap, drag and place a programming block at the scripting area.
            Tap on that programming block for the choice of lights.</h2>
        <p class="note text-center">Note: *Run the programme to let children observe how each choice of light runs on a
            robot.</p>
    ...
    {{-- Slide 19 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s21.png') }}" class="img-md" />
    ...
    {{-- Slide 20 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s22.png') }}" class="img-xl" />
    ...
    {{-- Slide 22 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s23.png') }}" class="img-xl" />
    ...
    {{-- Slide 27 (Click Slide) --}}
    <div class="slide hidden click1 flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K1/coding/sound/s30.png') }}" class="img-md" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        ...
        <img src="{{ asset('assets/images/K1/coding/sound/s27.png') }}" class="img-lg" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="text-start">
            <h2 class="title stroke">Steps:</h2>
            <ol class="lesson-ul list-decimal title stroke" start="2">
                <li>How does a robot moves through this circuit? Number the steps.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K1/coding/sound/s28.png') }}" class="img-md" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        ...
        <div class="flex items-center gap-[.5vw]">
            <img src="{{ asset('assets/images/K1/coding/sound/s27.png') }}" class="img-md" />
            <img src="{{ asset('assets/images/K1/coding/sound/s29.png') }}" class="img-h-sm" />
        </div>
