...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-center text-center z-[99] w-full  ">
        <h2 class="text-[50px] text-[#F7B94A] stroke">Coding Challenge 3</h2>
        <div class="flex items-center justify-around w-full">

            {{-- Lesson Button --}}
            <a href="{{ route('challenge3Lesson') }}" id="Lesson" class="flex flex-col gap-0">
                <img src="/assets/images/pptimages/lesson-btn.png" />
            </a>
            {{-- Teacher Button --}}
            <a href="{{ route('challenge3Teacher') }}" id="Lesson" class="flex flex-col gap-0">
    ...
    <div id="buttons" class="absolute  flex flex-row ">
        ...
        <!-- Return Button -->
        <a href="{{ route('challenge3') }}" id="returnButton">
