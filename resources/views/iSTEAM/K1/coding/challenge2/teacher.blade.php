...
@section('content')
    ...
    <div class="flex !text-white flex-col t-slide justify-start  text-start">
        ...
        <img src="{{ asset('assets/images/K1/coding/challenge2/ch1.png') }}" class="img-md" />
    </div>
    ...
    {{-- sldie 8 --}}
    <div class="flex !text-white flex-col t-slide items-center justify-start  text-start">
        <p>If time allows, let children repeat the hands-on session by adding obstacles
            into the coding mat (example as shown)</p>
        <img src="{{ asset('assets/images/K1/coding/challenge2/ch10.png') }}" class="img-h-md" />
    </div>
