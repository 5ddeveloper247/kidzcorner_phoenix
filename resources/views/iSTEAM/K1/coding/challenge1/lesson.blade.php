...
@section('content')
    {{-- title --}}
    <h2 class="title !text-[3vw] top-title stroke absolute top-[5vh] z-[100]">Coding Challenge (1)</h2>
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        ...
        <div class="flex items-center gap-[2vw]">
            <div class="flex items-start gap-[1vw]">
                <img src="/assets/images//K1/coding/challenge1/ch4.png" />
                <img src="/assets/images//K1/coding/challenge1/ch3.png" class="!w-[16vw]" />
            </div>
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <ol class="text-start title stroke">
            <h2>Steps:</h2>
            <li>6. The robot will flash the light to match the colour it finds.  How do you add in the matching light?
            </li>
        </ol>
        <div class="flex items-center gap-[2vw]">
            <div class="flex items-start gap-[1vw]">
    ...
    <div class="slide  hidden flex flex-col items-center justify-center ">
        ...
        <div class="w-[40vw] h-[40vh] bg-cover bg-center flex flex-col justify-center items-center"
            ...
            <img src="/assets/images/K1/coding/challenge1/ch2.png" class="!max-w-[18vw]" />
        </div>
    </div>
