...
@section('content')
    {{-- title --}}
    <h2 class="title !text-[3vw] top-title stroke absolute top-[5vh] z-[100]">Fast and Slow</h2>
    ...
    {{-- slide 9 --}}
    <div class="slide flex flex-col items-center justify-center  ">
        <img src="/assets/images/K1/coding/fast/fs8.png" />
    ...
    <div class="slide  hidden flex flex-col items-center justify-center ">
        ...
        <div class="w-[40vw] h-[40vh] bg-cover bg-center flex flex-col justify-center"
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const doneButtonRoute = "{{ route('fastSelection') }}";
