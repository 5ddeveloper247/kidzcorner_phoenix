...
@section('content')
    {{-- title --}}
    <h2 class="title !text-[3vw] top-title stroke absolute top-[5vh] z-[100]">Go! Go! Go! 1</h2>

    {{-- Slide 1 --}}
    <div class="slide flex flex-col items-center justify-center  ">
        <div class="flex items-center gap-[1vw]">
            <img src="/assets/images//K1/coding/cd/cd4.png" class="large-img" />
    ...
    {{-- slide 17 --}}
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <img src="/assets/images//K1/coding/go/gl2.png" />
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        ...
        <img src="/assets/images//K1/coding/go/gl4.png" />
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        ...
        <img src="/assets/images//K1/coding/go/gl5.png" />
        <p class="note text-center">Note: Have children help each other to complete this step; then place the card
    ...
    <div class="slide hidden  flex flex-col items-center justify-start">
        <div class="text-start title stroke">
            ...
            <ul>
               ...
               <img src="/assets/images//K1/coding/go/gl6.png" />       
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const whereToGoWhenDone = "{{ route('go1Selection') }}";
