...
@section('content')
    ...
    <div id="topDiv" class="flex flex-col  h-[90%] items-center ">
        <div class="  text-amber-300 text-[65px] font-extrabold stroke">Go! Go! Go! (2)</div>
        <h2 class="text-2xl sm:text-3xl lg:text-6xl text-white stroke ">Learn how to programme a robot to move
