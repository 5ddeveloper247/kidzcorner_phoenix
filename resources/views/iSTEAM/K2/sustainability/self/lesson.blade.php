...
@section('content')
    ...
    {{-- Slide 7 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/sustain/self/gl1.png') }}" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        ...
        <img src="{{ asset('assets/images/K2/sustain/self/s16.png') }}" class="w-img" />
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        ...
        <img src="{{ asset('assets/images/K2/sustain/self/s17.png') }}" class="w-img2" />
