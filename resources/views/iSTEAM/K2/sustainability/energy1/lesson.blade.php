...
@section('content')
    ...
    {{-- Slide 5 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/sustain/energy1/e1.png') }}" class="w-img3" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/sustain/energy1/e2.png') }}" class="w-img3" />
    ...
    <div class="slide hidden flex flex-col items-center">
        ...
        <img src="{{ asset('assets/images/K2/sustain/energy1/e0a.png') }}" class="w-img" />
        <h2 class="title stroke text-start">Let's find out: <br> Create a solar oven and find out if the sun's heat can cook
            food.</h2>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center">
        ...
        <div class="flex gap-2 items-center">
            <img src="{{ asset('assets/images/K2/sustain/energy1/e8.png') }}" class="w-img" />
            <img src="{{ asset('assets/images/K2/sustain/energy1/e9.png') }}" class="w-img" />
        </div>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center">
        ...
        <img src="{{ asset('assets/images/K2/sustain/energy1/e5.png') }}" class="!max-w-[40vw]" />
    </div>
...
@push('script')
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const doneRoute = "{{ route('energy1Selection') }}";
