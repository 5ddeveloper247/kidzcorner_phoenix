...
@section('content')
    ...
    <div class="t-slide flex  !text-white flex-col items-center justify-center text-start hidden">
        ...
        <div>
            <h2 class="t-title">Teacher's Bottle:</h2>
            <ul class="list-decimal">
                <li>Put two coffee filter paper together and tie them at the mouth of the bottle with
    ...
    <div class="t-slide flex  !text-white flex-col items-center justify-center text-start hidden">
        <div class="text-start ">
            ...
            <ol class="lesson-ul list-disc">
                ...
                <li> You may have a third bottle to compare newspaper too. Note
                    that newspaper will take a longer time to break down as compared to the toilet paper. You need to
                    shake it more vigorously.</li>
                <li> If children find it hard to see the results of the materials in the
    ...
    <div class="t-slide flex  !text-white flex-col items-center justify-center text-start hidden">
        ...
        <div>
            <h2 class="text-[2vw] stroke !text-white">Biodegradable Vs Non-biodegradable</h2>
