...
@section('content')
    ...
    <div class="slide hidden flex flex-col items-center">
        <div class="flex gap-2 items-center">
            <img src="{{ asset('assets/images/K2/sustain/Globalwarming/s16.png') }}"class="!max-w-[14vw]" />
            <img src="{{ asset('assets/images/K2/sustain/Globalwarming/s18.png') }}" class="!max-w-[14vw]" />
            <img src="{{ asset('assets/images/K2/sustain/Globalwarming/s23.png') }}"class="!max-w-[14vw]" />
        </div>
    ...
    {{-- slide 6 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/sustain/Globalwarming/s1.png') }}" class="w-img" />
