...
@section('content')
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[45vh]">
        ...
        <a href="https://www.youtube.com/watch?v=8q7_aV8eLUE"
            class="title stroke">https://www.youtube.com/watch?v=8q7_aV8eLUE </a>
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[45vh]">
        ...
        <a href="https://mycarbonfootprint.spgroup.com.sg/" class="title stroke">https://mycarbonfootprint.spgroup.com.sg/
        </a>
    ...
    {{-- Slide 20 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/sustain/carbon/c9.png') }}" class="w-img3" />
    ...
    {{-- Slide 31 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/sustain/carbon/c18.png') }}" class="w-img" />
        ...
        <p class="note">Note: Guide children to view and understand this video <br> <span class="text-[#F7B94A] stroke">
    ...
    {{-- Slide 33 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/sustain/carbon/c20.png') }}" class="w-img3" />
    ...
    {{-- Slide 42 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/sustain/carbon/c23.png') }}" class="w-img3" />
