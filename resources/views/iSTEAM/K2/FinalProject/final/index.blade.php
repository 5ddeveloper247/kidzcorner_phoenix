...
@section('content')
    ...
    <div id="topDiv" class="flex flex-col  gap-20 items-center ">
        <div class="  text-amber-300 text-[65px] font-extrabold stroke">Final Project</div>
        <h2 class="text-2xl sm:text-3xl lg:text-5xl text-white stroke ">
            Invent things that help to solve problems <br>
            based on the previously learnt knowledge</h2>
