...
@section('content')
    ...
    <div class=" slide flex text-2xl text-white flex-col justify-start text-start">
        <div>
            ...
            <ul class="list-disc ">
                ...
                <li class="text-[1.3vw]">Know that ScratchJr allows us to create our own animated stories</li>
                <li class="text-[1.3vw]">Know that more than a programme can be created for a character to do several
                ...
                <li class="text-[1.3vw]">Learn to cooperate with friends to complete a task</li>
            </ul>
        </div>
    ...
    {{-- slide 4 --}}
    <div class=" slide flex text-2xl text-white flex-col justify-start items-cente text-start">
