...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-center text-center z-[99] w-full">
        <h2 class="text-[50px] text-[#F7B94A] stroke">Animate a Character 3</h2>
        <div class="flex items-center justify-around w-full">

            {{-- Lesson Button --}}
            <a href="{{ route('animate3Lesson') }}" id="Lesson" class="flex flex-col gap-0">
                <img src="/assets/images/pptimages/lesson-btn.png" />
            </a>

            {{-- Teacher Button --}}
            <a href="{{ route('animate3Teacher') }}" id="Lesson" class="flex flex-col gap-0">
    ...
    <div id="buttons" class="absolute  flex flex-row gap-6 ">
        ...
        <!-- Return Button -->
        <a href="{{ route('animate3') }}" id="returnButton">
