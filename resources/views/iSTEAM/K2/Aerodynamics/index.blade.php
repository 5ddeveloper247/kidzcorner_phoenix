...
@section('content')
    ...
    <div class="board  flex flex-col justify-center  items-center">
        ...
        <h2 class="text-[#F7B94A] stroke board-title">Aerodynamics</h2>
        ...
        <div class="flex flex-wrap justify-center items-center gap-[2vw]">
            ...
            <a href="{{ route('Aerodynamics1') }}"
                ...
                <h2 class="text-[1.51vw] text-[#7D6F71]">What is <br> Aerodynamics? <br> 1</h2>
            ...
            <a href="{{ route('Aerodynamics2') }}"
                style="background-image: url('{{ asset('/assets/images/pptimages/Property1.png') }}');"
                class=" bg-no-repeat bg-contain bg-center   w-[13.594vw] h-[11.198vw] relative flex justify-center items-center transition hover:brightness-110">
                <h2 class="text-[1.51vw] text-[#7D6F71]">What is <br> Aerodynamics? <br> 2</h2>
            ...
            <a href="{{ route('Hydrodynamics') }}"
                style="background-image: url('{{ asset('/assets/images/pptimages/Property1.png') }}');"
                class=" bg-no-repeat bg-contain bg-center   w-[13.594vw] h-[11.198vw] relative flex justify-center items-center transition hover:brightness-110">
                <h2 class="text-[1.51vw] text-[#7D6F71]">Hydrodynamics</h2>
            ...
            <a href="{{ route('Evolution') }}"
                style="background-image: url('{{ asset('/assets/images/pptimages/Property1.png') }}');"
                class=" bg-no-repeat bg-contain bg-center   w-[13.594vw] h-[11.198vw] relative flex justify-center items-center transition hover:brightness-110">
                <h2 class="text-[1.51vw] text-[#7D6F71]">Evolution of <br> Aeroplanes</h2>
            ...
            <a href="{{ route('Flying') }}"
                style="background-image: url('{{ asset('/assets/images/pptimages/Property1.png') }}');"
                class=" bg-no-repeat bg-contain bg-center   w-[13.594vw] h-[11.198vw] relative flex justify-center items-center transition hover:brightness-110">
                <h2 class="text-[1.51vw] text-[#7D6F71]">Flying <br> Machines</h2>
