...
@section('content')
    ...
    {{-- slide 11 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/aero/aero1/a22.png') }}" class="img-xl" />
        <h2 class="title stroke">But how do aeroplanes move forward after taking off?</h2>
        <p class="note">Note: Encourage children to share their answers.</p>
    </div>

    {{-- slide 12 --}}
    <div class="slide hidden  flex flex-col items-center h-[15vw] justify-between ">
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[28vw]">
        ...
        <img src="{{ asset('assets/images/K2/aero/aero1/a23.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        ...
        <img src="{{ asset('assets/images/K2/aero/aero1/a24.png') }}" class="img-md" />
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        ...
        <img src="{{ asset('assets/images/K2/aero/aero1/a25.png') }}" class="img-xl" />
    </div>
    ...
    {{-- Slide 18 --}}
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a47.png') }}" class="img-lg" />
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[28vw]">
        ...
        <img src="{{ asset('assets/images/K2/aero/aero1/a27.png') }}" class="img-xl" />
    ...
    {{-- Slide 24 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a48.png') }}" class="img-lg" />
    ...
    {{-- Slide 28 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a45.png') }}" class="img-lg" />
    ...
    {{-- Slide 35 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a32.png') }}" class="img-lg" />
    ...
    {{-- Slide 36 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a50.png') }}" class="img-lg" />
    ...
    {{-- Slide 37 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a51.png') }}" class="img-lg" />
    ...
    {{-- Slide 38 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a33.png') }}" class="img-lg" />
