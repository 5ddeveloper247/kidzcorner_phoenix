...
@section('content')
    ...
    {{-- Slide 5 --}}
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a40.png') }}" class="!max-w-[42vw]" />
    ...
    {{-- slide 6 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/aero/aero1/a42.png') }}" class="!max-w-[42vw]" />
        <h2 class="title stroke">Lift is a force that pushes something up.</h2>
    </div>

    {{-- slide 7 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/aero/aero1/a43.png') }}" class="!max-w-[42vw]" />
        <h2 class="title stroke">The force of lift is generated by the wings.</h2>
    </div>

    {{-- slide 8 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/aero/aero1/a12.png') }}" class="!max-w-[42vw]" />
    ...
    {{-- slide 10 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/aero/aero1/a41.png') }}" class="!max-w-[43vw]" />
    ...
    {{-- slide 11 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/aero/aero1/a22.png') }}" class="w-img3" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="self-start text-start title stroke">
            ...
            <ol class="list-decimal lesson-ul" start="1">
                <li>Observe and talk about the setup.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/aero/aero1/a23.png') }}" class="w-img3" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="self-start text-start title stroke">
            ...
            <ol class="list-decimal lesson-ul" start="2">
                <li>Pull the balloon as close to the chair as possible.</li>
            </ol>
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="self-start text-start title stroke">
            ...
            <ol class="list-decimal lesson-ul" start="3">
                <li>Release the clip but press onto the mouth of the balloon so that air will not escape</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/aero/aero1/a25.png') }}" class="w-img3" />
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="self-start text-start title stroke">
            ...
            <ol class="list-decimal lesson-ul" start="4">
                <li>Release the mouth of the balloon and share your observation</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/aero/aero1/a23.png') }}" class="w-img3" />
    ...
    {{-- Slide 18 --}}
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a47.png') }}" class="!max-w-[42vw]" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        ...
        <img src="{{ asset('assets/images/K2/aero/aero1/a27.png') }}" class="w-img3" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="self-start text-start title stroke">
            <h2>Steps:</h2>
            <ol class="list-decimal lesson-ul" start="2">
                <li>Pull the 2 balloons as close to the chair as possible. Release the balloons simultaneously. Observe the
                    distance travelled by both balloons. Share and discuss your observation.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/aero/aero1/a27.png') }}" class="w-img3" />
    </div>
    ...
    {{-- Slide 24 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a48.png') }}" class="!max-w-[42vw]" />
    ...
    {{-- Slide 25 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a29.png') }}" class="w-img3" />
    ...
    {{-- Slide 28 --}}
    <div class="slide hidden flex flex-col items-center justify-center ">
        <img src="{{ asset('assets/images/K2/aero/aero1/a45.png') }}" class="!max-w-[42vw]" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center ">
        ...
        <!-- Video Trigger Button -->
        <div class="absolute top-1/2 right-[-10vw] z-[99] -translate-y-1/2 video-btn " onclick="toggleVideo('video3')">
            <img src="{{ asset('/assets/images/pptimages/video.png') }}" />
        </div>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center ">
        ...
        <!-- Video Trigger Button -->
        <div class="absolute top-1/2 right-[-10vw] z-[99] -translate-y-1/2 video-btn " onclick="toggleVideo('video4')">
            <img src="{{ asset('/assets/images/pptimages/video.png') }}" />
        </div>
    </div>
