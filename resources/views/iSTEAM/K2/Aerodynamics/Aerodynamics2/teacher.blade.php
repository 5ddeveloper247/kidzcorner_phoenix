...
@section('content')
    ...
    {{-- slide 2 --}}
    <div class="flex t-slide !text-white flex-col  text-start">
        <div>
    ...
    {{-- sldie 3 --}}
    <div class=" t-slide flex  !text-white flex-col items-center justify-around  text-start">
        <div>
    ...
    <div class=" t-slide flex !text-white flex-col items-center justify-center  text-start">
        ...
        <div class="flex items-center gap-5">
            <img src="{{ asset('assets/images/K2/aero/aero1/a38.png') }}" class="img-sm" />
            <img src="{{ asset('assets/images/K2/aero/aero1/a39.png') }}" class="img-sm" />
        </div>
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher" class="absolute teacher-img1" />
    </div>
