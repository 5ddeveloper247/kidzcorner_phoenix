...
@section('content')
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <div class="title stroke  self-start text-start">
            ...
            <ol class="list-decimal lesson-ul" start="1">
                <li>
                    Hold the wing model this way (as shown) in front of a fan.
                    Ensure that the model is facing the centre part of the fan.
                    Turn on the fan and observe the movement of the model.
                </li>
            </ol>
        </div>
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <div class="title stroke  self-start text-start">
            ...
            <ol class="list-decimal lesson-ul" start="2">
                <li>
                    Repeat step 1 by holding the wing model this way instead
                    (as shown) in front of a fan. Share your observations.
                </li>
            </ol>
        </div>
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        ...
        <div class="absolute top-1/2 right-[-10vw] z-[99] -translate-y-1/2 video-btn " onclick="toggleVideo('video1')">
