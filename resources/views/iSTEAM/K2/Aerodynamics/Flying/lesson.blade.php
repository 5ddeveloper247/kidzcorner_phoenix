...
@section('content')
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        <img src="{{ asset('assets/images/K2/aero/hydro/h1.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/hydro/h4.png') }}" class="img-xl" />
    ...
    <div class="slide hidden  flex flex-col items-center justify-start  ">
        <img src="{{ asset('assets/images/K2/aero/hydro/h5.png') }}" class="img-lg" />
    ...
    {{-- slide 6 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/hydro/h6.png') }}" class="img-lg" />
    ...
    {{-- slide 7 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/hydro/h7.png') }}" class="img-xl" />
    ...
    {{-- slide 8 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/hydro/h8.png') }}" class="img-xl" />
    ...
    {{-- slide 10 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/hydro/h21.png') }}" class="img-semi-lg" />
    ...
    {{-- slide 18 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/aero1/a29.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center">
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/K2/aero/evo/e12.png') }}" class="img-sm" />
            <img src="{{ asset('assets/images/K2/aero/evo/e19.png') }}" class="img-sm" />
        </div>
    ...
    {{-- slide 20 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/evo/e12.png') }}" class="img-lg" />
    ...
    {{-- slide 26 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/evo/e20.png') }}" class="img-semi-lg" />
    ...
    {{-- slide 28 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/evo/e24.png') }}" class="img-md" />
    ...
    {{-- slide 29 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/evo/e24.png') }}" class="img-semi-lg" />
    ...
    {{-- slide 30 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/evo/e21.png') }}" class="img-lg" />
    ...
    {{-- slide 31 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/evo/e22.png') }}" class="img-md" />
    ...
    {{-- slide 32 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/aero/evo/e23.png') }}" class="img-md" />
    ...
    {{-- Slide 37 --}}
    <div class="slide hidden  flex flex-col items-center   ">
        <img src="{{ asset('assets/images/K2/aero/evo/e26.png') }}" class="img-lg" />
    ...
    {{-- Slide 39 --}}
    <div class="slide hidden  flex flex-col items-center   ">
        <img src="{{ asset('assets/images/K2/aero/evo/e27.png') }}" class="img-lg" />
    ...
    {{-- Slide 40 --}}
    <div class="slide hidden  flex flex-col items-center   ">
        <img src="{{ asset('assets/images/K2/aero/evo/e28.png') }}" class="img-lg" />
    ...
    <div class="slide  hidden flex flex-col items-center justify-center gap-y-4">
        ...
        <div class="w-[55vw] h-[25vw] drawable bg-cover bg-center p-[20px] text-startphp"
