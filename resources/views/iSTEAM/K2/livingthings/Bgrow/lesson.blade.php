...
@section('content')
    ...
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b1.png" />
    ...
    {{-- Slide 2 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b2.png" />
    ...
    {{-- Slide 4 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b3.png" />
    ...
    {{-- slide 6 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b4.png" />
    ...
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        ...
        <img src="/assets/images/K2/livingthings/bg/b5.png" />
    ...
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        ...
        <img src="/assets/images/K2/livingthings/bg/b6.png" />
        <p class="note">Note: Guide children to make conclusions from their own test results.</p>
    ...
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        ...
        <img src="/assets/images/K2/livingthings/bg/b7.png" />
        <p class="note">Note: Guide children to make conclusions from their own test results.</p>
    ...
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        ...
        <img src="/assets/images/K2/livingthings/bg/b8.png" />
        <p class="note">Note: Guide children to make conclusions from their own test results.</p>
    ...
    {{-- slide 16 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b9.png" />
    ...
    {{-- slide 17 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b10.png" />
    ...
    {{-- slide 18 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b11.png" />
    ...
    {{-- slide 19 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b12.png" />
    ...
    {{-- slide 21 --}}
    <div class="slide flex flex-col items-center justify-center gap-5 ">
        <img src="/assets/images/K2/livingthings/bg/b13.png" />
