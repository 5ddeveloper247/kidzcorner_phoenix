...
@section('content')
            ...
            <div class="title stroke text-start">
                ...
                <ul class="!text-white">
                    <li class="flex items-center gap-5">
                        <img src="{{ asset('assets/images/N2/LivingThings/an65.png') }}" class="w-[2.5vw]" />
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/livingthings/pthings/p24.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="flex items-center gap-5">
            <img src="{{ asset('assets/images/K2/livingthings/dna/d1.png') }}" class="img-sm" />
    ...
    {{-- Slide 7 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d3.png') }}" class="img-xl" />
    ...
    {{-- Slide 8 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d4.png') }}" class="img-xl" />
    ...
    {{-- Slide 9 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d5.png') }}" class="img-xl" />
    ...
    {{-- Slide 10 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d6.png') }}" class="img-xl" />
    ...
    {{-- Slide 11 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d7.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="flex items-center gap-5">
            <img src="{{ asset('assets/images/K2/livingthings/dna/d8.png') }}" class="img-sm" />
            <img src="{{ asset('assets/images/K2/livingthings/dna/d9.png') }}" class="img-sm" />
        </div>
    ...
    {{-- Slide 14 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d10.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[30vw]">
        <div class="text-start">
            ...
            <ol class="lesson-ul list-decimal title stroke" start="1">
                <li>Mix together 100ml distilled water and half a teaspoon of salt in a cup.</li>
            </ol>
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="text-start">
            ...
            <ol class="lesson-ul list-decimal title stroke" start="4">
                <li>Spit the water back into the cup.</li>
            </ol>
        </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="text-start">
            ...
            <ol class="lesson-ul list-decimal title stroke" start="5">
                <li>Add one drop of clear liquid dish soap to the cup. Stir gently to avoid making bubbles.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/livingthings/dna/d16.png') }}" class="img-xl" />
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="text-start">
            ...
            <ol class="lesson-ul list-decimal title stroke" start="6">
                <li>Mix together 30ml cold rubbing alcohol and 3 drops food colouring in another cup.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/livingthings/dna/d17.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="text-start">
            ...
            <ol class="lesson-ul list-decimal title stroke" start="7">
                <li>Gently pour the alcohol mixture from the side into the cup with gargled water.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/livingthings/dna/d18.png') }}" class="img-xl" />
    ...
    {{-- Slide 28 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d20.png') }}" class="img-md" />
    ...
    {{-- Slide 35 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d23.png') }}" class="img-md" />
