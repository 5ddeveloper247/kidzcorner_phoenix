...
@section('content')
    ...
    <div class="slide hidden flex flex-col items-center justify-center gap-5">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/f10.png') }}" class="img-lg" />
        <div class="title stroke">
            <h2>Children, as you know, <span class="!text-white">fingerprints</span> are
                <span class="!text-white">ridges</span> on the tips of our <span class="!text-white">fingers</span> and <span
    ...
    {{-- Slide 8 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp4.png') }}" class="img-h-md" />
    ...
    {{-- Slide 9 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp5.png') }}" class="img-xl" />
    ...
    {{-- Slide 10 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp6.png') }}" class="img-lg" />
    ...
    {{-- Slide 11 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp7.png') }}" class="img-lg" />
    ...
    {{-- Slide 12 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp8.png') }}" class="img-h-md" />
    ...
    {{-- Slide 13 --}}
    <div class="slide hidden flex flex-col items-center">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp9.png') }}" class="img-lg" />
    ...
    <div class="slide hidden flex flex-col items-center justify-start">
        <div class="self-start text-start">
            ...
            <ol class="lesson-ul list-decimal stroke">
               <li>Observe each fingerprint to find out which pattern it has.
                Write down the result of comparison at the side of each
                fingerprint in the record.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp10.png') }}" class="img-md" />
    ...
    {{-- Slide 17 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp10.png') }}" class="img-lg" />
        <div class="self-start text-start">
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[32vw]">
        <div class="self-start text-start">
            <h2 class="title stroke text-start">Let's do:</h2>
            <ol class="lesson-ul list-decimal stroke">
                <li>Which fingerprint pattern do you have on each finger?
                    Record them in a table.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp11.png') }}" class="img-xl" />
    ...
    <div class="slide hidden flex flex-col items-center justify-between h-[32vw]">
        <div class="self-start text-start">
            ...
            <ol class="lesson-ul list-decimal stroke" start="2">
                <li>Create a graph to show the numbers of fingerprint
                    patterns in the class.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp12.png') }}" class="img-xl" />
        <p class="note">Note: Guide children to count from the record table and create the graph.</p>
    </div>

    {{-- Slide 27 --}}
    <div class="slide hidden flex flex-col items-center justify-center gap-y-2">
        <img src="{{ asset('assets/images/K2/livingthings/fingerprints/fp13.png') }}" class="img-sm" />
