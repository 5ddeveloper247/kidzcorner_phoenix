...
@section('content')
    ...
    {{-- sldie 3 --}}
    <div class="flex flex-col hidden justify-start items-center  t-slide  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k18.png') }}" class="img-md" />
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher" class="absolute teacher-img1" />
    </div>
    ...
    <div class="flex flex-col hidden justify-start items-center  t-slide  ">
        ...
        <img src="/assets/images/K2/livingthings/killing/k13.png" class="img-md" />
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher" class="absolute teacher-img1" />
    </div>
    ...
    <div class="flex flex-col hidden justify-start items-center  t-slide  ">
        ...
        <img src="/assets/images/K2/livingthings/killing/k20.png" class="img-xl" />
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher" class="absolute teacher-img1" />
    </div>
    ...
    <div class="flex flex-col hidden justify-start items-center  t-slide  ">
        ...
        <img src="/assets/images/K2/livingthings/killing/k15.png" class="img-md" />
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher" class="absolute teacher-img1" />
    </div>
    ...
    <div class="flex flex-col hidden justify-start items-center t-slide  ">
        ...
        <img src="/assets/images/K2/livingthings/killing/k16.png" class="img-xl" />
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher" class="absolute teacher-img1" />
    </div>
    ...
    <div class="flex flex-col hidden justify-start items-center  t-slide  ">
        ...
        <img src="/assets/images/K2/livingthings/killing/k17.png" class="img-md" />
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher" class="absolute teacher-img1" />
    </div>
    ...
    {{-- slide 30 --}}
    <div class="flex flex-col hidden items-center justify-center t-slide">
        <h2 class="title stroke">Learning Centre Idea</h2>
        <div class="!text-white !text-start">
            <h2 class="text-[2vw] stroke !text-white">Fun Fact</h2>
            ...
            <ul class="pl-[2vw] list-disc space-y-3">
                <li>There are around 40 million bacteria in a gram of soil.</li>
                <li>Scientists estimate that bacteria produce nearly half the oxygen
                    (plants and animals need this type of gas to survive) found in the
                    world.</li>
