...
@section('content')
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k1.png') }}" class="w-img" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k2.png') }}" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        <div class="flex justify-center items-center">
            ...
            <img src="{{ asset('/assets/images/K2/livingthings/killing/k3.png') }}" class="!h-[18vw]" />
            <img src="{{ asset('/assets/images/K2/livingthings/killing/k4.png') }}" />
        </div>
    ...
    {{-- Slide 5  --}}
    <div class="slide flex flex-col items-center justify-center  ">
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k5.png') }}" class="w-img3" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k7.png') }}" class="!max-w-[12vw]" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k8.png') }}" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k6.png') }}" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        <h2 class="title stroke !text-start">Let's do: <br>
            1. (G1 & G2) Use a cotton bud to go through hand of a group 
    ...
    <div class="slide flex flex-col items-center justify-center !gap-[.5vw  ]  ">
        ...
        <div class=" flex gap-1">
            ...
            <img src="{{ asset('/assets/images/K2/livingthings/killing/k12.png') }}" class="large-img4" />
        </div>
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k13.png') }}" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k14.png') }}" class="w-img3" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k15.png') }}" class="w-img3" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k16.png') }}" class="w-img3" />
    ...
    <div class="slide flex flex-col items-center justify-center  ">
        ...
        <img src="{{ asset('/assets/images/K2/livingthings/killing/k17.png') }}" />
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const doneButtonRoute = "{{ route('killingSelection') }}";
