...
@section('content')
    ...
    <div class=" slide flex text-2xl text-white flex-col justify-start gap-y-10 text-start">
        <div>
            ...
            <ul class="list-disc ">
                <li class="text-[1.3vw]">Learn how to extract DNA from a tomato</li>
                <li class="text-[1.3vw]">Know that the same chemicals can be used to extract DNA from different living things</li>
                <li class="text-[1.3vw]">Know that a strand of DNA is a long string</li>
                <li class="text-[1.3vw]">Know that all living things have DNA</li>
        ...
        <div class="flex flex-col  items-start justify-between">
            ...
            <div >
                <ul class="list-disc ">
                    ...
                    <li class="text-[1.3vw]">DNA</li>
                    <li class="text-[1.3vw]">Cell</li>
                    <li class="text-[1.3vw]">String</li>
                </ul>
                <ul class="list-disc ">
                    <li class="text-[1.3vw]">Animals</li>
                    <li class="text-[1.3vw]">Plants</li>
                    <li class="text-[1.3vw]">Chemical</li>
                </ul>
            </div>
        </div>
    ...
    <div class=" slide flex text-2xl text-white flex-col justify-start gap-y-10 text-start">
        <div>
            ...
            <ul class="list-disc ">
                ...
                <li class="text-[1.3vw]">1 bottle of distilled water (normally sold in 500ml bottles; will use 100ml)</li>
                <li class="text-[1.3vw]">Some salt</li>
                <li class="text-[1.3vw]">2 clear plastic cups or glasses</li>
                <li class="text-[1.3vw]">1 bottle of clear liquid dish soap</li>
                <li class="text-[1.3vw]"> 1 bottle of rubbing alcohol (for better results, try to find 90% isopropyl alcohol; use 30ml ice-cold
                    alcohol — put the alcohol in the freezer one day before the activity)</li>
                <li class="text-[1.3vw]">1 teaspoon</li>
                <li class="text-[1.3vw]">1 strainer (can be replaced with a piece of coffee filter paper)</li>
                <li class="text-[1.3vw]">1 measuring cup (at least 100ml)</li>
            </ul>
        </div>
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="Teacher"
            class="absolute teacher-img1" />
    ...
    <div class="text-white flex flex-col items-center justify-center gap-y-10 text-start text-2xl slide hidden">
        ...
        <div>
            <ul>
                ...
                <li class="text-[1.3vw]">Put the final result of the activity (the filtered liquid of tomato
    ...
    <div class="text-white flex flex-col items-center justify-center gap-y-10 text-start text-2xl slide hidden">
        ...
        <div>
            <ul class="list-disc">
                ...
                <li class="text-[1.3vw]">Your DNA is 60% identical to the DNA of tomatoes!</li>
                <li class="text-[1.3vw]">Your DNA is 50% identical to the DNA of bananas!</li>
                <li class="text-[1.3vw]">Your DNA is 40-50% identical to the DNA of cabbages!</li>
            </ul>
        </div>
        <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" class="absolute teacher-img1" />
    </div>
    ...
    <div class="text-white flex flex-col items-center justify-center gap-y-10 text-start text-2xl slide hidden">
        ...
        <div>
            <div>
                <h2 class="!text-white title stroke">Fun Facts</h2>
                <h2 class="t-title">What and how to set up:</h2>
                <p class="text-[1.3vw]">Prepare things as listed in the preparations and other fruits or
            ...
            <div>
                ...
                <p class="text-[1.3vw]">Guide children to repeat the DNA extraction steps in the lesson for
