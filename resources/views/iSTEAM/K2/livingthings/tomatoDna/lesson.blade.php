...
@section('content')
    ...
    <div class="slide flex flex-col items-center justify-center gap-[1vw]">
        <img src="{{ asset('assets/images/K2/livingthings/dna/td1.png') }}" class="img-xl" />
        <div class="title stroke">
            <h2>Children, do you still remember how to extract DNA from one's mouth? What does DNA look like?</h2>
        </div>
    ...
    <div class="slide hidden flex flex-col items-center">
        ...
        <p class="note">Note: Guide children to recap the points learnt [1. Like a set of building bricks will form an
            object correctly based on its instruction manual, every living thing has its own instruction manual called DNA
            that guide them on how to form and work correctly. 2. Living things are made up of cells and DNA is stored in
            the cells.]</p>
    </div>
    ...
    {{-- Slide 5 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <h2 class="title stroke">Now we'll learn how to extract DNA from a tomato. We'll also find out if the same chemicals
            will be used to extract DNA from a tomato.</h2>
    </div>

    {{-- Slide 6 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <h2 class="text-center justify-start text-[45px] !text-white stroke">Class Activity</h2>
        <img src="{{ asset('assets/images/K2/livingthings/dna/td2.png') }}" class="img-sm" />
        <h2 class="title stroke text-start">Let's find out: <br>How to extract DNA from a tomato?</h2>
    </div>
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        ...
        <div class="text-start">
            <h2 class="title stroke">What do you observe: <br>What happens in the cup?</h2>
        </div>
    </div>
    ...
    {{-- Slide 21 --}}
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/K2/livingthings/dna/d22.png') }}" class="img-lg" />
        <h2 class="title stroke">In fact, a strand of DNA is a long string but too small to be visible to our eyes.</h2>
    </div>
    ...
    {{-- Slide 24 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/td13.png') }}" class="img-lg" />
        <h2 class="title stroke">This is the image drawing of a tomato under a microscope. DNA is stored in the cells.</h2>
    </div>

    {{-- Slide 25 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/td14.png') }}" class="img-lg" />
        <h2 class="title stroke">The <span class="!text-white">chemicals</span> used in the process break down the outer
            covering of tomato <span class="!text-white">cells</span> and release <span class="!text-white">DNA</span>
            from the <span class="!text-white">cells</span>.</h2>
    </div>

    {{-- Slide 26 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/td15.png') }}" class="img-lg" />
        <h2 class="title stroke">As a matter of fact, the same chemicals have been used to extract our DNA, as well as a
            tomato's DNA.</h2>
    ...
    {{-- Slide 27 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/td16.png') }}" class="img-lg" />
        <h2 class="title stroke">Based on the results of the activities, we can conclude that both animals and plants have
            DNA.</h2>
    </div>

    {{-- Slide 28 --}}
    <div class="slide hidden flex flex-col items-center justify-start">
        <img src="{{ asset('assets/images/K2/livingthings/dna/td17.png') }}" class="img-lg" />
        <h2 class="title stroke"><span class="!text-white">Animals</span> and <span class="!text-white">plants</span> are
            <span class="!text-white">living things</span>, so we can summarize that <span class="!text-white">all living
                things have DNA</span>!</h2>
    </div>
