...
@section('content')
    ...
    <div id="topDiv" class="flex flex-col  h-[90%] items-center gap-20 ">
        <div class="  text-amber-300 text-[65px] font-extrabold stroke">Sound and Light</div>
        <h2 class="text-2xl sm:text-3xl lg:text-6xl text-white text-center stroke ">
