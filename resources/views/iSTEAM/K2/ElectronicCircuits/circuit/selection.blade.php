...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-around relative text-center z-[99]w-full h-full">
        <h2 class="text-[50px] text-[#F7B94A]  stroke">What is an Electronic Circuit?</h2>
        <div class="flex items-center justify-between gap-[10vw]">

            {{-- Lesson Button --}}
            <a href="{{ route('circuitLesson') }}" id="Lesson" class="flex flex-col gap-0">
            ...
            {{-- Teacher Button --}}
            <a href="{{ route('circuitTeacher') }}" id="Lesson" class="flex flex-col gap-0">
