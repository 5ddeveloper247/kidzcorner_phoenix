...
@section('content')
    ...
    {{-- sldie 4 --}}
    <div class="text-start t-slide !text-white space-y-[1vw]">
        <div>
        ...
        <div>
            ...
            <ul class="list-disc pl-[1vw]">
                ...
                <li>
                    ...
                    You may try turning them into keypads together with children.Please don't try on food items like gummy
                    candy or pizza to avoid food wastage.
                </li>
            </ul>
        </div>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            returnBtn.addEventListener("click", () => {
                if (currentIndex === 0) {
                    ...
                    window.location.href = "{{ route('makey2Selection') }}";
                } else {
