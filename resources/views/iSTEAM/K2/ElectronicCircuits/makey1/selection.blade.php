...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-around relative text-center z-[99]w-full h-full">
        <h2 class="text-[50px] text-[#F7B94A]  stroke">Makey Makey (1)</h2>
        <div class="flex items-center justify-between gap-[10vw]">

            {{-- Lesson Button --}}
            <a href="{{ route('makey1Lesson') }}" id="Lesson" class="flex flex-col gap-0">
            ...
            {{-- Teacher Button --}}
            <a href="{{ route('makey1Teacher') }}" id="Lesson" class="flex flex-col gap-0">
