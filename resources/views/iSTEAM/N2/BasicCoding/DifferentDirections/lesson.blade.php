...
@section('content')
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs1a.png') }}" class="img-xl">
    ...
    {{-- Slide 3 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs6.png') }}" class="img-lg" />
    ...
    {{-- slide 5 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs3.png') }}" class="img-lg" />
        <h2 class="stroke title">Which<span class="!text-white"> direction</span> are these <span
                class="text-white">arrows</span> pointing to?</h2>
        <p class="note">Note: Have children recall and share what they have learnt.</p>
    </div>
    ...
    {{-- slide 8 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs21.png') }}" class="img-h-md" />
    ...
    {{-- slide 9 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs21.png') }}" class="rotate-[180deg] img-h-md" />
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        <div class="flex items-center justify-center">
            <img src="{{ asset('assets/images/N2/BasicCoding/bs23.png') }}" class="img-h-md" />
            <img src="{{ asset('assets/images/N2/BasicCoding/bs22.png') }}" class="img-h-md" />
        </div>
        <h2 class="stroke title">Move backward.</h2>
        <p class="note">Note: Guide children to move accordingly.</p>
    </div>
    ...
    {{-- slide 15 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs4.png') }}" class="img-lg">
    ...
    {{-- slide 17 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs5.png') }}" class="img-lg">
        <h2 class="stroke title">Which direction is this arrow pointing to?
            What instruction does it give?</h2>
    ...
    {{-- slide 19 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs25.png') }}" class="img-lg">
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        <div class="flex items-start">
            <p class="text-white text-[2vw]">This is my left arm!</p>
            <img src="{{ asset('assets/images/N2/BasicCoding/bs8.png') }}" class="img-h-md">
        </div>
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        <div class="flex flex-row-reverse items-start">
            <p class="text-white text-[2vw]">This is my right arm!</p>
            <img src="{{ asset('assets/images/N2/BasicCoding/bs9.png') }}" class="img-h-md">
        </div>
    ...
    {{-- slide 26 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs26.png') }}" class="img-h-md">
        <h2 class="stroke title">Which is pointing to the <span class="!text-white">left</span>? Which is pointing to the
            <span class="!text-white">right</span>?
        </h2>
        <p class="note">Note: Have children come forward to point out the answers.</p>
    ...
    {{-- slide 27 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs24.png') }}" class="img-h-md">
        <h2 class="stroke title">Which is pointing to the <span class="!text-white">left</span>? Which is pointing to the
            <span class="!text-white">right</span>?
        </h2>
        <p class="note">Note: Have children come forward to point out the answers.</p>
