...
@section('content')
    {{-- title --}}
    <h2 class="top-title stroke">Directional Signs</h2>

    {{-- Slide 1 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs1.png') }}" class="img-lg">
    ...
    <div class="slide hidden flex flex-col items-center justify-center">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs2.png') }}" class="img-lg"  />
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        ...
        <h2 class="stroke title">It also has an <span class="!text-white">arrow </span>pointing <span
                class="text-white">right</span> to the escalators.So if you need the escalators., you should turn<span
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        ...
        <h2 class="stroke title">It also has an <span class="!text-white">arrow</span> pointing <span
                class="text-white">right</span> to the escalators.So if you need escalators, you should turn <span
                class="text-white">right</span>.</h2>
    </div>
    ...
    {{-- slide 9 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/BasicCoding/bs7.png') }}" class="img-lg" />
        <h2 class="stroke title">These <span class="!text-white">arrows</span> on a train platform are pointing <span
                class="text-white">backward</span>.For your safety, you should move <span
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        ...
        <h2 class="stroke title"><span class="!text-white">Directional signs</span> use
            <span class="!text-white">arrows</span> to show us which way to go.They give us
