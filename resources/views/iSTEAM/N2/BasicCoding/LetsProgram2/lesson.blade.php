        ...
        @section('content')
            ...
            <div class="slide flex flex-col items-center justify-center  ">
                <img src="{{ asset('assets/images/N2/BasicCoding/bs31.png') }}" class="img-lg" />
            ...
            <div class="flex flex-col items-center justify-center gap-5 slide hidden">
                <div class="flex flex-col items-center">
                    <img src="{{ asset('assets/images/N2/BasicCoding/bs14.png') }}" class="img-xl" />
                    <div class="flex !text-white text-[1.5vw] W-[100%] justify-between  ">
                        <p>forwar</p>
                        <p>bakcward</p>
                        <p>turn left</p>
                        <p>turn right</p>
            ...
            <div class="flex flex-col items-center justify-center slide hidden">
                <div class="flex justify-center items-center flex-col">
                    <img src="{{ asset('assets/images/N2/BasicCoding/bs33.png') }}" class="img-lg" />
                    <img src="{{ asset('assets/images/N2/BasicCoding/bs32.png') }}" class="img-lg" />
                </div>
