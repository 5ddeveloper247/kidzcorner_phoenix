...
@section('content')
    ...
    {{-- title  --}}
    <h2 class="top-title stroke">How do Animals Grow?</h2>
    ...
    <div class="flex !text-white flex-col justify-start t-slide  text-start ">
        ...
        <div class="flex flex-col gap-[1vw] border-4 border-white border">
            <h2 class="t-title">Dear Parents</h2>
            ...
            <p>You may send us the soft copy of the photo via Commapp or email. Thephotos will be used in
                our class
                activity.</p>
        </div>
    </div>
    ...
    {{-- slide 3 --}}
    <div class="flex !text-white justify-start t-slide  text-start  ">
        <div>
    ...
    {{-- slide 4 --}}
    <div class="text-white flex text-start t-slide hidden">
        <div>
    ...
    {{-- slide 6 --}}
    <div class="text-white t-slide flex flex-col text-start hidden">
        <h2 class=" title stroke text-center">Learning Centre Idea</h2>
        <div>
            <h2 class="!text-white text-[2vw] stroke">Stages of Growth of a Person</h2>
    ...
    {{-- slide 7 --}}
    <div class="text-white flex t-slide flex-col text-start hidden">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            returnButton.addEventListener("click", () => {
                if (currentSlide === 0) {
                    //  Redirect to your desired route when on first slide
