...
@section('content')
    ...
    {{-- slide 4 --}}
    <div class="text-white flex text-start text-2xl t-slide slide hidden">
        <div>
            <h2 class=" t-title underline">Things to consider during discussion:</h2>
            <ul class="list-disc">
                <li>
    ...
    {{-- slide 6 --}}
    <div class="text-white t-slide flex flex-col text-start text-2xl slide hidden">
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            returnButton.addEventListener("click", () => {
                if (currentSlide === 0) {
                    ...
                    window.location.href = "{{ route('GrowthSelection') }}"; // Change 'YourRouteName' to your actual route
