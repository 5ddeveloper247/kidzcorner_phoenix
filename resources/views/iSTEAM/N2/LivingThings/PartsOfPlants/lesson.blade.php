...
@section('content')
    ...
    {{-- Slide 3 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt22.png') }}" class="img-md" />
    ...
    <div class="flex items-center flex-col slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt32p.png') }}" class="img-lg" />
    ...
    {{-- slide 8 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt33p.png') }}" class="img-lg" />
    ...
    {{-- slide 15 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt35p.png') }}" class="img-xl" />
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        <div class="flex items-center justify-center">
            <img src="{{ asset('assets/images/N2/LivingThings/lt26.png') }}" class="img-h-sm" />
            <img src="{{ asset('assets/images/N2/LivingThings/lt46.png') }}" class="img-h-sm" />
            <img src="{{ asset('assets/images/N2/LivingThings/lt47.png') }}" class="img-h-sm" />
            <img src="{{ asset('assets/images/N2/LivingThings/lt48.png') }}" class="img-h-sm" />
        </div>
    ...
    {{-- slide 17 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt49.png') }}" class="img-md" />
    ...
    {{-- slide 18 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt50.png') }}" class="img-md" />
    ...
    {{-- slide 18 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt53.png') }}" class="img-lg" />
    ...
    {{-- slide 19 --}}
    <div class="flex flex-col items-center justify-center slide hidden">
        <img src="{{ asset('assets/images/N2/LivingThings/lt36p.png') }}" class="img-lg" />
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
        ...
        <div class="w-[55vw] h-[25vw] drawable bg-cover bg-center flex flex-col items-center"
            ...
            <img src="{{ asset('assets/images/N2/LivingThings/lt52.png') }}" class="img-h-sm" />
        </div>
    </div>
