...
@section('content')
    ...
    {{-- slide 2 --}}
    <div class="flex flex-col justify-center !text-white text-start t-slide ">
        <div>
    ...
    {{-- slide 5 --}}
    <div class="text-white flex flex-col text-start t-slide items-center justify-center hidden">
        <h2 class="title stroke">Learning Centre Idea</h2>
        <div>
            <h2 class="!text-white text-[2vw] stroke">Closer Look at a Flower</h2>
    ...
    <div class="text-white flex flex-col text-start t-slide items-center justify-center hidden">
        <h2 class="title stroke">Learning Centre Idea</h2>
        <div>
            <h2 class="!text-white text-[2vw] stroke">Let’s Make A Flower</h2>
            <h2 class=" t-title">What and how to set up:</h2>
