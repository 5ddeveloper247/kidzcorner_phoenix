...
@section('content')
    ...
    <div id="topDiv" class="flex flex-col items-center ">
        ...
        <h2
            class="text-2xl sm:text-3xl lg:text-6xl text-white max-w-5xl leading-snug flex flex-col items-center space-x-[30px]">Learn about the characteristics of living things;
