...
@section('content')
    ...
    <div class="flex flex-col items-center justify-center gap-10 slide hidden">
        <h2 class="stroke title">Children, do you remember what the stem does?</h2>
    ...
    <div class="flex flex-col items-center justify-center slide hidden">
       ...
       <h2 class="stroke title">That’s right! The <span class="text-white">stem</span> helps the <span class="text-white">plant</span> to grow tall. When<br/>the <span class="text-white">plant</span> is tall, its <span class="text-white">leaves</span> can get enough sunlight to make food.</h2>
    </div>
