...
@section('content')
    ...
    <div class="flex !text-white flex-col t-slide justify-center items-center text-start">
        <div>
            ...
            <ul class="list-disc ">
                <li>Build a seesaw based on a pictorial guide</li>
                <li>Explore and learn about the characteristics and uses of levers - a simple machine</li>
                <li>Explore and learn about weight and balance</li>
                <li>Explore ways to balance a seesaw</li>
    ...
    <div class="flex !text-white flex-col t-slide justify-center items-center text-start">
        ...
        <img src="{{ asset('assets/images/N2/SimpleMachines/s24.png') }}" class="img-md" />
    ...
    <div class="flex !text-white flex-col t-slide justify-center text-start">
        <div>
            <h2 class=" t-title">Preparations:</h2>
            <ul class="list-disc ">
                <li>Each group a boy and a girl figurines</li>
                <li>Each group a set of square bricks</li>
            </ul>
        </div>
        <div class="flex items-center">
            <img src="{{ asset('assets/images/N2/SimpleMachines/s25.png') }}" />
            <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt="" class="absolute teacher-img1" />
        </div>
    </div>
    ...
    <div class="text-white flex flex-col t-slide text-start hidden">
        <div>
            ...
            <ul class="list-disc">
                ...
                <li>If needed, advise children to use adhesive tape to secure the base of the seesaw during hands-on session
                    2.</li>
            </ul>
        </div>
        <div>
