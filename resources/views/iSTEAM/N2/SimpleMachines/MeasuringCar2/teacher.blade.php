...
@section('content')
    ...
    <div class=" slide flex text-2xl text-white flex-col justify-start gap-y-10 text-start w-[75%]">
        ...
        <div class="flex items-center">
            <div class="flex items-center">
                <img src="{{ asset('assets/images/N2/b2.png') }}" class="w-[636px]" />
                <img src="{{ asset('assets/images/N2/b17.png') }}" class="w-[636px]" />
            </div>
    ...
    <div class=" slide flex text-2xl text-white flex-col justify-start gap-y-10 text-start w-[75%]">
        ...
        <div class="flex items-center">
            <img src="{{ asset('assets/images/N2/b22.png') }}" class="w-[636px]" />
            <img src="{{ asset('assets/images/pptimages/teacher1.png') }}" alt=""
