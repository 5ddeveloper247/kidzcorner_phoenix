...
@section('content')
    <div class="Selection flex items-center flex-col justify-center text-center z-[99] w-full">
        <h2 class="text-[#F7B94A] stroke">A Spinning Top</h2>
        <div class="flex items-center justify-around w-full">

            {{-- Lesson Button --}}
            <a href="{{ route('spinningTopLesson') }}" id="Lesson" class="flex flex-col gap-0">
                <img src="/assets/images/pptimages/lesson-btn.png" />
            </a>

            {{-- Teacher Button --}}
            <a href="{{ route('spinningTopTeacher') }}" id="Lesson" class="flex flex-col gap-0">
