...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-center text-center z-[99] w-full">
        <h2 class="text-[50px] text-[#F7B94A] stroke">A Measuring Car-1</h2>
        <div class="flex items-center justify-around w-full">

            {{-- Lesson Button --}}
            <a href="{{ route('MeasuringCarLesson') }}" id="Lesson" class="flex flex-col gap-0">
            ...
            {{-- Teacher Button --}}
            <a href="{{ route('MeasuringCarTeacher') }}" id="Lesson" class="flex flex-col gap-0">
    ...
    <div id="buttons" class="absolute  flex flex-row ">
        ...
        <!-- Return Button -->
        <a href="{{ route('MeasuringCar') }}" id="returnButton">
