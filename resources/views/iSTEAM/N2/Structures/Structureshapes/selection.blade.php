...
@section('content')
    ...
    <div class="Selection flex items-center flex-col justify-center text-center z-[99] w-full">
        <h2 class="text-[#F7B94A] stroke">Shapes in Structures</h2>
        <div class="flex items-center justify-around w-full">

            {{-- Lesson Button --}}
            <a href="{{ route('StructureshapesLesson') }}" id="Lesson" class="flex flex-col gap-0">
            ...
            {{-- Teacher Button --}}
            <a href="{{ route('StructureshapesTeacher') }}" id="Lesson" class="flex flex-col gap-0">
