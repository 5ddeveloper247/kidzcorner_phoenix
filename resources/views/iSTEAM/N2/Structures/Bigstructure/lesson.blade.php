...
@section('content')
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Let’s do: <br>
            3.Start with a rectangle block and connect the blocks
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Let’s do: <br>
            4.Continue to add blocks to complete the rectangle shape
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Let’s do: <br>
            5.Connect 3 wheels on one side according to the
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Let’s do: <br>
            6.Connect 3 wheels on the other side. Match the positions
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Let’s do: <br>
            7.Connect a wheel connector to a rectangle block. Connect it
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Let’s do: <br>
            8.Take these parts and connect them together using the <br>
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Let’s do: <br>
            10.The fire engine is done! You can open up the ladder, turn <br>
    ...
    <div class="slide hidden  flex flex-col justify-start items-center  ">
        ...
        <h2 class="title stroke !text-start">Steps: <br>
            1.Draw the big vehicle that you and your friends would like <br>
    ...
    <div class="slide hidden  flex flex-col justify-between h-[50vh] items-center  ">
        <h2 class="title stroke !text-start">Guided Questions During Group Activity
            ...
            the shapes?<br>
            3.Which parts can you use to create the shapes?</h2>
