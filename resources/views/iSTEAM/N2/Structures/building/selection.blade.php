...
@section('content')
    ...
    <div class=" flex items-center flex-col justify-center text-center z-[99] w-full">
       <h2 class="text-[50px] text-[#F7B94A] stroke">Buildings around us</h2>
       <div class="flex items-center justify-around w-full">

           {{-- Lesson Button --}}
           <a href="{{ route('n2buildingLesson') }}" id="Lesson" class="l-btn flex flex-col gap-0">
        ...
        {{-- Teacher Button --}}
        <a href="{{ route('n2buildingTeacher') }}" id="Lesson" class=" t-btn flex flex-col gap-0">
 ...
 <div id="buttons" class="absolute right-[60px] flex flex-row gap-6 ">
        ...
        <!-- Close Button -->
        <button class="relative w-24 h-24 button-fade-in cursor-pointer bg-red-500 rounded-[30px] shadow-lg shadow-inner outline outline-1 outline-red-900" id="closeButton">
