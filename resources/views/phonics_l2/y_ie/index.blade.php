...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/y_ie/y') }}">
            <img src="{{ asset('assets/images/phonics_l2/yie/y.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/y_ie/ie') }}">
            <img src="{{ asset('assets/images/phonics_l2/yie/ie.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/y_ie/yie') }}">
            <img src="{{ asset('assets/images/phonics_l2/yie/yie.png') }}" class="mx-auto d-block" />
        </a>
