...
@php
    ...
    $rounds = [
        ...
        [
            'type' => 'grid',
            'cols' => 3,
            'question' => 'Find the picture that end with the /i/ sound.',
            'audio' => 'assets/audio/phonics_audio-2/ay_ue/match-ue.m4a',
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/eea/peas.png',
                    'audio' => 'assets/audio/phonics_audio-2/ee_ea/peas.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/yie/kite.png',
                    'audio' => 'assets/audio/phonics_audio-2/y_ie/kite.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/yie/hide.png',
                    'audio' => 'assets/audio/phonics_audio-2/y_ie/hide.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/yie/five.png',
                    'audio' => 'assets/audio/phonics_audio-2/y_ie/five.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/yie/slide.png',
                    'audio' => 'assets/audio/phonics_audio-2/y_ie/slide.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/unup/bun.png',
                    'audio' => 'assets/audio/phonics_audio-2/un_up/bun.m4a',
                    'correct' => false,
                ],
            ],
        ],
        ...
        [
            ...
            'message' => "That's right! <br> Kite, Hide, Five and <br> slide end with the <br> /i/ sound.",
            'cols' => 2,
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/yie/kite.png',
...
@section('content')
    ...
    <div class="phonics-panel" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/bl_pl/letsplay.m4a') }}">
        <div class="flex justify-center items-center">
            <img src="{{ asset('assets/images/phonics_l2/global/common/match.png') }}" class="w-[30vw] h-[20vw]" />
    ...
    <div class="phonics-panel  flex justify-center items-center">
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  text-[#A15E0D] text-[1.7vw] text-center">
                Let’s spot the <br>
                pictures of words <br>
                that have the long <br>
                ‘<span class="text-[#70af39]">i</span>’ sound!
            </h2>
        </div>
    </div>
