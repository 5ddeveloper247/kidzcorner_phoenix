...
@php
    ...
    $questions = [
        [
            ...
            'audio' => 'assets/audio/phonics_audio-2/y_ie/lime.m4a',
            'leftLetters' => ['t', 'm', 'fl', 'l'],
            'rightLetters' => ['t', 'l', 'p', 'm'],
            'vowels' => ['i', 'e'],
            'answers' => [[null, null, null, null], ['l', null, 3, null], ['l', 'm', 3, 3]],
        ],

        [
            'image' => 'assets/images/phonics_l2/yie/five.png',
            'audio' => 'assets/audio/phonics_audio-2/y_ie/five.m4a',
            'leftLetters' => ['f', 'm', 'fl', 'l'],
            'rightLetters' => ['t', 'l', 'p', 'v'],
            'vowels' => ['i', 'e'],
            'answers' => [[null, null, null, null], ['f', null, 0, null], ['f', 'v', 0, 3]],
        ],

        [
            'image' => 'assets/images/phonics_l2/yie/bite.png',
            'audio' => 'assets/audio/phonics_audio-2/y_ie/bite.m4a',
            'class' => 'h-[20vw]',
            'leftLetters' => ['t', 'm', 'fl', 'b'],
            'rightLetters' => ['t', 'l', 'p', 'b'],
            'vowels' => ['i', 'e'],
            'answers' => [[null, null, null, null], ['b', null, 3, null], ['b', 't', 3, 0]],
        ],

        [
            'image' => 'assets/images/phonics_l2/yie/dive.png',
            'audio' => 'assets/audio/phonics_audio-2/y_ie/dive.m4a',
            'leftLetters' => ['t', 'd', 'fl', 'i'],
            'rightLetters' => ['t', 'v', 'p', 'm'],
            'vowels' => ['i', 'e'],
            'answers' => [[null, null, null, null], ['d', null, 1, null], ['d', 'v', 1, 1]],
        ],
    ];
