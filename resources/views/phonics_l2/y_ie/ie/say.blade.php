...
@php
    ...
    $returnURL = '/phonics_l2/y_ie/ie';
    $doneURL = '/phonics_l2/y_ie/ie';

    $first = 'i';
    $end = 'e';

    $sideBtns = ['assets/audio/phonics_audio-2/y_ie/ie.m4a', 'assets/audio/phonics_audio-2/y_ie/ieah.m4a'];

    $words = [
        [
            'image' => 'assets/images/phonics_l2/yie/bike.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'bike',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-sh.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /j/..../et/...jet)',
        ],
        [
            'image' => 'assets/images/phonics_l2/yie/bite.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'bite',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/yie/kite.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'kite',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-read.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/yie/mice.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'mice',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-irty.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/yie/five.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'five',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/yie/hive.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'hive',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/dive.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'dive',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/hide.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'hide',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/bride.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'bride',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/slide.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'slide',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/nine.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'nine',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/lime.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'lime',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/slime.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'slime',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/ie-in.m4a',
            'tip' => null,
...
@section('content')
    ...
    <div class="phonics-panel info-panel-1 flex flex-col gap-y-[1vw]">
        ...
        <ul class="list-disc text-start panel-ul space-y-[.2vw]">
            ...
            <li>Digraphs - Two letters that represent one dab sound, as ch for ch in "chin".</li>
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">like</h2>
                <h2 class="stroke">hide</h2>
                <h2 class="stroke">nine</h2>
            </div>
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <button class="absolute right-[16%] top-[22%] w-[3.5vw]" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/ieah.m4a') }}">
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/ie2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <h2
                    ...
                    You’re right! <br>
                    Shine, she and <br>
                    sharp begin with '<span class="text-[#70af39]">{{ $first }}_{{$end}}</span>'.
                </h2>
            </div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/ie3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                ...
                Do you know <br>
                the sound of <br>
                '<span class="text-[#70af39]">{{ $first }}_{{$end}}</span>'.
            </h2>
        </div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/ie4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                ...
                '<span class="text-[#70af39]">{{ $first }}_{{$end}}</span>' makes the <span class="opacity-0">----</span>
                sound. <br>
                Let's practice saying <br> the sound of <br> the diagraph '<span
                    class="text-[#70af39]">{{ $first }}_{{$end}}</span>'.
            </h2>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/ie5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                ...
                digslabh '<span class="text-[#70af39]">{{ $first }}_{{$end}}</span>'?
            </h2>
        </div>
        ...
        <div class="phonics-panel flex flex-col items-center justify-between">
            ...
            <div class="flex gap-x-[4vw] items-center justify-center">
                <div>
                    ...
                    <h1 class="large-title h-fit">{{ $first }}_{{$end}}</h1>
                </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const CHEERING = "{{ asset('assets/audio/phonics_audio-2/common/dabing.mp3') }}";
            ...
            function getAudioForSlide(slide) {
                ...
                if (newContainer) {
                    // Reveal panel: play the word audio + dabing
