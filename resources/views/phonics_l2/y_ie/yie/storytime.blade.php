...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st1.m4a',
                'image' => 'assets/images/phonics_l2/yie/story1.png',
                'text' => 'Shy Mike and His Mice',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st2.m4a',
                'image' => 'assets/images/phonics_l2/yie/story2.png',
                'text' => 'Shy Mike has five fluffy and furry mice.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st3.m4a',
                'image' => 'assets/images/phonics_l2/yie/story3.png',
                'text' => 'The mice will only eat fried brown rice.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st4.m4a',
                'image' => 'assets/images/phonics_l2/yie/story4.png',
                'text' => 'Sometimes, Mike and his mice like to share a lime.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st5.m4a',
                'image' => 'assets/images/phonics_l2/yie/story5.png',
                'text' => 'Just before they dive into a pool of slime.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st6.m4a',
                'image' => 'assets/images/phonics_l2/yie/story6.png',
                'text' => 'The five mice also like to sit on Mike’s bike and watch 
                 him fly his kite.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st7.m4a',
                'image' => 'assets/images/phonics_l2/yie/story7.png',
                'text' => 'But they always cry when the kite flies high in the sky.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st8.m4a',
                'image' => 'assets/images/phonics_l2/yie/story8.png',
                'text' => 'And Mike doesn’t know the reason why.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/st9.m4a',
                'image' => 'assets/images/phonics_l2/yie/story9.png',
                'text' => 'Mike’s only friends are these mice and they treat him
                real nice.',
            ],
        ];
        ...
        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/stq1.m4a',
                'question' => "How many mice  \n does Mike have?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/stq2.m4a',
                'question' => "What do they do \n after they \n eat a lime?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/stq3.m4a',
                'question' => "Why do the mice \n sit on the bike?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/stq4.m4a',
                'question' => "Why do the  \n mice cry?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/y_ie/stq5.m4a',
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">
                {{ $storySlides[0]['text'] === $slide['text'] ? 'Shy Mike and His Mice' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story4.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story5.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story2.png') }}" class="h-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story3.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Shy Mike has five fluffy and furry mice.</div>
            <div class="question">The mice will only eat fried brown rice.</div>
            <div class="question">Sometime, Mike and his mice like to share a lime.</div>
            <div class="question">Just before they dive into a pool of slime.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story5.png') }}" class="h-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Shy Mike has five fluffy and furry mice. </div>
            <div class="question">The mice will only eat fried brown rice.</div>
            <div class="question">Sometime, Mike and his mice like to share a lime.</div>
            <div class="question">Just before they dive into a pool of slime.</div>
        </div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story4.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story5.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story2.png') }}" class="h-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story3.png') }}" class="w-[7vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Shy Mike has five fluffy and furry mice.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">The mice will only eat fried brown rice.</div>
            <div class="question">Sometime, Mike and his mice like to share a lime.</div>
            <div class="question">Just before they dive into a pool of slime.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Shy Mike has five fluffy and furry mice.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> The mice will only eat fried brown rice. </div>
            <div class="question">Sometime, Mike and his mice like to share a lime.</div>
            <div class="question">Just before they dive into a pool of slime.</div>
        </div>
    </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story4.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story2.png') }}" class="h-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story3.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Shy Mike has five fluffy and furry mice.</div>
            <div class="question">The mice will only eat fried brown rice.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Sometime, Mike and his mice like to share a lime.</div>
            <div class="question">Just before they dive into a pool of slime.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Shy Mike has five fluffy and furry mice.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> The mice will only eat fried brown rice.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> Sometime, Mike and his mice like to share a lime.</div>
            <div class="question">Just before they dive into a pool of slime.</div>
        </div>
    </div>

    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story4.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/yie/story5.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">The mice will only eat fried brown rice.</div>
            <div class="question">Sometime, Mike and his mice like to share a lime.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Just before they dive into a pool of slime.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">2</span> The mice will only eat fried brown rice.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> Sometime, Mike and his mice like to share a lime.</div>
            <div class="question done"><span class="absolute left-0 pl-5">4</span> Just before they dive into a pool of slime.</div>
        </div>
    </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            /* CONFIG */
            const returnURL = "{{ url('/phonics_l2/y_ie/yie') }}";
            const doneURL = "{{ url('/phonics_l2/y_ie/yie') }}";
