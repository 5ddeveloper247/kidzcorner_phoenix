...
@php
    ...
    $questions = [
        [
            'picture' => asset('assets/images/phonics_l2/yie/fry.png'),
            'pictureAudio' => asset('assets/audio/phonics_audio-2/y_ie/fry.m4a'),
            'correctWord' => 'fly',
            'correctHighlight' => 'y',
            'distractorWord' => 'floss',
            'pictureWordBreak' => 'fr<span class="text-[#f7b94a]">y</span>',
            'correctPosition' => 'left', 
        ],
        [
            'picture' => asset('assets/images/phonics_l2/yie/kite.png'),
            'pictureAudio' => asset('assets/audio/phonics_audio-2/y_ie/kite.m4a'),
            'correctWord' => 'big',
            'correctHighlight' => 'ie',
            'distractorWord' => 'bike',
            'pictureWordBreak' => 'k<span class="text-[#f7b94a]">i</span>t<span class="text-[#f7b94a]">e</span>',
            'correctPosition' => 'right',
        ],
        [
            'picture' => asset('assets/images/phonics_l2/yie/cry.png'),
            'pictureAudio' => asset('assets/audio/phonics_audio-2/y_ie/cry.m4a'),
            'correctWord' => 'dry',
            'correctHighlight' => 'y',
            'distractorWord' => 'play',
            'pictureWordBreak' => 'dr<span class="text-[#f7b94a]">y</span>p',
            'correctPosition' => 'left',
        ],
        [
            'picture' => asset('assets/images/phonics_l2/yie/mice.png'),
            'pictureAudio' => asset('assets/audio/phonics_audio-2/y_ie/mice.m4a'),
            'distractorWord' => 'sit',
            'correctHighlight' => 'ie',
            'correctWord' => 'nine',
            'pictureWordBreak' => 'm<span class="text-[#f7b94a]">i</span>c<span class="text-[#f7b94a]">e</span>',
            'correctPosition' => 'right',
        ],
        [
            'picture' => asset('assets/images/phonics_l2/yie/pry.png'),
            'pictureAudio' => asset('assets/audio/phonics_audio-2/y_ie/pry.m4a'),
            'correctWord' => 'shy',
            'correctHighlight' => 'y',
            'distractorWord' => 'chin',
            'pictureWordBreak' => 'sh<span class="text-[#f7b94a]">y</span>',
            'correctPosition' => 'left',
        ],
    ];
...
@push('script')
    <script>
        (function() {
            ...
            const RETURN_URL = "{{ url('/phonics_l2/y_ie/yie') }}";
            const DONE_URL = "{{ url('/phonics_l2/y_ie/yie') }}";
