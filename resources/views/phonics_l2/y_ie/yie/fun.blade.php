...
@php
    ...
    $questions = [
        // ── Question 1 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/yie/fun1.png',
            'imageSize' => 'h-[13vw]',
            'audio' => 'assets/audio/phonics_audio-2/y_ie/fb-yie1.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'Mike’s'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'lands next to a'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            ...
            'words' => [
                ['word' => 'kite', 'answer' => true],
                ['word' => 'hit', 'answer' => false],
                ['word' => 'cat',  'answer' => false],
                ['word' => 'hive', 'answer' => true],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/y_ie/kite.m4a',
                'assets/audio/phonics_audio-2/y_ie/hive.m4a',
            ],
        ],

        // ── Question 2 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/yie/fun2.png',
            'imageSize' => 'h-[16vw]',
            'audio' => 'assets/audio/phonics_audio-2/y_ie/fb-yie2.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'There is a'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'sititng on the'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            'tip' => null,
            'words' => [
                ...
                ['word' => 'fly', 'answer' => true],
                ['word' => 'lime', 'answer' => true],
                ['word' => 'lid', 'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/y_ie/fly.m4a',
                'assets/audio/phonics_audio-2/y_ie/lime.m4a',
            ],
        ],

        // ── Question 3 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/yie/fun3.png',
            'imageSize' => 'h-[15vw]',
            'audio' => 'assets/audio/phonics_audio-2/y_ie/fb-yie3.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'mice try to'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'themselves in the sun.'],
            ],
            'tip' => null,
            'words' => [
                ['word' => 'five', 'answer' => true],
                ['word' => 'fry', 'answer' => false],
                ['word' => 'dry', 'answer' => true],
                ['word' => 'nine', 'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/y_ie/five.m4a',
                'assets/audio/phonics_audio-2/y_ie/dry.m4a',
            ],
        ],
    ];
