...
@php
    ...
    $sideBtns = ['assets/audio/phonics_audio-2/y_ie/y.m4a', 'assets/audio/phonics_audio-2/y_ie/yah.m4a'];
    ...
    $words = [
        [
            ...
            'imageSize' => 'w-[20vw]',
            'word' => 'fly',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/y-sh.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /h/..../am/...ham)',
        ],
        [
            'image' => 'assets/images/phonics_l2/yie/cry.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'cry',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/y-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/yie/dry.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'dry',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/y-read.m4a',
            'tip' => null,
        ],
        [
            ...
            'imageSize' => 'w-[20vw]',
            'word' => 'fry',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/y-irty.m4a',
            'tip' => null,
        ],
        [
            ...
            'imageSize' => 'w-[20vw]',
            'word' => 'pry',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/y-in.m4a',
            'tip' => null,
        ],
        [
        ...
        [
            'image' => 'assets/images/phonics_l2/yie/sky.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'sky',
            'wordAudio' => 'assets/audio/phonics_audio-2/y_ie/y-in.m4a',
            'tip' => null,
...
@section('content')
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/y2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div class="flex flex-col">
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">sty</h2>
                <h2 class="stroke">sly</h2>
                <h2 class="stroke">try</h2>
            </div>
        </div>
    </div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/y3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/y4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/y_ie/y5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
