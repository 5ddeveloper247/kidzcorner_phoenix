...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ag_ab/ag') }}">
            <img src="{{ asset('assets/images/phonics_l2/agab/ag.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ag_ab/ab') }}">
            <img src="{{ asset('assets/images/phonics_l2/agab/ab.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ag_ab/agab') }}">
            <img src="{{ asset('assets/images/phonics_l2/agab/agab.png') }}" class="mx-auto d-block" />
        </a>
