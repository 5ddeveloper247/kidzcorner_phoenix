...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st1.m4a',
                'image' => 'assets/images/phonics_l2/agab/st1.png',
                'text' => 'Dag The Crab',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st2.m4a',
                'image' => 'assets/images/phonics_l2/agab/st1.png',
                'text' => 'I know a crab named Dag.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st3.m4a',
                'image' => 'assets/images/phonics_l2/agab/st2.png',
                'text' => 'Dag the crab would only nag at a Stag.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st4.m4a',
                'image' => 'assets/images/phonics_l2/agab/st3.png',
                'text' => 'He nagged at Stag when it tripped on a rag while carrying his flag.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st5.m4a',
                'image' => 'assets/images/phonics_l2/agab/st4.png',
                'text' => 'He nagged at Stag for going into a lab to get a jab.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st6.m4a',
                'image' => 'assets/images/phonics_l2/agab/st5.png',
                'text' => 'He nagged at Stag for sitting on a tab in an old yellow cab.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st7.m4a',
                'image' => 'assets/images/phonics_l2/agab/st6.png',
                'text' => 'He also nagged at Stag for losing the tag on his big brown bag.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/st8.m4a',
                'image' => 'assets/images/phonics_l2/agab/st7.png',
                'text' => 'Poor Stag! He only wishes that Dag would stop his nag.',
            ],
        ];

        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/stq1.m4a',
                'question' => "What did Dag\nnag at?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/stq2.m4a',
                'question' => "What did Stag\ntrip on?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/stq3.m4a',
                'question' => "Why did Stag\ngo into the lab?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/stq4.m4a',
                'question' => "Why did Dag nag\n at Stag for\nsitting on the tab?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ag_ab/stq4.m4a',
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">{{ $storySlides[0]['text'] === $slide['text'] ? 'Dag The Crab' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ag_ab/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st5.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st4.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st3.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st2.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">I know a crab named Dag.</div>
            <div class="question">Dag the crab would only nag at Stag.</div>
            <div class="question">He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question">He nagged at Stag for sitting on a tab in an old yellow cab.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st3.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> I know a crab named Dag. </div>
            <div class="question">Dag the crab would only nag at Stag.</div>
            <div class="question">He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question">He nagged at Stag for sitting on a tab in an old yellow cab.</div>
        </div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ag_ab/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st5.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st2.png') }}" class="w-[7vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">I know a crab named Dag.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Dag the crab would only nag at Stag.</div>
            <div class="question">He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question">He nagged at Stag for sitting on a tab in an old yellow cab.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> I know a crab named Dag.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> Dag the crab would only nag at Stag.</div>
            <div class="question">He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question">He nagged at Stag for sitting on a tab in an old yellow cab.</div>
        </div>
    </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ag_ab/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st5.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st4.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st3.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">I know a crab named Dag.</div>
            <div class="question">Dag the crab would only nag at Stag.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question">He nagged at Stag for sitting on a tab in an old yellow cab.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> I know a crab named Dag.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> Dag the crab would only nag at Stag.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question">He nagged at Stag for sitting on a tab in an old yellow cab.</div>
        </div>
    </div>

    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ag_ab/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st5.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/agab/st4.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">Dag the crab would only nag at Stag.</div>
            <div class="question">He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">He nagged at Stag for sitting on a tab in an old yellow cab.
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> I know a crab named Dag.
            </div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> Dag the crab would only nag at Stag.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> He nagged at Stag for going into a lab to get a jab.</div>
            <div class="question done"><span class="absolute left-0 pl-5">4</span> He nagged at Stag for sitting on a tab in an old yellow cab.</div>
        </div>
    </div>
