...
@php
    ...
    $returnURL = '/phonics_l2/ag_ab/agab';
    $doneURL = '/phonics_l2/ag_ab/agab';
    ...
    $questions = [
        // ── Question 1 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/agab/fun1.png',
            'imageSize' => 'h-[13vw]',
            'audio' => 'assets/audio/phonics_audio-2/ag_ab/fb-agab1.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'There is a'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'on the green'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            ...
            'words' => [
                ['word' => 'stab', 'answer' => false],
                ['word' => 'tab', 'answer' => true],
                ['word' => 'flag', 'answer' => true],
                ['word' => 'nag',  'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/ag_ab/tab.m4a',
                'assets/audio/phonics_audio-2/ag_ab/flag.m4a',
            ],
        ],

        // ── Question 2 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/agab/fun2.png',
            'imageSize' => 'h-[16vw]',
            'audio' => 'assets/audio/phonics_audio-2/ag_ab/fb-agab2.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'crawled into the brown'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'the presents.'],
            ],
            'tip' => null,
            'words' => [
                ['word' => 'crab', 'answer' => true],
                ['word' => 'lab', 'answer' => false],
                ['word' => 'bag', 'answer' => true],
                ['word' => 'tag', 'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/ag_ab/crab.m4a',
                'assets/audio/phonics_audio-2/ag_ab/bag.m4a',
            ],
        ],

        // ── Question 3 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/agab/fun3.png',
            'imageSize' => 'h-[15vw]',
            'audio' => 'assets/audio/phonics_audio-2/ag_ab/fb-agab3.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The boys'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'their lugagae into the yellow'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            'tip' => null,
            'words' => [
                ['word' => 'drag', 'answer' => true],
                ['word' => 'nab', 'answer' => false],
                ['word' => 'jab', 'answer' => false],
                ['word' => 'cab', 'answer' => true],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/ag_ab/drag.m4a',
                'assets/audio/phonics_audio-2/ag_ab/cab.m4a',
            ],
        ],
    ];
