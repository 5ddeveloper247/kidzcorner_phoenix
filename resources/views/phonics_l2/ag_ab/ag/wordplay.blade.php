...
@php
    ...
    $panels = [
        [
            ...
            'audio' => 'ag_ab/tag.m4a',
            'tip' =>
                'Tip: Invite children to sound out each word by parts (e.g. /t/.../ag/) <br> before selecting the word that matches the picture.',
        ],
        [
            'image' => 'phonics_l2/agab/drag.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['drag', 'flag'],
            'answer' => 'drag',
            'before' => 'dr',
            'highlight' => 'ag',
            'after' => '',
            'audio' => 'ag_ab/drag.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/agab/wag.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['rag', 'wag'],
            'answer' => 'wag',
            'before' => 'w',
        ...
        [
            'image' => 'phonics_l2/agab/stag.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['stag', 'tags'],
            'answer' => 'stag',
            'before' => 'st',
            'highlight' => 'ag',
            'after' => '',
            'audio' => 'ag_ab/stag.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/agab/bag.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['nag', 'bag'],
            'answer' => 'bag',
            'before' => 'b',
