...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/th_wh/th') }}">
            <img src="{{ asset('assets/images/phonics_l2/thwh/th.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/th_wh/wh') }}">
            <img src="{{ asset('assets/images/phonics_l2/thwh/wh.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/th_wh/thwh') }}">
            <img src="{{ asset('assets/images/phonics_l2/thwh/thwh.png') }}" class="mx-auto d-block" />
        </a>
