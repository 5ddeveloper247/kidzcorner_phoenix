...
@section('content')
    ...
    <div id="buttons" class="absolute flex flex-row gap-6 z-90">
        ...
        <a href="{{ url ('/phonics_l2/th_wh') }}" id="returnButton">
