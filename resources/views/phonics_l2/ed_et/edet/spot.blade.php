...
@php
    ...
    $targetSound = [
        'text' => 'bl',
        'audio' => 'assets/audio/phonics_audio-2/bl_pl/blah.mp3',
    ];

    $cheerAudio = 'assets/audio/phonics_audio-2/common/cheering.mp3';
    $slideAudio = 'assets/audio/phonics_audio-2/bl_pl/bl-spot.m4a';
    ...
    $questions = [
        ...
        [
            ...
            'circles' => [
                ['text' => 'bl', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/blah.mp3', 'isCorrect' => true],
                ['text' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/pluh.m4a', 'isCorrect' => false],
                ['text' => 'pr', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/prah.m4a', 'isCorrect' => false],
                ['text' => 'br', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/brah.m4a', 'isCorrect' => false],
            ],
        ],
        ...
        [
            ...
            'circles' => [
                ['text' => 'br', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/brah.m4a', 'isCorrect' => false],
                ['text' => 'bl', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/blah.mp3', 'isCorrect' => false],
                ['text' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/pluh.m4a', 'isCorrect' => true],
                ['text' => 'sl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/slah.m4a', 'isCorrect' => false],
            ],
        ],
        ...
        [
            ...
            'circles' => [
                ['text' => 'gl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/glah.m4a', 'isCorrect' => false],
                ['text' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/pluh.m4a', 'isCorrect' => true],
                ['text' => 'cl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/clah.m4a', 'isCorrect' => false],
                ['text' => 'br', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/brah.m4a', 'isCorrect' => false],
            ],
        ],
        ...
        [
            ...
            'circles' => [
                ['text' => 'br', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/brah.m4a', 'isCorrect' => false],
                ['text' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/pluh.m4a', 'isCorrect' => false],
                ['text' => 'fl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/flah.m4a', 'isCorrect' => false],
                ['text' => 'bl', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/blah.mp3', 'isCorrect' => true],
            ],
        ],
        ...
        // ── last slide Question 7 ──────────────────────────────────
        [
            'bgImage' => 'assets/images/phonics_l2/global/common/m7.png',
            'circles' => [
                ['text' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/pluh.m4a', 'isCorrect' => true],
                ['text' => 'gl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/glah.m4a', 'isCorrect' => false],
                ['text' => 'bl', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/blah.mp3', 'isCorrect' => false],
...
@section('content')
    ...
    @foreach ($questions as $i => $q)
        @php
            $nextBg = $questions[$i + 1]['bgImage'] ?? $q['bgImage'];
            $isLast = $i === count($questions) - 1;
        @endphp


        {{-- QUESTION SLIDE --}}
        <div class="phonics-panel no-bg" data-audio="{{ asset($slideAudio) }}">
            ...
            <div class="relative">
                ...
                <div class="flex items-center gap-[1.5vw] absolute bottom-0 left-1/2 -translate-1/2">
...
@push('script')
    <script>
        ...
        const CONFIG = {
            returnURL: "{{ url('/phonics_l2/ed_et/edet') }}",
            doneURL: "{{ url('/phonics_l2/ed_et/edet') }}",
