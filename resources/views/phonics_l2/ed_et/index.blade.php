...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ed_et/ed') }}">
            <img src="{{ asset('assets/images/phonics_l2/edet/ed.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ed_et/et') }}">
            <img src="{{ asset('assets/images/phonics_l2/edet/et.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ed_et/edet') }}">
            <img src="{{ asset('assets/images/phonics_l2/edet/edet.png') }}" class="mx-auto d-block" />
        </a>
