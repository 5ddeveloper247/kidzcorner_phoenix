...
@php
    ...
    $returnURL = '/phonics_l2/ed_et/ed';
    $doneURL = '/phonics_l2/ed_et/ed';

    $diagraph = 'ed';

    $sideBtns = ['assets/audio/phonics_audio-2/ed_et/ed.m4a', 'assets/audio/phonics_audio-2/ed_et/edah.m4a'];
    ...
    $words = [
        [
            ...
            'imageSize' => 'w-[20vw]',
            'word' => 'bed',
            'wordAudio' => 'assets/audio/phonics_audio-2/ed_et/ed-sh.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /h/..../am/...ham)',
        ],
        [
            'image' => 'assets/images/phonics_l2/edet/red.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'red',
            'wordAudio' => 'assets/audio/phonics_audio-2/ed_et/ed-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/edet/wed.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'wed',
            'wordAudio' => 'assets/audio/phonics_audio-2/ed_et/ed-read.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/edet/sled.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'sled',
            'wordAudio' => 'assets/audio/phonics_audio-2/ed_et/ed-irty.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/edet/fed.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'fed',
            'wordAudio' => 'assets/audio/phonics_audio-2/ed_et/ed-in.m4a',
            'tip' => null,
        ]
    ];
...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">fled</h2>
                <h2 class="stroke">led</h2>
                <h2 class="stroke">shed</h2>
            </div>
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <button class="absolute right-[16%] top-[22%] w-[3.5vw]" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ed_et/edah.m4a') }}">
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ed_et/ed2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ed_et/ed3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ed_et/ed4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ed_et/ed5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
