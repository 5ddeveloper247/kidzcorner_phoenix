...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/fr_cr/fr') }}">
            <img src="{{ asset('assets/images/phonics_l2/frcr/fr.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/fr_cr/cr') }}">
            <img src="{{ asset('assets/images/phonics_l2/frcr/cr.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/fr_cr/frcr') }}">
            <img src="{{ asset('assets/images/phonics_l2/frcr/frcr.png') }}" class="mx-auto d-block" />
        </a>
