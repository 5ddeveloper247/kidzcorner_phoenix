...
@php
    ...
    $returnURL = '/phonics_l2/fr_cr/frcr';
    $doneURL = '/phonics_l2/fr_cr/frcr';
    ...
    $questions = [
        [
            ...
            'imageSize' => 'w-[15vw]',
            'ending' => 'ack',
            'answerAudio' => 'assets/audio/phonics_audio-2/fr_cr/cr-ack.m4a',
            'choices' => [
                ...
                ['blend' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/pluh.m4a', 'correct' => false],
            ],
        ],
        ...
        [
            ...
            'imageSize' => 'h-[15vw]',
            'ending' => 'uits',
            'answerAudio' => 'assets/audio/phonics_audio-2/fr_cr/fr-uit.m4a',
            'choices' => [
                ...
                ['blend' => 'bl', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/pluh.m4a', 'correct' => false],
            ],
        ],
        ...
        [
            ...
            'imageSize' => 'h-[15vw]',
            'ending' => 'y',
            'answerAudio' => 'assets/audio/phonics_audio-2/fr_cr/fr-y.m4a',
            'choices' => [
        ...
        [
            ...
            'imageSize' => 'w-[17vw]',
            'ending' => 'awl',
            'answerAudio' => 'assets/audio/phonics_audio-2/fr_cr/cr-awl.m4a',
            'choices' => [
                ['blend' => 'pr', 'audio' => 'assets/audio/phonics_audio-2/br_pr/prah.m4a', 'correct' => false],
                ['blend' => 'dr', 'audio' => 'assets/audio/phonics_audio-2/dr_gr/drah.m4a', 'correct' => false],
                ['blend' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/pluh.m4a', 'correct' => false],
                ['blend' => 'cr', 'audio' => 'assets/audio/phonics_audio-2/br_pr/crah.m4a', 'correct' => true],
            ],
        ],
        ...
        [
            ...
            'imageSize' => 'w-[15vw]',
            'ending' => 'og',
            'answerAudio' => 'assets/audio/phonics_audio-2/fr_cr/fr-og.m4a',
            'choices' => [
