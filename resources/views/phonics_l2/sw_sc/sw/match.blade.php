...
@php
    $showBackground = true;
    $refImage = 'assets/images/phonics_l2/swsc/sweet.png';
    $refAudio = 'assets/audio/phonics_audio-2/sw_sc/sweet.m4a';
    ...
    $questions = [
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/swsc/swing.png',
            'correctSize' => 'w-[15vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sw_sc/swing.m4a',
            'correctWord' => 'swing',
            'answerAudio' => 'assets/audio/phonics_audio-2/sw_sc/swing.m4a',
            'wrong' => 'assets/images/phonics_l2/clsl/slide.png',
            'wrongSize' => 'w-[15vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/cl_sl/slide.m4a',
        ],
        [
            'correctSide' => 'left',
            'correct' => 'assets/images/phonics_l2/swsc/swim.png',
            'correctSize' => 'w-[15vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sw_sc/swim.m4a',
            'correctWord' => 'swim',
        ...
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/swsc/sweep.png',
            'correctSize' => 'h-[17vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sw_sc/sweep.m4a',
            'correctWord' => 'sweep',
            'answerAudio' => 'assets/audio/phonics_audio-2/sw_sc/sweep.m4a',
            'wrong' => 'assets/images/phonics_l2/trev/trip.png',
            'wrongSize' => 'h-[17vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/tr_rev/trip.m4a',
        ],
        [
            'correctSide' => 'left',
            'correct' => 'assets/images/phonics_l2/swsc/swan.png',
            'correctSize' => 'w-[17vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sw_sc/swan.m4a',
            'correctWord' => 'swan',
            'answerAudio' => 'assets/audio/phonics_audio-2/sw_sc/swan.m4a',
            'wrong' => 'assets/images/phonics_l2/trev/trumpet.png',
            'wrongSize' => 'w-[17vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/tr_rev/trumpet.m4a',
        ],
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/swsc/sway.png',
            'correctSize' => 'w-[16vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sw_sc/sway.m4a',
            'correctWord' => 'sway',
            'answerAudio' => 'assets/audio/phonics_audio-2/sw_sc/sway.m4a',
            'wrong' => 'assets/images/phonics_l2/clsl/ski.png',
            'wrongSize' => 'w-[16vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/cl_sl/ski.m4a',
        ],
    ];
    // ============================================================
@endphp
