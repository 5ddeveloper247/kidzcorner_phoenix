...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/sw_sc/sw') }}">
            <img src="{{ asset('assets/images/phonics_l2/swsc/sw.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sw_sc/sc') }}">
            <img src="{{ asset('assets/images/phonics_l2/swsc/sc.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sw_sc/swsc') }}">
            <img src="{{ asset('assets/images/phonics_l2/swsc/swsc.png') }}" class="mx-auto d-block" />
        </a>
