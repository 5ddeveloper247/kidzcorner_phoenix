...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/sk_sn/sk') }}">
            <img src="{{ asset('assets/images/phonics_l2/sksn/sk.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sk_sn/sn') }}">
            <img src="{{ asset('assets/images/phonics_l2/sksn/sn.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sk_sn/sksn') }}">
            <img src="{{ asset('assets/images/phonics_l2/sksn/sksn.png') }}" class="mx-auto d-block" />
        </a>
