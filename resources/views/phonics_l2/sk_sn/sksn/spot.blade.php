...
@php
    ...
    $questions = [
        [
            'questionAudio' => 'assets/audio/phonics_audio-2/sk_sn/spot-skah.m4a',
            'titleAudio' => 'assets/audio/phonics_audio-2/sk_sn/spah.m4a',
            'ratPosition' => 'top-[35%] left-[8%]',
            'ratAnswerPos' => 'bottom-[16%] left-[12%]',
            'ratImage' => 'rat.png',
            'circles' => [
                ['label' => 'sk', 'audio' => 'assets/audio/phonics_audio-2/sk_sn/skah.m4a', 'correct' => true],
        ...
        [
            'questionAudio' => 'assets/audio/phonics_audio-2/sp_st/spot-snah.m4a',
        ...
        [
            'questionAudio' => 'assets/audio/phonics_audio-2/sk_sn/spot-skah.m4a',
            'titleAudio' => 'assets/audio/phonics_audio-2/sk_sn/skah.m4a',
...
@push('script')
    <script>
        ...
        const returnURL = "{{ url('/phonics_l2/sk_sn/sksn') }}";
        const doneURL = "{{ url('/phonics_l2/sk_sn/sksn') }}";
