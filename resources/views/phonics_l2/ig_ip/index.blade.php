...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ig_ip/ig') }}">
            <img src="{{ asset('assets/images/phonics_l2/igip/ig.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ig_ip/ip') }}">
            <img src="{{ asset('assets/images/phonics_l2/igip/ip.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ig_ip/igip') }}">
            <img src="{{ asset('assets/images/phonics_l2/igip/igip.png') }}" class="mx-auto d-block" />
        </a>
