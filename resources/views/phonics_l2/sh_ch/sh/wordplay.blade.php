...
@php
    ...
    $panels = [
        [
            'image' => 'phonics_l2/shch/ship.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['hips', 'ship'],
            'answer' => 'ship',
            'highlight' => 'sh',
            'audio' => 'sh_ch/ship.m4a',
            'tip' =>
                'Tip: Invite children to sound out each word by parts (e.g. /sh/.../ip/) <br> before selecting the word that matches the picture.',
        ],
        [
            'image' => 'phonics_l2/shch/shout.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['pout', 'shout'],
            'answer' => 'shout',
            'highlight' => 'sh',
            'audio' => 'sh_ch/shout.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/shch/shut.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['shut', 'huts'],
            'answer' => 'shut',
            'highlight' => 'sh',
            'audio' => 'sh_ch/shut.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/shch/shirt.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['skirt', 'shirt'],
            'answer' => 'shirt',
            'highlight' => 'sh',
            'audio' => 'sh_ch/shirt.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/shch/shell.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['bell', 'shell'],
            'answer' => 'shell',
            'highlight' => 'sh',
            'audio' => 'sh_ch/shell.m4a',
            'tip' => null,
        ],
...
@section('content')
    ...
    @foreach ($panels as $panel)
        ...
        <div class="phonics-panel flex flex-col items-center space-y-[4vw] w-full relative"
            data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sh_ch/find-word.m4a') }}">
        ...
        <div class="phonics-panel answer flex flex-col justify-center space-y-[2vw] items-center w-full"
            ...
            @php
                ...
                $answer = $panel['answer'];
                $rest = substr($answer, strlen($highlight));
            @endphp
            <h2 class="text-[4vw] text-white">
                <span class="text-[#f7b94a]">{{ $highlight }}</span>{{ $rest }}
            </h2>
        </div>
    @endforeach
