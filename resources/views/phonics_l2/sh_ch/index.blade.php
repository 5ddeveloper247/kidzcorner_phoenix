...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/sh_ch/sh') }}">
            <img src="{{ asset('assets/images/phonics_l2/shch/sh.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sh_ch/ch') }}">
            <img src="{{ asset('assets/images/phonics_l2/shch/ch.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sh_ch/shch') }}">
            <img src="{{ asset('assets/images/phonics_l2/shch/shch.png') }}" class="mx-auto d-block" />
        </a>
