...
@php
    ...
    $returnURL = '/phonics_l2/un_up/up';
    $doneURL = '/phonics_l2/un_up/up';

    $diagraph = 'up';

    $sideBtns = ['assets/audio/phonics_audio-2/un_up/up.m4a', 'assets/audio/phonics_audio-2/un_up/upah.m4a'];

    $words = [
        [
            'image' => 'assets/images/phonics_l2/unup/cup.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'cup',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/up-sh.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /j/..../et/...jet)',
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/pup.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'pup',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/up-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/sup.png',
            'imageSize' => 'h-[15vw]',
            'word' => 'sup',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/up-read.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/ketchup.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'ketchup',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/up-irty.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/hiccup.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'hiccup',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/up-in.m4a',
            'tip' => null,
        ],
    ];
...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">sup</h2>
                <h2 class="stroke">cup</h2>
                <h2 class="stroke">pup</h2>
            </div>
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <button class="absolute right-[16%] top-[22%] w-[3.5vw]" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/upah.m4a') }}">
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/up2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/up3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/up4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/up5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
