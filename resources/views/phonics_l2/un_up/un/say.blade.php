...
@php
    ...
    $returnURL = '/phonics_l2/un_up/un';
    $doneURL = '/phonics_l2/un_up/un';

    $diagraph = 'un';

    $sideBtns = ['assets/audio/phonics_audio-2/un_up/un.m4a', 'assets/audio/phonics_audio-2/un_up/unah.m4a'];

    $words = [
        [
            'image' => 'assets/images/phonics_l2/unup/bun.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'bun',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/un-sh.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /h/..../am/...ham)',
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/run.png',
            'imageSize' => 'h-[20vw]',  
            'word' => 'run',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/un-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/sun.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'sun',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/un-read.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/fun.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'fun',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/un-irty.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/unup/spun.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'spun',
            'wordAudio' => 'assets/audio/phonics_audio-2/un_up/un-in.m4a',
            'tip' => null,
        ],
...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">fun</h2>
                <h2 class="stroke">pun</h2>
                <h2 class="stroke">stun</h2>
            </div>
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <button class="absolute right-[16%] top-[22%] w-[3.5vw]" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/unah.m4a') }}">
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/un2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/un3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/un4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/un5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
