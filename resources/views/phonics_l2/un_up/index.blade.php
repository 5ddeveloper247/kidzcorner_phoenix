...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/un_up/un') }}">
            <img src="{{ asset('assets/images/phonics_l2/unup/un.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/un_up/up') }}">
            <img src="{{ asset('assets/images/phonics_l2/unup/up.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/un_up/unup') }}">
            <img src="{{ asset('assets/images/phonics_l2/unup/unup.png') }}" class="mx-auto d-block" />
        </a>
