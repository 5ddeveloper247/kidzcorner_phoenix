...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st1.m4a',
                'image' => 'assets/images/phonics_l2/unup/story1.png',
                'text' => 'Pup has Fun',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st2.m4a',
                'image' => 'assets/images/phonics_l2/unup/story2.png',
                'text' => 'Buttercup likes to run for fun.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st3.m4a',
                'image' => 'assets/images/phonics_l2/unup/story3.png',
                'text' => 'After her run. she sits in the sun.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st4.m4a',
                'image' => 'assets/images/phonics_l2/unup/story4.png',
                'text' => 'And eats a hot cross bun.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st5.m4a',
                'image' => 'assets/images/phonics_l2/unup/story5.png',
                'text' => 'Along comes a playful pup',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st6.m4a',
                'image' => 'assets/images/phonics_l2/unup/story6.png',
                'text' => 'And knocks over her favourite cup.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st7.m4a',
                'image' => 'assets/images/phonics_l2/unup/story7.png',
                'text' => 'Scares Buttercup that she drops her bun',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st8.m4a',
                'image' => 'assets/images/phonics_l2/unup/story8.png',
                'text' => 'And starts to run.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/st9.m4a',
                'image' => 'assets/images/phonics_l2/unup/story9.png',
                'text' => 'The pup runs after her as it is having such fun.',
            ],
        ];

        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/stq1.m4a',
                'question' => "What does \n Buttercup like \n to do?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/stq2.m4a',
                'question' => "Why does she like \n to sit in \n the sun?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/stq3.m4a',
                'question' => "What does \n she eat?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/stq4.m4a',
                'question' => "What happens \n to her \n favourite cup?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/stq5.m4a',
                'question' => "What is Buttercup \n scared of?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/un_up/stq5.m4a',
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">
                {{ $storySlides[0]['text'] === $slide['text'] ? 'Pup has Fun' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story9.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story2.png') }}" class="h-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story3.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story4.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Buttercup likes to run for fun.</div>
            <div class="question">After her run she sits in the sun.</div>
            <div class="question">And eats a hot cross bun.</div>
            <div class="question">The pup runs after her as it is having such fun.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story3.png') }}" class="h-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Buttercup likes to run for fun. </div>
            <div class="question">After her run she sits in the sun.</div>
            <div class="question">And eats a hot cross bun.</div>
            <div class="question">The pup runs after her as it is having such fun.</div>
        </div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story9.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story3.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story4.png') }}" class="w-[7vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Buttercup likes to run for fun.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">After her run she sits in the sun.</div>
            <div class="question">And eats a hot cross bun.</div>
            <div class="question">The pup runs after her as it is having such fun.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Buttercup likes to run for fun.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> After her run she sits in the sun. </div>
            <div class="question">And eats a hot cross bun.</div>
            <div class="question">The pup runs after her as it is having such fun.</div>
        </div>
    </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story9.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story2.png') }}" class="h-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story3.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Buttercup likes to run for fun.</div>
            <div class="question">After her run she sits in the sun.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">And eats a hot cross bun.</div>
            <div class="question">The pup runs after her as it is having such fun.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Buttercup likes to run for fun.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> After her run she sits in the sun.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> And eats a hot cross bun.</div>
            <div class="question">The pup runs after her as it is having such fun.</div>
        </div>
    </div>

    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/un_up/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story9.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/unup/story2.png') }}" class="h-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">After her run she sits in the sun.</div>
            <div class="question">And eats a hot cross bun.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">The pup runs after her as it is having such fun.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">2</span> After her run she sits in the sun.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> And eats a hot cross bun.</div>
            <div class="question done"><span class="absolute left-0 pl-5">4</span> The pup runs after her as it is having such fun.</div>
        </div>
    </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            /* CONFIG */
            const returnURL = "{{ url('/phonics_l2/un_up/unup') }}";
            const doneURL = "{{ url('/phonics_l2/un_up/unup') }}";
