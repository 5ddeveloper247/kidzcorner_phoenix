...
@php
    ...
    $panels = [
        [
            'image' => 'phonics_l2/utrev/shut.png',
            'imageSize' => 'h-[16vw]',
            'options' => ['ship', 'shut'],
            'answer' => 'shut',
            'before' => 'sh', 
            'highlight' => 'ut',
            'after' => '', 
            'audio' => 'ut_rev/shut.m4a',
            'tip' =>
                'Tip: Invite children to sound out each word by parts (e.g. /sh/.../ut/) <br> before selecting the word that matches the picture.',
        ],
        [
            'image' => 'phonics_l2/utrev/cut.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['cut', 'cat'],
            'answer' => 'cut',
            'before' => 'c',
            'highlight' => 'ut',
            'after' => '',
            'audio' => 'ut_rev/cut.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/utrev/hut.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['cup', 'hut'],
            'answer' => 'hut',
            'before' => 'h',
            'highlight' => 'ut',
            'after' => '',
            'audio' => 'ut_rev/hut.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/utrev/nut.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['nut', 'net'],
            'answer' => 'nut',
            'before' => 'n',
