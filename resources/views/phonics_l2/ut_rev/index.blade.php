...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ut_rev/ut') }}">
            <img src="{{ asset('assets/images/phonics_l2/utrev/ut.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ut_rev/ug') }}">
            <img src="{{ asset('assets/images/phonics_l2/utrev/ug.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ut_rev/rev') }}">
            <img src="{{ asset('assets/images/phonics_l2/utrev/rev.png') }}" class="mx-auto d-block" />
        </a>
