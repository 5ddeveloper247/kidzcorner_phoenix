...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw2/pw1.png') }}" class="w-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            <span>The scouts hid the bench </span>
            
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">behind</span>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw2/pw2.png') }}" class="w-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            <span>The white whale is</span>
            
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">on </span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>
            <span>the wheel</span>
        </h2>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw2/pw3.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            <span>A chick hactches </span>

            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">from</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>
            <span>the egg.</span>
        </h2>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw2/pw4.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            <span>The sloth sees a fish bathing</span>

            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">in</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw2/pw5.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            <span>Lingo throws the ball</span>

            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">to</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw2/pw6.png') }}" class="h-[20vw]" />
    </div>
