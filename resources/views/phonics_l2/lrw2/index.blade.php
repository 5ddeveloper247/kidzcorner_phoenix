...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-2 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/lrw2/describe') }}">
            <img src="{{ asset('assets/images/phonics_l2/lrw2/describe.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/lrw2/prepositional') }}">
            <img src="{{ asset('assets/images/phonics_l2/lrw2/prepositional.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/lrw2/lets_write') }}">
