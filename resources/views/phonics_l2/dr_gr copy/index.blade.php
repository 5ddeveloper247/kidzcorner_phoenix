...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/dr_gr/dr') }}">
            <img src="{{ asset('assets/images/phonics_l2/drgr/dr.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/dr_gr/gr') }}">
            <img src="{{ asset('assets/images/phonics_l2/drgr/gr.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/dr_gr/drgr') }}">
            <img src="{{ asset('assets/images/phonics_l2/drgr/drgr.png') }}" class="mx-auto d-block" />
        </a>
