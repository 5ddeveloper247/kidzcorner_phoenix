...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full">
        <div class="flex items-end justify-around w-full ">
            <div class="flex items-end gap-[.5vw]">
                <h2 class="large-title">dr</h2>
                <div class="options"></div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options">ool</div>
                <div class="options">ag</div>
                <div class="options">ip</div>
                <div class="options">op</div>
            </div>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                <img src="{{ asset('assets/images/phonics_l2/drgr/drool.png') }}" class="h-[20vw]" />
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">drool</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options opacity-0!">ool</div>
                <div class="options">ag</div>
                <div class="options">ip</div>
                <div class="options">op</div>
            </div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                <img src="{{ asset('assets/images/phonics_l2/drgr/drag.png') }}" class="h-[20vw]" />
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">drag</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options">ool</div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                ...
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">drip</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options">ool</div>
                <div class="options">ag</div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                <img src="{{ asset('assets/images/phonics_l2/drgr/drop.png') }}" class="h-[20vw]" />
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">drop</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options">ool</div>
                <div class="options">ag</div>
                <div class="options">ip</div>
                <div class="options opacity-0!">op</div>
            </div>
        </div>
    </div>
