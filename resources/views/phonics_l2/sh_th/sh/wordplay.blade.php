...
@php
    ...
    $panels = [
        [
            'image' => 'phonics_l2/shth/dish.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['fish', 'dish'],
            'answer' => 'dish',
            'highlight' => 'sh',
            'audio' => 'sh_th/dish.m4a',
            'tip' =>
                'Tip: Invite children to sound out each word by parts (e.g. /sh/.../ip/) <br> before selecting the word that matches the picture.',
        ],
        [
            'image' => 'phonics_l2/shth/wish.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['wish', 'swish'],
            'answer' => 'wish',
            'highlight' => 'sh',
            'audio' => 'sh_th/wish.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/shth/trash.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['trash', 'flash'],
            'answer' => 'trash',
            'highlight' => 'sh',
            'audio' => 'sh_th/trash.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/shth/bush.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['push', 'bush'],
            'answer' => 'bush',
            'highlight' => 'sh',
            'audio' => 'sh_th/bush.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/shth/cash.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['mash', 'cash'],
            'answer' => 'cash',
            'highlight' => 'sh',
            'audio' => 'sh_th/cash.m4a',
            'tip' => null,
        ],
    ];
@endphp
