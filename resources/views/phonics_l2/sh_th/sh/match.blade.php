...
@php
    ...
    $rounds = [
        ...
        [
            'type' => 'grid',
            'cols' => 3,
            'question' => 'Find the picture that begin with the /sh/ sound.',
            'audio' => 'assets/audio/phonics_audio-2/sh_th/match-sh.m4a',
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/shth/dish.png',
                    'audio' => 'assets/audio/phonics_audio-2/sh_th/dish.m4a',
                    'correct' => true,
                ],
                [
                    'image' => 'assets/images/phonics_l2/shth/fish.png',
                    'audio' => 'assets/audio/phonics_audio-2/sh_th/fish.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/shch/sheep.png',
                    'audio' => 'assets/audio/phonics_audio-2/sh_ch/sheep.m4a',
                    'correct' => false,
                ],
                [
                ...
                [
                    ...
                    'audio' => 'assets/audio/phonics_audio-2/sh_th/brush.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/shth/push.png',
                    'audio' => 'assets/audio/phonics_audio-2/sh_th/push.m4a',
                    'correct' => false,
                ],
            ],
        ],
        ...
        [
            ...
            'message' => "That's right! <br> Shower, Shell, Shut and <br> Shark begin with the <br> /th/ sound.",
            'cols' => 2, 
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/shth/dish.png',
...
@section('content')
    ...
    @foreach ($rounds as $round)
        {{-- ───────────────────────────────────────────────────── --}}
        {{-- TYPE: grid — question or reveal grid --}}
        @if ($round['type'] === 'grid')
            @php
