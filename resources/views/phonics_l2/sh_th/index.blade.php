...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/sh_th/sh') }}">
            <img src="{{ asset('assets/images/phonics_l2/shth/sh.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sh_th/th') }}">
            <img src="{{ asset('assets/images/phonics_l2/shth/th.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sh_th/shth') }}">
