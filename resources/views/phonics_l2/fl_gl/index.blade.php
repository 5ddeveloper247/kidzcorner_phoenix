...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/fl_gl/fl') }}">
            <img src="{{ asset('assets/images/phonics_l2/flgl/fl.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/fl_gl/gl') }}">
            <img src="{{ asset('assets/images/phonics_l2/flgl/gl.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/fl_gl/flgl') }}">
            <img src="{{ asset('assets/images/phonics_l2/flgl/flgl.png') }}" class="mx-auto d-block" />
        </a>
