...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full">
        <div class="flex items-end justify-around w-full ">
            ...
            <div class="space-y-[1vw]">
                <div class="options">oss</div>
                <div class="options">y</div>
                <div class="options">oat</div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                <img src="{{ asset('assets/images/phonics_l2/flgl/floss.png') }}" class="h-[20vw]" />
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">floss</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options opacity-0!">oss</div>
                <div class="options">y</div>
                <div class="options">oat</div>
                <div class="options">ag</div>
            </div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                ...
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">fly</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options">oss</div>
                <div class="options opacity-0!">y</div>
                <div class="options">oat</div>
                <div class="options">ag</div>
            </div>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                <img src="{{ asset('assets/images/phonics_l2/flgl/float.png') }}" class="w-[20vw]" />
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">float</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options">oss</div>
                <div class="options">y</div>
    ...
    <div class="phonics-panel flex flex-col justify-center space-y-[2vw] items-center w-full"
        ...
        <div class="flex items-end justify-around w-full ">
            <div class="flex flex-col items-center gap-[1vw]">
                ...
                <div class="options text-[#f7b94a]! text-[3vw]! text-end">flag</div>
            </div>
            <div class="space-y-[1vw]">
                <div class="options">oss</div>
                <div class="options">y</div>
