...
@section('content')
    ...
    <div class="phonics-panel h-full space-y-[1vw]"
        ...
        <div class="flex flex-col items-center space-y-[1vw]">
            ...
            <div class="flex items-end justify-center">
                <img src="{{ asset('assets/images/phonics_l2/flgl/gloves.png') }}" class="h-[13vw]" />
                <div class="flex items-center gap-4">
                    <div class="box"></div>
                    <span class="text-[2.5vw] text-[#f7b94a]">ove</span>
                </div>
            </div>
        </div>
    ...
    <div class="phonics-panel h-full space-y-[1vw]"
        ...
        <div class="flex flex-col items-center space-y-[1vw]">
            ...
            <div class="flex items-end justify-center">
                ...
                <div class="flex items-center gap-4">
                    <div class="box"></div>
                    <span class="text-[2.5vw] text-[#f7b94a]">y</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel h-full space-y-[1vw]"
        ...
        <div class="flex flex-col items-center space-y-[1vw]">
            ...
            <div class="flex items-end justify-center">
                <img src="{{ asset('assets/images/phonics_l2/flgl/globe.png') }}" class="h-[15vw]" />
                <div class="flex items-center gap-4">
                    <div class="box"></div>
                    <span class="text-[2.5vw] text-[#f7b94a]">obe</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel h-full space-y-[1vw]"
        ...
        <div class="space-y-[1vw]">
            ...
            <div class="flex items-end justify-center gap-[1vw]">
                ...
                <div class="flex items-center gap-4">
                    <div class="box"></div>
                    <span class="text-[2.5vw] text-[#f7b94a]">ask</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel h-full space-y-[1vw]"
        ...
        <div class="flex flex-col items-center space-y-[1vw]">
            ...
            <div class="flex items-end justify-center">
                <img src="{{ asset('assets/images/phonics_l2/flgl/glass.png') }}" class="h-[15vw]" />
                <div class="flex items-center gap-4">
                    <div class="box"></div>
                    <span class="text-[2.5vw] text-[#f7b94a]">ass</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel h-full space-y-[1.5vw]"
        ...
        <div class="flex flex-col items-center space-y-[1vw]">
            <div class="flex items-center gap-[1.5vw]">
                ...
                <div class="box">
                    <button class="w-[3vw]" id="soundButton"
                        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/fl-gl/glah.m4a') }}">
                        <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                    </button>
                    <span>gl</span>
                </div>
            ...
            <div class="flex items-end justify-center">
                <img src="{{ asset('assets/images/phonics_l2/flgl/flute.png') }}" class="w-[15vw]" />
                <div class="flex items-center gap-4">
                    <div class="box"></div>
                    <span class="text-[2.5vw] text-[#f7b94a]">ute</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const AUDIO = {
                ...
                gl_ove:   "{{ asset('assets/audio/phonics_audio-2/fl_gl/gl-ove.m4a') }}",
                fl_y:     "{{ asset('assets/audio/phonics_audio-2/fl_gl/fl-y.m4a') }}",
                gl_obe:   "{{ asset('assets/audio/phonics_audio-2/fl_gl/gl-obe.m4a') }}",
                fl_ask:   "{{ asset('assets/audio/phonics_audio-2/fl_gl/fl-ask.m4a') }}",
                gl_ass:   "{{ asset('assets/audio/phonics_audio-2/fl_gl/gl-ass.m4a') }}",
                fl_ute:   "{{ asset('assets/audio/phonics_audio-2/fl_gl/fl-ute.m4a') }}",
            };
