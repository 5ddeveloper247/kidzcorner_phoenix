...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/cl_sl/cl') }}">
            <img src="{{ asset('assets/images/phonics_l2/clsl/cl.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/cl_sl/sl') }}">
            <img src="{{ asset('assets/images/phonics_l2/clsl/sl.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/cl_sl/clsl') }}">
            <img src="{{ asset('assets/images/phonics_l2/clsl/clsl.png') }}" class="mx-auto d-block" />
        </a>
