...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/br_pr/br') }}">
            <img src="{{ asset('assets/images/phonics_l2/brpr/br.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/br_pr/pr') }}">
            <img src="{{ asset('assets/images/phonics_l2/brpr/pr.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/br_pr/brpr') }}">
            <img src="{{ asset('assets/images/phonics_l2/brpr/brpr.png') }}" class="mx-auto d-block" />
        </a>
