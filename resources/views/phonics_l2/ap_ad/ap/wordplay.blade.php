...
@php
    ...
    $panels = [
        [
            'image' => 'phonics_l2/apad/tap.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['sap', 'tap'],
            'answer' => 'tap',
            'highlight' => 'ap',
            'before' => 't', // Part before highlight
            'after' => '', // Part after highlight
            'audio' => 'ap_ad/tap.m4a',
            'tip' =>
                'Tip: Invite children to sound out each word by parts (e.g. /t/.../ap/) <br> before selecting the word that matches the picture.',
        ],
        [
            'image' => 'phonics_l2/apad/wrap.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['wrap', 'trap'],
            'answer' => 'wrap',
            'highlight' => 'ap',
            'before' => 'wr',
            'after' => '',
            'audio' => 'ap_ad/wrap.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/apad/nap.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['map', 'nap'],
            'answer' => 'nap',
            'highlight' => 'ap',
        ...
        [
            'image' => 'phonics_l2/apad/clap.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['clap', 'flap'],
            'answer' => 'clap',
            'highlight' => 'ap',
            'before' => 'cl',
            'after' => '',
            'audio' => 'ap_ad/clap.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/apad/lap.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['gap', 'lap'],
            'answer' => 'lap',
            'highlight' => 'ap',
