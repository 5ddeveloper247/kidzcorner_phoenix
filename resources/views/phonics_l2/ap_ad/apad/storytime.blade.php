...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st1.m4a',
                'image' => 'assets/images/phonics_l2/apad/st1.png',
                'text' => 'Chad and His Map',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st2.m4a',
                'image' => 'assets/images/phonics_l2/apad/st2.png',
                'text' => 'Chat the rat was feeling rather sad.
He had just lost his map!',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st3.m4a',
                'image' => 'assets/images/phonics_l2/apad/st3.png',
                'text' => 'The map was on his lap when he was taking a nap.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st4.m4a',
                'image' => 'assets/images/phonics_l2/apad/st4.png',
                'text' => 'After the nap, he was feeling rather glad.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st5.m4a',
                'image' => 'assets/images/phonics_l2/apad/st5.png',
                'text' => 'Then he found that the map was not in the plastic wrap.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st6.m4a',
                'image' => 'assets/images/phonics_l2/apad/st6.png',
                'text' => 'Instead, all he found was his old dirty cap.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st7.m4a',
                'image' => 'assets/images/phonics_l2/apad/st7.png',
                'text' => 'Was it Brad the cat who took away the map?
Thinking about it made him just mad.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/st8.m4a',
                'image' => 'assets/images/phonics_l2/apad/st8.png',
                'text' => 'Do you know where is Chad’s map?',
            ],
        ];

        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/stq1.m4a',
                'question' => "What was Chad the\nrat feeling sad?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/stq2.m4a',
                'question' => "Where was the\nmap when he was\nsleeping?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/stq3.m4a',
                'question' => "Why did he put\nthe map in a\nplastic wrap?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ap_ad/stq4.m4a',
                'question' => "Why was his dirty\nold cap in the\nplastic wrap?",
                'tip' => 'Tip: Elicit response from children.',
            ]
        ];
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">{{ $storySlides[0]['text'] === $slide['text'] ? 'Chad and His Map' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st5.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st4.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st3.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st2.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Chad the rat was feeling rather sad.</div>
            <div class="question">The map was on his lap when he was taking a nap.</div>
            <div class="question">After the nap, he was feeling rather glad.</div>
            <div class="question">Then he found that the map was not in the plastic wrap.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st3.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Chad the rat was feeling rather sad.</div>
            <div class="question">The map was on his lap when he was taking a nap.</div>
            <div class="question">After the nap, he was feeling rather glad.</div>
            <div class="question">Then he found that the map was not in the plastic wrap.</div>
        </div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st5.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st2.png') }}" class="w-[7vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Chad the rat was feeling rather sad.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">The map was on his lap when he was taking a nap.</div>
            <div class="question">After the nap, he was feeling rather glad.</div>
            <div class="question">Then he found that the map was not in the plastic wrap.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Chad the rat was feeling rather sad.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> The map was on his lap when he was taking a nap.</div>
            <div class="question">After the nap, he was feeling rather glad.</div>
            <div class="question">Then he found that the map was not in the plastic wrap.</div>
        </div>
    </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st5.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st4.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st3.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Chad the rat was feeling rather sad.</div>
            <div class="question">The map was on his lap when he was taking a nap.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">After the nap, he was feeling rather glad.</div>
            <div class="question">Then he found that the map was not in the plastic wrap.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Chad the rat was feeling rather sad. </div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> The map was on his lap when he was taking a nap.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> After the nap, he was feeling rather glad.</div>
            <div class="question">Then he found that the map was not in the plastic wrap.</div>
        </div>
    </div>

    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st5.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/apad/st4.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">The map was on his lap when he was taking a nap.</div>
            <div class="question">After the nap, he was feeling rather glad.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Then he found that the map was not in the plastic wrap.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">2</span> The map was on his lap when he was taking a nap.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> After the nap, he was feeling rather glad.</div>
            <div class="question done"><span class="absolute left-0 pl-5">4</span> Then he found that the map was not in the plastic wrap.</div>
        </div>
    </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            /* CONFIG */
            const returnURL = "{{ url('/phonics_l2/ap_ad/apad') }}";
            const doneURL = "{{ url('/phonics_l2/ap_ad/apad') }}";
