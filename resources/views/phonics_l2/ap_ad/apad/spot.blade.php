...
@php
    ...
    $targetSound = 'ad';
    $targetSoundAudio = asset('assets/audio/phonics_audio-2/ap_ad/apah.m4a');
    ...
    $slidesData = [
        ...
        [
            ...
            'frogPadIndex' => 0,
            'rowPosition' => '35%',
            'options' => [['text' => 'ap'], ['text' => 'st'], ['text' => 'sp'], ['text' => 'sl']],
        ],

        // Slide 4: Question
        [
            'type' => 'question',
            'audio' => asset('assets/audio/phonics_audio-2/ap_ad/spo-adah.m4a'),
            'frogPosition' => 'top',
            'rowPosition' => '35%',
            'layout' => 'with-bottom    ',
            'options' => [
                ...
                ['text' => 'ad', 'audio' => asset('assets/audio/phonics_audio-2/ap_ad/adah.m4a'), 'isAnswer' => true],
                ['text' => 'sl', 'audio' => asset('assets/audio/phonics_audio-2/cl_sl/slah.m4a'), 'isAnswer' => false],
            ],
        ],
        ...
        [
            ...
            'frogPadIndex' => 2,
            'rowPosition' => '45%',
            'options' => [['text' => 'sw'], ['text' => 'cl'], ['text' => 'ad'], ['text' => 'sl']],
        ],
        ...
        [
            ...
            'frogPadIndex' => 1,
            'rowPosition' => '55%',
            'options' => [['text' => 'sn'], ['text' => 'ap'], ['text' => 'sm'], ['text' => 'ch']],
        ],

        // Slide 8: Question
        [
            'type' => 'question',
            'audio' => asset('assets/audio/phonics_audio-2/ap_ad/spot-adah.m4a'),
            'frogPosition' => 'top',
            'rowPosition' => '55%',
            'layout' => 'with-bottom',
            'options' => [
        ...
        [
            ...
            'frogPadIndex' => 0,
            'rowPosition' => '60%',
            'options' => [['text' => 'ad'], ['text' => 'cr'], ['text' => 'fl'], ['text' => 'cl']],
        ],
        ...
        [
            ...
            'frogPadIndex' => 1,
            'rowPosition' => '74%',
            'options' => [['text' => 'st'], ['text' => 'ap'], ['text' => 'sl'], ['text' => 'tr']],
        ],
