...
@php
    ...
    $sideBtns = ['assets/audio/phonics_audio-2/ap_ad/ad.m4a', 'assets/audio/phonics_audio-2/ap_ad/adah.m4a'];

    $words = [
        [
            'image' => 'assets/images/phonics_l2/apad/dad.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'dad',
            'wordAudio' => 'assets/audio/phonics_audio-2/ap_ad/ad-ale.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /d/..../ad/...dad)',
        ],
        [
            'image' => 'assets/images/phonics_l2/apad/mad.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'mad',
            'wordAudio' => 'assets/audio/phonics_audio-2/ap_ad/ad-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/apad/sad.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'sad',
            'wordAudio' => 'assets/audio/phonics_audio-2/ap_ad/ad-istle.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/apad/glad.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'glad',
            'wordAudio' => 'assets/audio/phonics_audio-2/ap_ad/ad-eat.m4a',
            'tip' => null,
        ],
        [
            ...
            'imageSize' => 'h-[20vw]',
            'word' => 'pad',
            'wordAudio' => 'assets/audio/phonics_audio-2/ap_ad/ad-ip.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/apad/bad.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'bad',
            'wordAudio' => 'assets/audio/phonics_audio-2/ap_ad/ad-ite.m4a',
            'tip' => null,
        ]
    ];
...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">had</h2>
                <h2 class="stroke">bad</h2>
                <h2 class="stroke">clad</h2>
            </div>
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <button class="absolute right-[16%] top-[22%] w-[3.5vw]" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/adah.m4a') }}">
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/ad2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/ad3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/ad4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ap_ad/ad5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const CHEERING = "{{ asset('assets/audio/phonics_audio-2/common/bading.mp3') }}";
            ...
            function getAudioForSlide(slide) {
                ...
                if (newContainer) {
                    // Reveal panel: play the word audio + bading
