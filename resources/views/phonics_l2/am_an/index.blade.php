...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/am_an/am') }}">
            <img src="{{ asset('assets/images/phonics_l2/aman/am.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/am_an/an') }}">
            <img src="{{ asset('assets/images/phonics_l2/aman/an.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/am_an/aman') }}">
            <img src="{{ asset('assets/images/phonics_l2/aman/aman.png') }}" class="mx-auto d-block" />
        </a>
