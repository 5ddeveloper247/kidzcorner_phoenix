...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st1.m4a',
                'image' => 'assets/images/phonics_l2/aman/st1.png',
                'text' => 'Sam and His Van',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st2.m4a',
                'image' => 'assets/images/phonics_l2/aman/st2.png',
                'text' => 'Sam the ram drove a van.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st3.m4a',
                'image' => 'assets/images/phonics_l2/aman/st3.png',
                'text' => 'In his van, there was a little fan and lots of cans.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st4.m4a',
                'image' => 'assets/images/phonics_l2/aman/st4.png',
                'text' => 'Some cans were filled with juicy jam',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st5.m4a',
                'image' => 'assets/images/phonics_l2/aman/st5.png',
                'text' => 'While others filled with yummy yam.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st6.m4a',
                'image' => 'assets/images/phonics_l2/aman/st6.png',
                'text' => 'But his favorite can was still chowder made of clams.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st7.m4a',
                'image' => 'assets/images/phonics_l2/aman/st7.png',
                'text' => 'Sam the ram had a plan to sell his cans.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st8.m4a',
                'image' => 'assets/images/phonics_l2/aman/st8.png',
                'text' => 'He sold them near a dam to an old raggedy man.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/st9.m4a',
                'image' => 'assets/images/phonics_l2/aman/st9.png',
                'text' => 'But when he saw the policeman, he just ran!',
            ],
        ];

        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/stq1.m4a',
                'question' => "What did Sam\n drive?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/stq2.m4a',
                'question' => "What was in \n the van?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/stq3.m4a',
                'question' => "which can was\n his favorite?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/am_an/stq4.m4a',
                'question' => "What was \n his plan?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">{{ $storySlides[0]['text'] === $slide['text'] ? 'Sam and His Van' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/am_an/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st5.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st4.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st3.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st2.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Sam the ram drove a van.</div>
            <div class="question">In his van, there was a little fan and lots fo cans.</div>
            <div class="question">Some cans were filled with juicy jams.</div>
            <div class="question">While others were filled with yummy yams.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st3.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Sam the ram drove a van. </div>
            <div class="question">In his van, there was a little fan and lots fo cans.</div>
            <div class="question">Some cans were filled with juicy jams.</div>
            <div class="question">While others were filled with yummy yams.</div>
        </div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/am_an/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st5.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st2.png') }}" class="w-[7vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Sam the ram drove a van.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">In his van, there was a little fan and lots fo cans.</div>
            <div class="question">Some cans were filled with juicy jams.</div>
            <div class="question">While others were filled with yummy yams.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Sam the ram drove a van.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> In his van, there was a little fan and lots fo cans.</div>
            <div class="question">Some cans were filled with juicy jams.</div>
            <div class="question">While others were filled with yummy yams.</div>
        </div>
    </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/am_an/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st5.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st4.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st3.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">Sam the ram drove a van.</div>
            <div class="question">In his van, there was a little fan and lots fo cans.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Some cans were filled with juicy jams.</div>
            <div class="question">While others were filled with yummy yams.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Sam the ram drove a van.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> In his van, there was a little fan and lots fo cans.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> Some cans were filled with juicy jams.</div>
            <div class="question">While others were filled with yummy yams.</div>
        </div>
    </div>

    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/am_an/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st5.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/aman/st4.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">In his van, there was a little fan and lots fo cans.</div>
            <div class="question">Some cans were filled with juicy jams.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">While others were filled with yummy yams.
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> Sam the ram drove a van.
            </div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> In his van, there was a little fan and lots fo cans.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> Some cans were filled with juicy jams.</div>
            <div class="question done"><span class="absolute left-0 pl-5">4</span> While others were filled with yummy yams.</div>
        </div>
    </div>
