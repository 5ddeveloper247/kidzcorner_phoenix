...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st1.m4a',
                'image' => 'assets/images/phonics_l2/spst/st1.png',
                'text' => 'If You Give a Spider a Spotted Star',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st1.m4a',
                'image' => 'assets/images/phonics_l2/spst/st2.png',
                'text' => 'If you give a spider a spotted star.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st3.m4a',
                'image' => 'assets/images/phonics_l2/spst/st3.png',
                'text' => 'It will stick it in a spaghetti jar.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st4.m4a',
                'image' => 'assets/images/phonics_l2/spst/st4.png',
                'text' => 'Fill it with stones and stamps.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st5.m4a',
                'image' => 'assets/images/phonics_l2/spst/st5.png',
                'text' => 'Bury it under the stars with lamps.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st6.m4a',
                'image' => 'assets/images/phonics_l2/spst/st6.png',
                'text' => 'Spin around on its web and not stop.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st7.m4a',
                'image' => 'assets/images/phonics_l2/spst/st7.png',
                'text' => 'Until its spectacles finally drop!',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/st8.m4a',
                'image' => 'assets/images/phonics_l2/spst/st8.png',
                'text' => 'If you give a spider 2 spotted star.',
            ]
        ];

        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/stq1.m4a',
                'question' => "What is the\nspider given?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/stq2.m4a',
                'question' => "Where will the\nspider put the\nspotted star?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/stq3.m4a',
                'question' => "Where will\nthe spider\nbury it?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/stq4.m4a',
                'question' => "Why will the spider\nspin around on\nits web?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sp_st/stq5.m4a',
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">{{ $storySlides[0]['text'] === $slide['text'] ? 'If You Give a Spider a Spotted Star' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sp_st/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st7.png') }}" class="w-[20vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st6.png') }}" class="w-[20vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st2.png') }}" class="w-[20vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st3.png') }}" class="w-[20vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">If you give a spider a spotted star</div>
            <div class="question">It will stick it in a spaghetti jar</div>
            <div class="question">Spin around on its web and not stop</div>
            <div class="question">Until its spectacles finally drop.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[1vw] rounded-xl border-2 border-[#f7b94a] relative w-fit box h-[10vw]">
                ...
                <img src="{{ asset('assets/images/phonics_l2/spst/st2.png') }}" class="w-[20vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st7.png') }}" class="w-[20vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> If you give a spider a spotted star
            </div>
            <div class="question">It will stick it in a spaghetti jar</div>
            <div class="question">Spin around on its web and not stop</div>
            <div class="question">Until its spectacles finally drop.</div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sp_st/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st7.png') }}" class="w-[20vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st3.png') }}" class="w-[20vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">If you give a spider a spotted star</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">It will stick it in a spaghetti jar</div>
            <div class="question">Spin around on its web and not stop</div>
            <div class="question">Until its spectacles finally drop.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">2</span> It will stick it in a spaghetti jar
            </div>
            <div class="question">Spin around on its web and not stop</div>
            <div class="question">Until its spectacles finally drop.</div>
        </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sp_st/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st7.png') }}" class="w-[20vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st6.png') }}" class="w-[20vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st2.png') }}" class="w-[20vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">If you give a spider a spotted star</div>
            <div class="question">It will stick it in a spaghetti jar</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Spin around on its web and not stop</div>
            <div class="question">Until its spectacles finally drop.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">3</span> Spin around on its web and not stop
            </div>
            <div class="question">Until its spectacles finally drop.</div>
        </div>
    </div>
    ...
    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sp_st/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st7.png') }}" class="w-[20vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/spst/st6.png') }}" class="w-[20vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">It will stick it in a spaghetti jar</div>
            <div class="question">Spin around on its web and not stop</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Until its spectacles finally drop.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">4</span> Until its spectacles finally drop.
            </div>
        </div>
    </div>
