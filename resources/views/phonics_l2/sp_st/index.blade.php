...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/sp_st/sp') }}">
            <img src="{{ asset('assets/images/phonics_l2/spst/sp.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sp_st/st') }}">
            <img src="{{ asset('assets/images/phonics_l2/spst/st.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sp_st/spst') }}">
            <img src="{{ asset('assets/images/phonics_l2/spst/spst.png') }}" class="mx-auto d-block" />
        </a>
