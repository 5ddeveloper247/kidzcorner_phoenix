...
@php
    $showBackground = true;
    $refImage = 'assets/images/phonics_l2/spst/spots.png';
    $refAudio = 'assets/audio/phonics_audio-2/sp_st/spots.m4a';

    $questionAudio = 'assets/audio/phonics_audio-2/sp_st/match-sp.m4a';

    $questions = [
        [
            'correctSide' => 'left',
            'correct' => 'assets/images/phonics_l2/spst/spoon.png',
            'correctSize' => 'w-[15vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sp_st/spoon.m4a',
            'correctWord' => 'spoon',
            'answerAudio' => 'assets/audio/phonics_audio-2/sp_st/spoon.m4a',
        ...
        [
            'correctSide' => 'left',
            'correct' => 'assets/images/phonics_l2/spst/spin.png',
            'correctSize' => 'w-[15vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sp_st/spin.m4a',
            'correctWord' => 'spin',
        ...
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/spst/space.png',
            'correctSize' => 'h-[17vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sp_st/space.m4a',
            'correctWord' => 'space',
            'answerAudio' => 'assets/audio/phonics_audio-2/sp_st/space.m4a',
        ...
        [
            'correctSide' => 'left',
            'correct' => 'assets/images/phonics_l2/spst/spider.png',
            'correctSize' => 'w-[17vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sp_st/spider.m4a',
            'correctWord' => 'spider',
            'answerAudio' => 'assets/audio/phonics_audio-2/sp_st/spider.m4a',
            'wrong' => 'assets/images/phonics_l2/swsc/swan.png',
            'wrongSize' => 'w-[17vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/sw_Sc/swan.m4a',
        ],
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/spst/spade.png',
            'correctSize' => 'w-[20vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/sp_st/spade.m4a',
            'correctWord' => 'spade',
            'answerAudio' => 'assets/audio/phonics_audio-2/sp_st/spade.m4a',
            'wrong' => 'assets/images/phonics_l2/swsc/scale.png',
            'wrongSize' => 'h-[20vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/sw_Sc/scale.m4a',
        ],
    ];
    // ============================================================
@endphp
