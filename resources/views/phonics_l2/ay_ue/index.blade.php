...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ay_ue/ay') }}">
            <img src="{{ asset('assets/images/phonics_l2/ayue/ay.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ay_ue/ue') }}">
            <img src="{{ asset('assets/images/phonics_l2/ayue/ue.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ay_ue/ayue') }}">
            <img src="{{ asset('assets/images/phonics_l2/ayue/ayue.png') }}" class="mx-auto d-block" />
        </a>
