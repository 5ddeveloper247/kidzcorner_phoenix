...
@php
    ...
    $rounds = [
        ...
        [
            'type' => 'grid',
            'cols' => 3,
            'question' => 'Find the picture that end with the /u/ sound.',
            ...
            'cards' => [
                ...
                [
                    ...
                    'audio' => 'assets/audio/phonics_audio-2/ay_ue/huge.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/ayue/cube.png',
                    'audio' => 'assets/audio/phonics_audio-2/ay_ue/cube.m4a',
                    'correct' => false,
                ],
                [
        ...
        [
            ...
            'message' => "That's right! <br> Cute, Mule, Huge and <br> Cube end with the <br> /un/ sound.",
            'cols' => 2,
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/ayue/cute.png',
    ...
    <div class="phonics-panel  flex justify-center items-center">
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                ...
                ‘<span class="text-[#70af39]">u</span>’ sound!
            </h2>
        </div>
    </div>
