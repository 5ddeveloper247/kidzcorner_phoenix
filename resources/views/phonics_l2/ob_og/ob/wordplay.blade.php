...
@php
    ...
    $panels = [
        [
            ...
            'audio' => 'ob_og/rob.m4a',
            'tip' =>
                'Tip: Invite children to sound out each word by parts (e.g. /b/.../ed/) <br> before selecting the word that matches the picture.',
        ],
        [
            'image' => 'phonics_l2/obog/knob.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['knob', 'knot'],
            'answer' => 'knob',
            'before' => 'kn',
            'highlight' => 'ob',
            'after' => '',
            'audio' => 'ob_og/knob.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/obog/snob.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['snap', 'snob'],
            'answer' => 'snob',
            'before' => 'sn',
            'highlight' => 'ob',
            'after' => '',
            'audio' => 'ob_og/snob.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/obog/slob.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['slob', 'slip'],
            'answer' => 'slob',
            'before' => 'sl',
