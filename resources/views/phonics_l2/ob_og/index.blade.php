...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ob_og/ob') }}">
            <img src="{{ asset('assets/images/phonics_l2/obog/ob.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ob_og/og') }}">
            <img src="{{ asset('assets/images/phonics_l2/obog/og.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ob_og/obog') }}">
            <img src="{{ asset('assets/images/phonics_l2/obog/obog.png') }}" class="mx-auto d-block" />
        </a>
