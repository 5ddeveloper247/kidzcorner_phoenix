...
@section('content')
    ...
    <div class="phonics-panel flex flex-col mt-[-3vw] h-full items-center space-y-[1.5vw]">
        <h2 class="large-title stroke">Bob and the Blob</h2>
        <img src="{{ asset('assets/images/phonics_l2/obog/rhyme.png') }}" class="h-[20vw]" />
        ...
        <button class="absolute top-1/2 -translate-1/2 left-[-10vw] w-[4vw]" id="soundButton"
            data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ob_og/og-rhyme.mp3') }}">
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const returnURL = "{{ url('/phonics_l2/ob_og/og') }}";
            const doneURL = "{{ url('/phonics_l2/ob_og/og') }}";
