...
@php
    ...
    $rounds = [
        ...
        [
            'type' => 'grid',
            'cols' => 3,
            'question' => 'Find the picture that end with the /id/ sound.',
            'audio' => 'assets/audio/phonics_audio-2/at_rev/match-at.m4a',
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/idin/kid.png',
                    'audio' => 'assets/audio/phonics_audio-2/id_in/kid.m4a',
                    'correct' => true,
                ],
                [
                ...
                [
                    ...
                    'audio' => 'assets/audio/phonics_audio-2/id_in/skid.m4a',
                    'correct' => false,
                ],
                [
                ...
                [
                    ...
                    'audio' => 'assets/audio/phonics_audio-2/id_in/lid.m4a',
                    'correct' => false,
                ],
                [
        ...
        [
            ...
            'message' => "That's right! <br> Kid, Skid, Hid and <br> Lid end with the <br> /id/ sound.",
            'cols' => 2,
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/idin/kid.png',
