...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/id_in/id') }}">
            <img src="{{ asset('assets/images/phonics_l2/idin/id.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/id_in/in') }}">
            <img src="{{ asset('assets/images/phonics_l2/idin/in.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/id_in/idin') }}">
            <img src="{{ asset('assets/images/phonics_l2/idin/idin.png') }}" class="mx-auto d-block" />
        </a>
