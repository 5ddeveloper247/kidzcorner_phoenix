...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ow_oe/ow') }}">
            <img src="{{ asset('assets/images/phonics_l2/owoe/ow.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ow_oe/oe') }}">
            <img src="{{ asset('assets/images/phonics_l2/owoe/oe.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ow_oe/owoe') }}">
            <img src="{{ asset('assets/images/phonics_l2/owoe/owoe.png') }}" class="mx-auto d-block" />
        </a>
