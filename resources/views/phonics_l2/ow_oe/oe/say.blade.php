...
@php
    ...
    $sideBtns = ['assets/audio/phonics_audio-2/ow_oe/oe.m4a', 'assets/audio/phonics_audio-2/ow_oe/oeah.m4a'];

    $words = [
        [
            'image' => 'assets/images/phonics_l2/owoe/bone.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'bone',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-sh.m4a',
            'tip' =>
        ...
        [
            ...
            'imageSize' => 'h-[20vw]',
            'word' => 'cone',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/owoe/hose.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'hose',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-read.m4a',
            'tip' => null,
        ],
        [
            ...
            'imageSize' => 'w-[20vw]',
            'word' => 'nose',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-irty.m4a',
            'tip' => null,
        ],
        [
            ...
            'imageSize' => 'h-[20vw]',
            'word' => 'rose',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-in.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/owoe/hole.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'hole',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/owoe/pole.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'pole',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/owoe/mole.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'mole',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/owoe/stone.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'stone',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/owoe/globe.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'globe',
            'wordAudio' => 'assets/audio/phonics_audio-2/ow_oe/oe-in.m4a',
            'tip' => null,
...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">slope</h2>
                <h2 class="stroke">poke</h2>
                <h2 class="stroke">hole</h2>
            </div>
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <button class="absolute right-[16%] top-[22%] w-[3.5vw]" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/oeah.m4a') }}">
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/oe2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/oe3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/oe4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/oe5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
