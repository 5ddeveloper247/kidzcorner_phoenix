...
@php
    ...
    $questions = [
        // ── Question 1 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/owoe/fun1.png',
            'imageSize' => 'h-[13vw]',
            'audio' => 'assets/audio/phonics_audio-2/ow_oe/fb-owoe1.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'in the pot is starting to'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            ...
            'words' => [
                ['word' => 'flower', 'answer' => true],
                ['word' => 'hose', 'answer' => false],
                ['word' => 'tow',  'answer' => false],
                ['word' => 'grow', 'answer' => true],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/ow_oe/flower.m4a',
                'assets/audio/phonics_audio-2/ow_oe/grow.m4a',
            ],
        ],

        // ── Question 2 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/owoe/fun2.png',
            'imageSize' => 'h-[16vw]',
            'audio' => 'assets/audio/phonics_audio-2/ow_oe/fb-owoe2.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'flies away with the white coloured'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            'tip' => null,
            'words' => [
                ['word' => 'row', 'answer' => false],
                ['word' => 'crow', 'answer' => true],
                ['word' => 'rope', 'answer' => true],
                ['word' => 'pole', 'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/ow_oe/crow.m4a',
                'assets/audio/phonics_audio-2/ow_oe/rope.m4a',
            ],
        ],

        // ── Question 3 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/owoe/fun3.png',
            'imageSize' => 'h-[15vw]',
            'audio' => 'assets/audio/phonics_audio-2/ow_oe/fb-owoe3.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The cheeky mole stuck a'],
                ['type' => 'blank'],
            ...
            'tip' => null,
            'words' => [
                ['word' => 'bow', 'answer' => true],
                ['word' => 'blow', 'answer' => false],
                ['word' => 'globe', 'answer' => true],
                ['word' => 'nose', 'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/ow_oe/bow.m4a',
                'assets/audio/phonics_audio-2/ow_oe/globe.m4a',
            ],
        ],
    ];
