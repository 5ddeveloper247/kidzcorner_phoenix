...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st1.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story1.png',
                'text' => 'Do You Know Rose?',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st2.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story2.png',
                'text' => 'Rose is no ordinary mole and she doesn’t even like
                to dig a hole.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st3.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story3.png',
                'text' => 'She loves to plant flowers in a row.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st4.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story4.png',
                'text' => 'But always get impatient watching them grow.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st5.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story5.png',
                'text' => 'Rose even likes to bathe in the snow using a hose.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st6.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story6.png',
                'text' => 'But then she usually end up sick in bed, blowing her nose.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st7.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story7.png',
                'text' => 'Sometimes, you can even catch Rose swinging
                from pole to pole.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/st8.m4a',
                'image' => 'assets/images/phonics_l2/owoe/story8.png',
                'text' => 'But you will never catch Rose the mole digging a hole.',
            ],
        ...
        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/stq1.m4a',
                'question' => "What animal \n is Rose?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/stq2.m4a',
                'question' => "What doesn’t \n she like to do?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/stq3.m4a',
                'question' => "Why does she \n get impatient?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/stq4.m4a',
                'question' => "Why does \nshe felt sick?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/stq5.m4a',
                'question' => "What does she  \n swing from?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/ow_oe/stq6.m4a',
                'question' => "Why do you  \n think Rose is not  \n an ordinary Mole?",
                'tip' => 'Tip: Elicit response from children.',
            ],
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">
                {{ $storySlides[0]['text'] === $slide['text'] ? 'Do You Know Rose?' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story6.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story5.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story2.png') }}" class="h-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story3.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">She loves to plant flowers in a row.</div>
            <div class="question">But always gets impatient watching them grow.</div>
            <div class="question">Rose even likes to bathe in the snow using a hose.</div>
            <div class="question">But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story5.png') }}" class="h-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> She loves to plant flowers in a row. </div>
            <div class="question">But always gets impatient watching them grow.</div>
            <div class="question">Rose even likes to bathe in the snow using a hose.</div>
            <div class="question">But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story6.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story5.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story2.png') }}" class="h-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story3.png') }}" class="w-[7vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">She loves to plant flowers in a row.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">But always gets impatient watching them grow.</div>
            <div class="question">Rose even likes to bathe in the snow using a hose.</div>
            <div class="question">But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> She loves to plant flowers in a row.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> But always gets impatient watching them grow. </div>
            <div class="question">Rose even likes to bathe in the snow using a hose.</div>
            <div class="question">But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story6.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story2.png') }}" class="h-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story3.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">She loves to plant flowers in a row.</div>
            <div class="question">But always gets impatient watching them grow.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">Rose even likes to bathe in the snow using a hose.</div>
            <div class="question">But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> She loves to plant flowers in a row.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> But always gets impatient watching them grow.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> Rose even likes to bathe in the snow using a hose.</div>
            <div class="question">But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    </div>

    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story6.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/owoe/story5.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">But always gets impatient watching them grow.</div>
            <div class="question">Rose even likes to bathe in the snow using a hose.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">2</span> But always gets impatient watching them grow.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> Rose even likes to bathe in the snow using a hose.</div>
            <div class="question done"><span class="absolute left-0 pl-5">4</span> But then she usually ends up sick in bed blowing her nose.</div>
        </div>
    </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            /* CONFIG */
            const returnURL = "{{ url('/phonics_l2/ow_oe/owoe') }}";
            const doneURL = "{{ url('/phonics_l2/ow_oe/owoe') }}";
