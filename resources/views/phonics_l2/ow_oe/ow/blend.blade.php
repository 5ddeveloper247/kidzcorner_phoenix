...
@php
    ...
    $questions = [
        // Question 1
        [
            'sound1' => ['text' => '/sn/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/snow.m4a'],
            'sound2' => ['text' => '/ow/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/snow.m4a'],
            'options' => [
                [
                ...
                [
                    ...
                    'class' => 'w-[8vw]',
                    'audio' => 'assets/audio/phonics_audio-2/ow_oe/snow',
                    'isCorrect' => true,
                ],
                [
                    'image' => 'assets/images/phonics_l2/spst/stop.png',
                    'class' => 'w-[8vw]',
                    'audio' => 'assets/audio/phonics_audio-2/sp_st/stop',
                    'isCorrect' => false,
                ],
            ],
            'questionAudio' => 'assets/audio/phonics_audio-2/fl_gl/match-fl.m4a',
            'answerAudio' => 'assets/audio/phonics_audio-2/ow_oe/snow.m4a',
            'answertext' => 'snow',
        ],
        // Question 2
        [
            'sound1' => ['text' => '/gl/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/glow.m4a'],
            'sound2' => ['text' => '/ow/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/glow.m4a'],
            'options' => [
                [
                    'image' => 'assets/images/phonics_l2/owoe/glow.png',
                    'class' => 'h-[8vw]',
                    'audio' => 'assets/audio/phonics_audio-2/ow_oe/glow.m4a',
                    'isCorrect' => true,
                ],
                [
            ...
            'questionAudio' => 'assets/audio/phonics_audio-2/fl_gl/match-fl.m4a',
            'answerAudio' => 'assets/audio/phonics_audio-2/ow_oe/glow.m4a',
            'answertext' => 'glow',
        ],
        // Question 3
        [
            'sound1' => ['text' => '/bl/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/blow.m4a'],
            'sound2' => ['text' => '/ow/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/blow.m4a'],
            'options' => [
                [
                ...
                [
                    ...
                    'class' => 'w-[8vw]',
                    'audio' => 'assets/audio/phonics_audio-2/ow_oe/blow',
                    'isCorrect' => false,
                ],
            ],
            'questionAudio' => 'assets/audio/phonics_audio-2/fl_gl/match-fl.m4a',
            'answerAudio' => 'assets/audio/phonics_audio-2/ow_oe/blow.m4a',
            'answertext' => 'blow', 
        ],
        // Question 4
        [
            'sound1' => ['text' => '/cr/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/crow.m4a'],
            'sound2' => ['text' => '/ow/', 'audio' => 'assets/audio/phonics_audio-2/ow_oe/crow.m4a'],
            'options' => [
                [
                ...
                [
                    ...
                    'class' => 'h-[8vw]',
                    'audio' => 'assets/audio/phonics_audio-2/ow_oe/crow',
                    'isCorrect' => true,
                ],
                [
            ...
            'questionAudio' => 'assets/audio/phonics_audio-2/fl_gl/match-fl.m4a',
            'answerAudio' => 'assets/audio/phonics_audio-2/ow_oe/crow.m4a',
            'answertext' => 'crow',
        ],
    ];
@endphp
...
@section('content')
    ...
    @foreach ($questions as $q)
        ...
        <div class="phonics-panel flex flex-col justify-center gap-[2vw] items-center"
            ...
            <div class="flex items-end w-[40vw] justify-between">
