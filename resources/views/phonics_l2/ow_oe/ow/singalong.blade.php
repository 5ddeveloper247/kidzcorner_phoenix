...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full justify-between items-center">
        <div class="text-center">
            <h2 class="large-title">OW</h2>
            <p class="note">Sing to the tune of “Skip to My Lou’</p>
        </div>

        <img src="{{ asset('assets/images/phonics_l2/owoe/singalong.png') }}" class="ml-15" />
        ...
        <button class="absolute top-1/2 -translate-1/2 left-[-10vw] w-[4vw]" id="soundButton"
            data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ow_oe/ow-singalong.mp3') }}">
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const returnURL = "{{ url('/phonics_l2/ow_oe/ow') }}";
            const doneURL = "{{ url('/phonics_l2/ow_oe/ow') }}";
