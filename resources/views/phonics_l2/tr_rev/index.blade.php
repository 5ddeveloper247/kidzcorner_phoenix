...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/tr_rev/tr') }}">
            <img src="{{ asset('assets/images/phonics_l2/trev/tr.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/tr_rev/pr') }}">
            <img src="{{ asset('assets/images/phonics_l2/trev/pr.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/tr_rev/rev') }}">
