...
@php
    $showBackground = true;
    $refImage = 'assets/images/phonics_l2/trev/tree.png';
    $refAudio = 'assets/audio/phonics_audio-2/tr_rev/tree.m4a';
    ...
    $questions = [
        [
            'correctSide' => 'left',
            'correct' => 'assets/images/phonics_l2/trev/train.png',
            'correctSize' => 'w-[20vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/tr_rev/train.m4a',
            'correctWord' => 'traim',
            'answerAudio' => 'assets/audio/phonics_audio-2/tr_rev/train.m4a',
            'wrong' => 'assets/images/phonics_l2/drgr/grapes.png',
            'wrongSize' => 'w-[20vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/dr_gr/grapes.m4a',
        ],
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/trev/tractor.png',
            'correctSize' => 'w-[20vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/tr_rev/tractor.m4a',
            'correctWord' => 'tractor',
        ...
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/trev/trip.png',
            'correctSize' => 'h-[17vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/tr_rev/trip.m4a',
            'correctWord' => 'trip',
            'answerAudio' => 'assets/audio/phonics_audio-2/tr_rev/trip.m4a',
        ...
        [
            'correctSide' => 'left',
            'correct' => 'assets/images/phonics_l2/trev/trumpet.png',
            'correctSize' => 'w-[17vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/tr_rev/trumpet.m4a',
            'correctWord' => 'trumpet',
            'answerAudio' => 'assets/audio/phonics_audio-2/tr_rev/trumpet.m4a',
        ...
        [
            'correctSide' => 'right',
            'correct' => 'assets/images/phonics_l2/trev/truck.png',
            'correctSize' => 'w-[16vw]',
            'correctAudio' => 'assets/audio/phonics_audio-2/tr_rev/truck.m4a',
            'correctWord' => 'truck',
            'answerAudio' => 'assets/audio/phonics_audio-2/tr_rev/truck.m4a',
            'wrong' => 'assets/images/phonics_l2/drgr/drip.png',
            'wrongSize' => 'w-[16vw]',
            'wrongAudio' => 'assets/audio/phonics_audio-2/dr_gr/drip.m4a',
        ],
