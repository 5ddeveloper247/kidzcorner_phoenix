...
@php
    ...
    $returnURL = '/phonics_l2/tr_rev/rev';
    $doneURL = '/phonics_l2/tr_rev/rev';

    $questions = [
        [
            'image' => 'assets/images/phonics_l2/trev/drum.png',
            'imageSize' => 'w-[15vw]',
            'ending' => 'um',
            'answerAudio' => 'assets/audio/phonics_audio-2/dr_gr/dr-um.m4a',
            'choices' => [
                ...
                ['blend' => 'dr', 'audio' => 'assets/audio/phonics_audio-2/dr_gr/drah.m4a', 'correct' => true],
        ...
        [
            ...
            'imageSize' => 'h-[15vw]',
            'ending' => 'ee',
            'answerAudio' => 'assets/audio/phonics_audio-2/tr_rev/tr-ee.m4a',
            'choices' => [
                ['blend' => 'tr', 'audio' => 'assets/audio/phonics_audio-2/tr_rev/trah.m4a', 'correct' => true],
                ['blend' => 'pr', 'audio' => 'assets/audio/phonics_audio-2/br_pr/prah.m4a', 'correct' => false],
                ['blend' => 'cr', 'audio' => 'assets/audio/phonics_audio-2/br_pr/crah.m4a', 'correct' => false],
                ['blend' => 'br', 'audio' => 'assets/audio/phonics_audio-2/br_pr/brah.m4a', 'correct' => false],
            ],
        ],

        [
            'image' => 'assets/images/phonics_l2/trev/break.png',
            'imageSize' => 'h-[15vw]',
            'ending' => 'eak',
            'answerAudio' => 'assets/audio/phonics_audio-2/br_pr/br-eak.m4a',
            'choices' => [
                ['blend' => 'fr', 'audio' => 'assets/audio/phonics_audio-2/fr_cr/frah.m4a', 'correct' => false],
                ['blend' => 'br', 'audio' => 'assets/audio/phonics_audio-2/br_pr/brah.m4a', 'correct' => true],
        ...
        [
            'image' => 'assets/images/phonics_l2/trev/press.png',
            'imageSize' => 'h-[15vw]',
            'ending' => 'ess',
            'answerAudio' => 'assets/audio/phonics_audio-2/br_pr/pr-ess.m4a',
            'choices' => [
                ['blend' => 'bl', 'audio' => 'assets/audio/phonics_audio-2/bl_pl/blah.mp3', 'correct' => false],
                ['blend' => 'gr', 'audio' => 'assets/audio/phonics_audio-2/dr_gr/grah.m4a', 'correct' => false],
                ['blend' => 'pl', 'audio' => 'assets/audio/phonics_audio-2/cl_sl/pluh.m4a', 'correct' => false],
                ['blend' => 'pr', 'audio' => 'assets/audio/phonics_audio-2/br_pr/prah.m4a', 'correct' => true],
            ],
        ],
        ...
        [
            ...
            'imageSize' => 'w-[15vw]',
            'ending' => 'ayon',
            'answerAudio' => 'assets/audio/phonics_audio-2/fr_cr/cr-ayon.m4a',
            'choices' => [
                ['blend' => 'cr', 'audio' => 'assets/audio/phonics_audio-2/fr_cr/crah.m4a', 'correct' => true],
        ...
        [
            ...
            'imageSize' => 'h-[15vw]',
            'ending' => 'iends',
            'answerAudio' => 'assets/audio/phonics_audio-2/fr_cr/fr-iends.m4a',
            'choices' => [
                ['blend' => 'fl', 'audio' => 'assets/audio/phonics_audio-2/fl_gl/flah.m4a', 'correct' => false],
                ['blend' => 'fr', 'audio' => 'assets/audio/phonics_audio-2/fr_cr/frah.m4a', 'correct' => true],
                ['blend' => 'tr', 'audio' => 'assets/audio/phonics_audio-2/tr_rev/trah.m4a', 'correct' => false],
                ['blend' => 'gl', 'audio' => 'assets/audio/phonics_audio-2/fl_gl/glah.m4a', 'correct' => false],
            ],
        ],
