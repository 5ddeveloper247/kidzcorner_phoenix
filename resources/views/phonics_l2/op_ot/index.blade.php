...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/op_ot/op') }}">
            <img src="{{ asset('assets/images/phonics_l2/opot/op.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/op_ot/ot') }}">
            <img src="{{ asset('assets/images/phonics_l2/opot/ot.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/op_ot/opot') }}">
            <img src="{{ asset('assets/images/phonics_l2/opot/opot.png') }}" class="mx-auto d-block" />
        </a>
