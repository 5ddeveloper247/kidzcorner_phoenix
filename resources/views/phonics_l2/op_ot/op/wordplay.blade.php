...
@php
    ...
    $panels = [
        ...
        [
            'image' => 'phonics_l2/opot/chop.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['drop', 'chop'],
            'answer' => 'chop',
            'before' => 'ch',
            'highlight' => 'op',
            'after' => '',
            'audio' => 'op_ot/chop.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/opot/stop.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['stop', 'shop'],
            'answer' => 'stop',
            'before' => 'st',
