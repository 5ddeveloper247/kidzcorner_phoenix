...
@php
    ...
    $rounds = [
        ...
        [
            'type' => 'grid',
            'cols' => 3,
            'question' => 'Find the picture that end with the /op/ sound.',
            'audio' => 'assets/audio/phonics_audio-2/at_rev/match-at.m4a',
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/opot/drop.png',
                    'audio' => 'assets/audio/phonics_audio-2/op_ot/drop.m4a',
                    'correct' => true,
                ],
                [
                    'image' => 'assets/images/phonics_l2/opot/shop.png',
                    'audio' => 'assets/audio/phonics_audio-2/op_ot/shop.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/obog/rob.png',
                    'audio' => 'assets/audio/phonics_audio-2/ob_og/rob.m4a',
                    'correct' => false,
                ],
                [
                ...
                [
                    ...
                    'audio' => 'assets/audio/phonics_audio-2/op_ot/stop.m4a',
                    'correct' => false,
                ],
                [
                    'image' => 'assets/images/phonics_l2/opot/mop.png',
                    'audio' => 'assets/audio/phonics_audio-2/op_ot/mop.m4a',
                    'correct' => false,
                ],
            ],
        ],
        ...
        [
            ...
            'imageSize' => 'w-[20vw]',
            'word' => 'stop',
            'audio' => 'assets/audio/phonics_audio-2/op_iot/sled.m4a',
        ],
        ...
        [
            ...
            'message' => "That's right! <br> Drop, Shop, Stop and <br> Mop end with the <br> /op/ sound.",
            'cols' => 2,
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/opot/drop.png',
