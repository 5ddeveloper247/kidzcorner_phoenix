...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/bl_pl/bl') }}">
            <img src="{{ asset('assets/images/phonics_l2/blpl/bl.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/bl_pl/pl') }}">
            <img src="{{ asset('assets/images/phonics_l2/blpl/pl.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/bl_pl/blpl') }}">
            <img src="{{ asset('assets/images/phonics_l2/blpl/blpl.png') }}" class="mx-auto d-block" />
        </a>
...
@push('script')
    <script>
        document.body.dataset.homeRoute = "{{ url('/phonics/l') }}";
    </script>
@endpush
