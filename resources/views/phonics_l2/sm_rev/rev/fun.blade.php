...
@php
    ...
    $returnURL = '/phonics_l2/sm_rev/rev';
    $doneURL = '/phonics_l2/sm_rev/rev';
    ...
    $questions = [
        // ── Question 1 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/smrev/fun1.png',
            'imageSize' => 'h-[13vw]',
            'audio' => 'assets/audio/phonics_audio-2/sm_rev/fb-rev1.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The skunk'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'the snow with a '],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            ...
            'words' => [
                ['word' => 'scoops', 'answer' => true],
                ['word' => 'spoon', 'answer' => true],
                ['word' => 'swing', 'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/sw_sc/scoop.m4a',
                'assets/audio/phonics_audio-2/sp_st/spoon.m4a',
            ],
        ],

        // ── Question 2 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/smrev/fun2.png',
            'imageSize' => 'h-[16vw]',
            'audio' => 'assets/audio/phonics_audio-2/sm_rev/fb-rev2.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The scout has'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'on his'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            'tip' => null,
            'words' => [
                ['word' => 'swell', 'answer' => false],
                ['word' => 'stars', 'answer' => true],
                ['word' => 'sweater', 'answer' => true],
                ['word' => 'skip', 'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/sp_st/star.m4a',
                'assets/audio/phonics_audio-2/sw_sc/sweater.m4a',
            ],
        ],

        // ── Question 3 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/smrev/fun3.png',
            'imageSize' => 'h-[15vw]',
            'audio' => 'assets/audio/phonics_audio-2/sm_rev/fb-rev3.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The snake and the'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'are on the'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            'tip' => null,
            'words' => [
                ['word' => 'spider', 'answer' => true],
                ['word' => 'scare', 'answer' => false],
                ['word' => 'spill', 'answer' => false],
                ['word' => 'swing', 'answer' => true],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/sk_sn/snake.m4a',
                'assets/audio/phonics_audio-2/sw_sc/swing.m4a',
            ],
        ],
    ];
...
@section('content')
    ...
    @foreach ($questions as $q)
        ...
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1.5vw]"
            ...
            <div class="flex items-center gap-1 text-[2vw] mt-3">
        ...
        @foreach ($answerWords as $revealIdx => $answerWord)
            ...
            <div class="answer phonics-panel h-full flex flex-col justify-center items-center space-y-[2vw]"
                ...
                <div class="flex items-center gap-2 text-[2vw] mt-3">
