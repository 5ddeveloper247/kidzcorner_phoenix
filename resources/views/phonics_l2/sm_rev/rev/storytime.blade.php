...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st1.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st1.png',
                'text' => 'What’s that smell?',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st2.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st2.png',
                'text' => 'What’s that smell?',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st3.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st3.png',
                'text' => 'It makes me sneeze until my nose swells.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st4.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st4.png',
                'text' => 'I sniff around but I can’t find where it dwells.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st5.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st5.png',
                'text' => 'Does the smell come from my starry sweater? No, my starry sweater smells better!',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st6.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st6.png',
                'text' => 'Does the smell come from my snail? No, my snail isn’t stale as I wash it daily in a pail.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st7.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st7.png',
                'text' => 'The smell comes from under the stairs.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/st8.m4a',
                'image' => 'assets/images/phonics_l2/smrev/st8.png',
                'text' => 'It’s a sweaty skunk eating scallops with a spoon on my chair!',
            ]
        ];

        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/stq1.m4a',
                'question' => "Why does the\nboy’s nose\nswell?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/stq2.m4a',
                'question' => "Why does he\nsmell his\nstarry\nsweater?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/stq3.m4a',
                'question' => "Why does he wash\nhis snail daily?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/stq4.m4a',
                'question' => "Where does the\nsmell come\nfrom?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/sm_rev/stq5.m4a',
                'question' => "Why is it smells\nbad?",
                'tip' => 'Tip: Elicit response from children.',
            ]
        ];
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">{{ $storySlides[0]['text'] === $slide['text'] ? 'What’s that smell?' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sm_rev/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st7.png') }}" class="w-[15vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st8.png') }}" class="w-[15vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st2.png') }}" class="w-[15vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st3.png') }}" class="w-[15vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">What’s that smell?</div>
            <div class="question">It makes me sneeze until my nose swells</div>
            <div class="question">The smell comes from under the stairs.</div>
            <div class="question">It’s a sweaty skunk eating scallops on my chair.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[1vw] rounded-xl border-2 border-[#f7b94a] relative w-fit box h-[10vw]">
                ...
                <img src="{{ asset('assets/images/phonics_l2/smrev/st2.png') }}" class="w-[15vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st7.png') }}" class="w-[15vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> What’s that smell?
            </div>
            <div class="question">It makes me sneeze until my nose swells</div>
            <div class="question">The smell comes from under the stairs.</div>
            <div class="question">It’s a sweaty skunk eating scallops on my chair.</div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sm_rev/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st7.png') }}" class="w-[15vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st3.png') }}" class="w-[15vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">What’s that smell?</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">It makes me sneeze until my nose swells</div>
            <div class="question">The smell comes from under the stairs.</div>
            <div class="question">It’s a sweaty skunk eating scallops on my chair.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">2</span> It makes me sneeze until my nose swells
            </div>
            <div class="question">The smell comes from under the stairs.</div>
            <div class="question">It’s a sweaty skunk eating scallops on my chair.</div>
        </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sm_rev/st7.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st7.png') }}" class="w-[15vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st8.png') }}" class="w-[10vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st2.png') }}" class="w-[15vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">What’s that smell?</div>
            <div class="question">It makes me sneeze until my nose swells</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">The smell comes from under the stairs.</div>
            <div class="question">It’s a sweaty skunk eating scallops on my chair.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">3</span> The smell comes from under the stairs.
            </div>
            <div class="question">It’s a sweaty skunk eating scallops on my chair.</div>
        </div>
    </div>
    ...
    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sm_rev/st8.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st7.png') }}" class="w-[15vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/smrev/st8.png') }}" class="w-[15vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">It makes me sneeze until my nose swells</div>
            <div class="question">The smell comes from under the stairs.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">It’s a sweaty skunk eating scallops on my chair.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">4</span> It’s a sweaty skunk eating scallops on my chair.
            </div>
        </div>
    </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            /* CONFIG */
            const returnURL = "{{ url('/phonics_l2/sm_rev/rev') }}";
            const doneURL = "{{ url('/phonics_l2/sm_rev/rev') }}";
