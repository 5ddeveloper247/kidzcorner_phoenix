...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/sm_rev/sm') }}">
            <img src="{{ asset('assets/images/phonics_l2/smrev/sm.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sm_rev/sc') }}">
            <img src="{{ asset('assets/images/phonics_l2/swsc/sc.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/sm_rev/rev') }}">
            <img src="{{ asset('assets/images/phonics_l2/smrev/rev.png') }}" class="mx-auto d-block" />
        </a>
