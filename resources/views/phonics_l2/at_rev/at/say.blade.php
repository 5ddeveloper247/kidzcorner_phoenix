...
@php
    ...
    $returnURL = '/phonics_l2/at_rev/at';
    $doneURL = '/phonics_l2/at_rev/at';

    $diagraph = 'at';

    $sideBtns = ['assets/audio/phonics_audio-2/at_rev/at.m4a', 'assets/audio/phonics_audio-2/at_rev/atah.m4a'];

    $words = [
        [
            'image' => 'assets/images/phonics_l2/atrev/bat.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'bat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-sh.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /b/..../at/...bat)',
        ],
        [
            'image' => 'assets/images/phonics_l2/atrev/cat.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'cat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/atrev/fat.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'fat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-read.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/atrev/hat.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'hat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-irty.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/atrev/mat.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'mat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-in.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/atrev/rat.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'rat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-ick.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/atrev/sat.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'sat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-ief.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/atrev/pat.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'pat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-ief.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/atrev/flat.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'flat',
            'wordAudio' => 'assets/audio/phonics_audio-2/at_rev/at-ief.m4a',
            'tip' => null,
...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">flat</h2>
                <h2 class="stroke">brat</h2>
                <h2 class="stroke">chat</h2>
            </div>
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <button class="absolute right-[16%] top-[22%] w-[3.5vw]" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/phonics_audio-2/at_rev/atah.m4a') }}">
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/at_rev/at2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/at_rev/at3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/at_rev/at4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/at_rev/at5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                ...
                digrgh '<span class="text-[#70af39]">{{ $diagraph }}</span>'?
            </h2>
        </div>
    ...
    @foreach ($words as $item)
        ...
        <div class="phonics-panel flex flex-col items-center justify-between">
            ...
            <div class="flex gap-x-[4vw] items-center justify-center">
                <div>
                    <span class="text-white text-[1.5vw]">Short Vowel Family</span>
