...
@php
    ...
    $panels = [
        [
            'image' => 'phonics_l2/atrev/bat.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['brat', 'bat'],
            'answer' => 'bat',
            'before' => 'b', 
            'highlight' => 'at',
            'after' => '', 
            'audio' => 'at_rev/bat.m4a',
            'tip' =>
                'Tip: Invite children to sound out each word by parts (e.g. /d/.../am/) <br> before selecting the word that matches the picture.',
        ],
        [
            'image' => 'phonics_l2/atrev/rat.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['rat', 'hat'],
            'answer' => 'rat',
            'before' => 'r',
            'highlight' => 'at',
            'after' => '',
            'audio' => 'at_rev/rat.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/atrev/hat.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['mat', 'hat'],
            'answer' => 'hat',
            'before' => 'h',
            'highlight' => 'at',
            'after' => '',
            'audio' => 'at_rev/hat.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/atrev/sat.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['sat', 'splat'],
            'answer' => 'sat',
            'before' => 's',
            'highlight' => 'at',
            'after' => '',
            'audio' => 'at_rev/sat.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/atrev/fat.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['flat', 'fat'],
            'answer' => 'fat',
            'before' => 'f',
