...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/at_rev/at') }}">
            <img src="{{ asset('assets/images/phonics_l2/atrev/at.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/at_rev/ab') }}">
            <img src="{{ asset('assets/images/phonics_l2/agab/ab.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/at_rev/rev') }}">
            <img src="{{ asset('assets/images/phonics_l2/atrev/rev.png') }}" class="mx-auto d-block" />
        </a>
