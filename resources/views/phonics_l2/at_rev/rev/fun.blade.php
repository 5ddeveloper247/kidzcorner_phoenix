...
@php
    ...
    $introPanelTip = "Tips: Encourage children to say the 'at' sound. <br>
        Remind them to listen to the initial sound when naming each object.";

    $questions = [
        // ── Question 1 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/atrev/fun1.png',
            'imageSize' => 'h-[13vw]',
            'audio' => 'assets/audio/phonics_audio-2/at_rev/fb-atrev1.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'This'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'trips on the'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => ' and falls on the mat.'],
            ],
            ...
            'words' => [
                ['word' => 'rat', 'answer' => true],
                ['word' => 'cat', 'answer' => false],
                ['word' => 'cap', 'answer' => true],
                ['word' => 'crab',  'answer' => false],
            ],
            'answerAudios' => [
                'assets/audio/phonics_audio-2/at_rev/rat.m4a',
        ...
        // ── Question 2 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/atrev/fun2.png',
            'imageSize' => 'h-[16vw]',
            'audio' => 'assets/audio/phonics_audio-2/at_rev/fb-atrev2.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The ram sits infornt of the'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'and eats the'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            'tip' => null,
            'words' => [
                ...
                ['word' => 'yam', 'answer' => false],
                ['word' => 'jam', 'answer' => true],
            ],
            'answerAudios' => [
        ...
        // ── Question 3 ──────────────────────────────────────────
        [
            'image' => 'assets/images/phonics_l2/atrev/fun3.png',
            'imageSize' => 'h-[15vw]',
            'audio' => 'assets/audio/phonics_audio-2/at_rev/fb-atrev3.m4a',
            'sentence' => [
                ['type' => 'text', 'text' => 'The stag waves the'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => 'from the green'],
                ['type' => 'blank'],
                ['type' => 'text', 'text' => '.'],
            ],
            'tip' => null,
