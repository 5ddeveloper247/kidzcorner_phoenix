...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/it_rev/it') }}">
            <img src="{{ asset('assets/images/phonics_l2/itrev/it.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/it_rev/in') }}">
            <img src="{{ asset('assets/images/phonics_l2/itrev/in.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/it_rev/rev') }}">
            <img src="{{ asset('assets/images/phonics_l2/itrev/rev.png') }}" class="mx-auto d-block" />
        </a>
