...
@php
    ...
    $targetSound = [
        'text' => 'ot',
        'audio' => 'assets/audio/phonics_audio-2/id_in/idah.m4a',
    ];
    ...
    $questions = [
        ...
        // ── Question 3 ──────────────────────────────────
        [
            'slideAudio' =>'assets/audio/phonics_audio-2/it_rev/spot-itah.m4a',
            ...
            'circles' => [
                ...
                ['text' => 'ip', 'audio' => 'assets/audio/phonics_audio-2/ig_ip/ipah.m4a', 'isCorrect' => false],
                ['text' => 'ig', 'audio' => 'assets/audio/phonics_audio-2/ig_ip/igah.m4a', 'isCorrect' => false],
                ['text' => 'it', 'audio' => 'assets/audio/phonics_audio-2/it_rev/itah.m4a', 'isCorrect' => true],
            ],
        ],
...
@push('script')
    <script>
        ...
        const CONFIG = {
            returnURL: "{{ url('/phonics_l2/it_rev/rev') }}",
            doneURL: "{{ url('/phonics_l2/it_rev/rev') }}",
