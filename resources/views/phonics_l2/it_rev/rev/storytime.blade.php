...
@section('content')
    ...
    @php
        ...
        $storySlides = [
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st1.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story1.png',
                'text' => 'Kit and the Squid',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st2.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story2.png',
                'text' => 'Kit the kid found a squid and hid it in a tin.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st3.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story3.png',
                'text' => 'He tried to teach the squid to skip and do a split.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st4.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story4.png',
                'text' => 'But the squid just wanted to sit and knit',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st5.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story5.png',
                'text' => 'He tried to teach the squid to dance a jig.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st6.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story6.png',
                'text' => 'But the squid wore a wig and started to dig with a twig.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st7.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story7.png',
                'text' => 'He tried to teach the squid how to sail a ship.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st8.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story8.png',
                'text' => 'But the squid decided instead to take a dip.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/st9.m4a',
                'image' => 'assets/images/phonics_l2/itrev/story9.png',
                'text' => 'Poor Kit! What can he do with the squid?',
            ],
        ];

        $storyQuestions = [
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/stq1.m4a',
                'question' => "Why did Kit hide \n the squid \n in the tin?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/stq2.m4a',
                'question' => "What was the first \nthing that Kit\n taught the \n squid?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/stq3.m4a',
                'question' => "What did the squid \n want to do \n instead?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/stq4.m4a',
                'question' => "What was the second \n thing that Kit \n taught the squid?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/stq5.m4a',
                'question' => "What did the squid \n dig with?",
                'tip' => 'Tip: Elicit response from children.',
            ],
            [
                'audio' => 'assets/audio/phonics_audio-2/it_rev/stq6.m4a',
                'question' => "What should Kit \n do with the \n Squid?",
                'tip' => 'Tip: Elicit response from children.',
            ],
        ];
    ...
    @foreach ($storySlides as $slide)
        <div class="phonics-panel h-full flex flex-col justify-center items-center space-y-[1vw]"
            ...
            <h2 class="title-top stroke">
                {{ $storySlides[0]['text'] === $slide['text'] ? 'Kit and the Squid' : '' }}
            </h2>
    ...
    {{-- Panel 14 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/it_rev/st2.m4a') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story3.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story5.png') }}" class="h-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story4.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story6.png') }}" class="w-[7vw]" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">He tried to teach the squid to skip and do a slip.</div>
            <div class="question">But the squid just wanted to sit and knit.</div>
            <div class="question">He tried to teach the squid to dance a jig</div>
            <div class="question">But the squid wore a wig and started to dig with a twig.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/common/cheering.mp3') }}">
        ...
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[1vw] rounded-xl border-2 border-[#f7b94a] relative w-[10vw] box h-[10vw]">
                ...
                <img src="{{ asset('assets/images/phonics_l2/itrev/story3.png') }}" class="h-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story5.png') }}" class="w-[7vw]" />
            </div>

            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story4.png') }}" class="h-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> He tried to teach the squid to skip and do a slip. </div>
            <div class="question">But the squid just wanted to sit and knit.</div>
            <div class="question">He tried to teach the squid to dance a jig</div>
            <div class="question">But the squid wore a wig and started to dig with a twig.</div>
        </div>
    ...
    {{-- Panel 16 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/it_rev/st3.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story3.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story4.png') }}" class="w-[7vw]" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story6.png') }}" class="w-[7vw] answer" />
            </div>
        </div>
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">He tried to teach the squid to skip and do a slip.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">But the squid just wanted to sit and knit.</div>
            <div class="question">He tried to teach the squid to dance a jig</div>
            <div class="question">But the squid wore a wig and started to dig with a twig.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> He tried to teach the squid to skip and do a slip.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> But the squid just wanted to sit and knit. </div>
            <div class="question">He tried to teach the squid to dance a jig</div>
            <div class="question">But the squid wore a wig and started to dig with a twig.</div>
        </div>
    </div>
    ...
    {{-- Panel 18 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/it_rev/st4.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story3.png') }}" class="w-[7vw]" />
            ...
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story5.png') }}" class="h-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story4.png') }}" class="w-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question">He tried to teach the squid to skip and do a slip.</div>
            <div class="question">But the squid just wanted to sit and knit.</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">He tried to teach the squid to dance a jig</div>
            <div class="question">But the squid wore a wig and started to dig with a twig.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            <div class="question done"><span class="absolute left-0 pl-5">1</span> He tried to teach the squid to skip and do a slip.</div>
            <div class="question done"><span class="absolute left-0 pl-5">2</span> But the squid just wanted to sit and knit.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> He tried to teach the squid to dance a jig</div>
            <div class="question">But the squid wore a wig and started to dig with a twig.</div>
        </div>
    </div>

    {{-- Panel 20 --}}
    <div class="phonics-panel mb-[2vw]" data-slide-audio="{{ asset('assets/audio/phonics_audio-2/it_rev/st5.m4a') }}">
        <h2 class="title-top">Find the picture that goes with the sentence.</h2>
        <div class="flex items-center h-fit gap-[2vw]">
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story3.png') }}" class="w-[7vw] answer" />
            </div>
            <div class="p-[0.5vw] rounded-xl border-2 border-[#f7b94a] w-[10vw] h-[10vw] box">
                <img src="{{ asset('assets/images/phonics_l2/itrev/story5.png') }}" class="h-[7vw]" />
            </div>
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question">But the squid just wanted to sit and knit.</div>
            <div class="question">He tried to teach the squid to dance a jig</div>
            <div class="question bg-[#f7b94a]! text-[#A15E0D]!">But the squid wore a wig and started to dig with a twig.</div>
        </div>
    </div>
    ...
    <div class="phonics-panel mb-[2vw]"
        ...
        <div class="flex flex-col gap-[0.5vw] justify-center mt-4">
            ...
            <div class="question done"><span class="absolute left-0 pl-5">2</span> But the squid just wanted to sit and knit.</div>
            <div class="question done"><span class="absolute left-0 pl-5">3</span> He tried to teach the squid to dance a jig</div>
            <div class="question done"><span class="absolute left-0 pl-5">4</span> But the squid wore a wig and started to dig with a twig.</div>
        </div>
    </div>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            /* CONFIG */
            const returnURL = "{{ url('/phonics_l2/it_rev/rev') }}";
            const doneURL = "{{ url('/phonics_l2/it_rev/rev') }}";
