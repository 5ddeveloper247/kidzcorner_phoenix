...
@php
    ...
    $panels = [
        [
            'image' => 'phonics_l2/itrev/sit.png',
            'imageSize' => 'h-[16vw]',
            'options' => ['sid', 'sit'],
            'answer' => 'sit',
            'before' => 's', 
        ...
        [
            ...
            'highlight' => 'it',
            'after' => '',
            'audio' => 'it_rev/lit.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/itrev/bit.png',
            'imageSize' => 'h-[20vw]',
            'options' => ['pit', 'bit'],
            'answer' => 'bit',
            'before' => 'b',
            'highlight' => 'it',
            'after' => '',
            'audio' => 'it_rev/bit.m4a',
            'tip' => null,
        ],
        [
            'image' => 'phonics_l2/itrev/split.png',
            'imageSize' => 'w-[20vw]',
            'options' => ['split', 'slit'],
            'answer' => 'split',
            'before' => 'spl',
