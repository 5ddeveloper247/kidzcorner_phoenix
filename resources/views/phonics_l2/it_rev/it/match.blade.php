...
@php
    ...
    $rounds = [
        ...
        [
            'type' => 'grid',
            'cols' => 3,
            'question' => 'Find the picture that end with the /it/ sound.',
            'audio' => 'assets/audio/phonics_audio-2/at_rev/match-at.m4a',
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/itrev/sit.png',
                    'audio' => 'assets/audio/phonics_audio-2/it_rev/sit.m4a',
                    'correct' => true,
                ],
                [
                ...
                [
                    ...
                    'audio' => 'assets/audio/phonics_audio-2/it_rev/bit.m4a',
                    'correct' => false,
                ],
                [
        ...
        [
            ...
            'message' => "That's right! <br> Sit, Hit, Bit and <br> Lit end with the <br> /it/ sound.",
            'cols' => 2,
            'cards' => [
                [
                    'image' => 'assets/images/phonics_l2/itrev/sit.png',
