...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ub_ug/ub') }}">
            <img src="{{ asset('assets/images/phonics_l2/ubug/ub.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ub_ug/ug') }}">
            <img src="{{ asset('assets/images/phonics_l2/ubug/ug.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ub_ug/ubug') }}">
            <img src="{{ asset('assets/images/phonics_l2/ubug/ubug.png') }}" class="mx-auto d-block" />
        </a>
