...
@section('content')
        ...
        <div class="flex justify-center items-center gap-[4vw]">
            ...
            <div class="flex flex-col justify-around h-full">
                <div class="flex items-end h-fit w-fit text-[#f7b94a] text-[2vw]">
                    <span>My ice-cream looks like </span>
            ...
            <img src="{{ asset('assets/images/phonics_l2/lrw1/fs1.png') }}"class="h-[20vw] " />
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] h-full items-center"
        ...
        <div class="flex flex-col-reverse justify-center items-center gap-[2vw]">
            ...
            <img src="{{ asset('assets/images/phonics_l2/lrw1/fs1.png') }}"class="h-[15vw] scale-x-[-1]" />
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] h-full items-center"
        ...
        <div class="flex flex-row-reverse justify-center items-center">
            ...
            <div class="flex flex-col justify-around h-full">
                ...
                <div class="flex items-end h-fit w-fit text-[#f7b94a] text-[2vw]">
                    <span>My ice cream is</span>
                    <div class="w-[19vw] h-[.2vw] bg-[#E6A23C] border-t border-[#C47F1E]"></div>.
                </div>
            </div>

            <img src="{{ asset('assets/images/phonics_l2/lrw1/fs1.png') }}"class="h-[20vw] scale-x-[-1] " />
