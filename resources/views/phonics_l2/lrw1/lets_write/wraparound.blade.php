...
@section('content')
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                class="absolute top-[40%] right-0 -translate-x-1/2 -translate-y-1/2  text-[#A15E0D] text-[1.7vw] text-center">
    ...
    <div class="phonics-panel flex flex-col justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/sh_ch/sh1.m4a') }}">
        <h2 class="text-white text-[1.5vw]">Use the pictures and some of the words to write your own story. <br>
            The beginning and the ending are done for you!</h2>
