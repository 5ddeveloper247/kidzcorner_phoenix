...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center w-full"
        ...
        <div class="flex justify-around items-center w-full">
            ...
            <img src="{{ asset('assets/images/phonics_l2/clsl/t-clown.png') }}" class="h-[20vw]" />
            <h2 class="text-[2.5vw] text-white">climbing</h2>
        </div>
        <div class="flex items-end relative h-fit w-fit text-[#f7b94a] text-[2vw]">
            <span>He juggles clocks while</span>
            <div class="w-[9vw] h-[4px] bg-[#E6A23C] border-t border-[#C47F1E]"></div>
            <span>up a slope.</span>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center w-full"
        ...
        <div class="flex items-end relative h-fit w-fit text-[#f7b94a] text-[2vw]">
            <span class="absolute top-0 right-[28%] text-white text-[1.6vw] ">climbing</span>
            <span>He juggles clocks while</span>
            <div class="w-[9vw] h-[4px] bg-[#E6A23C] border-t border-[#C47F1E]"></div>
            <span>up a slope.</span>
        </div>
   ...
   {{-- ============================= --}}
    <div class="phonics-panel flex flex-col justify-between h-full items-center w-full"
        ...
        <div class="flex justify-around items-center w-full">
            <h2 class="text-[2.5vw] text-white">sliding</h2>
            <img src="{{ asset('assets/images/phonics_l2/clsl/r-clown.png') }}" class="h-[20vw]" />
            <h2 class="text-[2.5vw] text-white">skipping</h2>
        </div>
        <div class="flex items-end relative h-fit w-fit text-[#f7b94a] text-[2vw]">
            <span>He juggles clips while</span>
            <div class="w-[9vw] h-[4px] bg-[#E6A23C] border-t border-[#C47F1E]"></div>
            <span>down a rope.</span>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center w-full"
        ...
        <div class="flex items-end relative h-fit w-fit text-[#f7b94a] text-[2vw]">
            <span class="absolute top-0 right-[35%] text-white text-[1.6vw] ">sliding</span>
            <span>He juggles clips while</span>
            <div class="w-[9vw] h-[4px] bg-[#E6A23C] border-t border-[#C47F1E]"></div>
            <span>down a rope.</span>
        </div>
