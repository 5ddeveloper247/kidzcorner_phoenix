...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw1.png') }}" class="w-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            ...
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">crawls</span>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw2.png') }}" class="w-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            ...
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">cries</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>.
        </h2>
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw2.png') }}" class="w-[20vw]" />
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw3.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            ...
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">stings</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>
            <span>the boy.</span>
        </h2>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw4.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            ...
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">smacks</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw5.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            ...
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">pricks</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>

            <span>his finger.</span>
        </h2>
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw5.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <img src="{{ asset('assets/images/phonics_l2/lrw1/vw6.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-between gap-[2vw] items-center"
        ...
        <h2 class="text-[2vw] text-white flex items-end gap-[0.3vw]">
            ...
            <span class="flex flex-col items-center">
                <span class="text-[#f7b94a]">sweeps</span>
                <span class="w-full h-[.2vw] bg-[#f7b94a] mt-[2px]"></span>
            </span>
