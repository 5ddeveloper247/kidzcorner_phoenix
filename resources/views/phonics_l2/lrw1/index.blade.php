...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-2 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/lrw1/words') }}">
            <img src="{{ asset('assets/images/phonics_l2/global/lr1.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/lrw1/actions') }}">
            <img src="{{ asset('assets/images/phonics_l2/global/lr2.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/lrw1/lets_write') }}">
