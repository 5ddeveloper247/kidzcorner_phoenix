...
@php
    ...
    $returnURL = '/phonics_l2/ee_ea/ee';
    $doneURL = '/phonics_l2/ee_ea/ee';

    $diagraph = 'ee';

    $sideBtns = ['assets/audio/phonics_audio-2/ee_ea/ee.m4a', 'assets/audio/phonics_audio-2/ee_ea/eeah.m4a'];
    ...
    $words = [
        [
            ...
            'imageSize' => 'w-[20vw]',
            'word' => 'bee',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-sh.m4a',
            'tip' =>
                'Tips: Invite children to name the object. <br> Encourage them to sound out the words by parts (e.g. /h/..../am/...ham)',
        ],
        [
            'image' => 'assets/images/phonics_l2/eea/see.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'see',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-ree.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/eea/tree.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'tree',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-read.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/eea/three.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'three',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-irty.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/eea/heel.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'heel',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
        ],
        [
            'image' => 'assets/images/phonics_l2/eea/peel.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'peel',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/eea/seed.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'seed',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/eea/sweep.png',
            'imageSize' => 'h-[20vw]',
            'word' => 'sweep',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/eea/sweet.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'sweet',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/eea/sleep.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'sleep',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/eea/sheep.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'sheep',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
        ...
        [
            'image' => 'assets/images/phonics_l2/eea/teeth.png',
            'imageSize' => 'w-[20vw]',
            'word' => 'teeth',
            'wordAudio' => 'assets/audio/phonics_audio-2/ee_ea/ee-in.m4a',
            'tip' => null,
...
@section('content')
    ...
    <div class="phonics-panel info-panel-1 flex flex-col gap-y-[1vw]">
        ...
        <ul class="list-disc text-start panel-ul space-y-[.2vw]">
            ...
            <li>Digrahs - Two letters that represent one lag sound, as ch for ch in "chin".</li>
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                ...
                In this lesson, we shall <br>
                begin to look at the long <br>
                vowel sounds. </h2>
        </div>
    </div>
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  text-[#A15E0D] text-[1.7vw] text-center w-full">
                In a vowel team, you have <br>
                two vowels but they make <br>
                one sound. </h2>
        </div>
    </div>
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <h2
                    class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  text-[#A15E0D] text-[1.7vw] text-center w-100">
                    When two vowels are <br>
                    placed together. The <br>
                    first vowel usually <br>
                    does the talking.
                </h2>
            </div>

            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="text-[3vw] font-bold flex items-end gap-[0.3vw] text-[#f7b94a]">
                    flee
                </h2>
            </div>
        </div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ee_ea/ee2.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div class="flex flex-col">
            ...
            <div class="flex gap-[2vw] justify-center items-center panel-title">
                <h2 class="stroke">cheek</h2>
                <h2 class="stroke">creep</h2>
                <h2 class="stroke">sweet</h2>
            </div>
        </div>
    </div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ee_ea/ee3.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        <div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ee_ea/ee4.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        ...
        <div>
            ...
            <div class="relative w-fit h-fit">
                ...
                <h2
                    ...
                    You’re right! <br>
                    Cheek, creep & <br> sweet have the vowels <br>
                    '<span class="text-[#70af39]">{{ $diagraph }}</span>' in them.</h2>
            </div>
    ...
    {{-- Intro Panel --}}
    <div class="phonics-panel flex justify-center items-center"
        data-slide-audio="{{ asset('assets/audio/phonics_audio-2/ee_ea/ee5.m4a') }}">
        <img src="{{ asset('assets/images/phonics_l2/global/common/mascot.png') }}" class="h-[20vw]" />
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  text-[#A15E0D] text-[2vw] text-center w-100">
                Do you know <br>
                what sound '<span class="text-[#70af39]">{{ $diagraph }}</span>'<br>
                makes?
            </h2>
        </div>
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  text-[#A15E0D] text-[2vw] text-center w-100">
                '<span class="text-[#70af39]">{{ $diagraph }}</span>' makes the long <br> <span
                    class="opacity-0">------</span>sound.
                Let’s practice saying <br>
                the sound.
            </h2>
        </div>
    ...
    <div class="phonics-panel flex justify-center items-center"
        ...
        <div class="relative w-fit h-fit">
            ...
            <h2
                ...
                that have the <br>
                '<span class="text-[#70af39]">{{ $diagraph }}</span>' sound?
            </h2>
        </div>
    ...
    @foreach ($words as $item)
        ...
        <div class="phonics-panel flex flex-col items-center justify-between">
            ...
            <div class="flex gap-x-[4vw] items-center justify-center">
                <div>
                    <span class="text-white text-[1.5vw]">Long Vowel Family</span>
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const CHEERING = "{{ asset('assets/audio/phonics_audio-2/common/laging.mp3') }}";
            ...
            function getAudioForSlide(slide) {
                ...
                if (newContainer) {
                    // Reveal panel: play the word audio + laging
