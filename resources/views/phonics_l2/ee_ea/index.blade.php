...
@section('content')
    ...
    <div id="slide-board" class="grid grid-cols-3 gap-[2vw] mb-[2vw]  text-center justify-content-center">
        ...
        <a href="{{ url('/phonics_l2/ee_ea/ee') }}">
            <img src="{{ asset('assets/images/phonics_l2/eea/ee.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ee_ea/ea') }}">
            <img src="{{ asset('assets/images/phonics_l2/eea/ea.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/phonics_l2/ee_ea/eea') }}">
            <img src="{{ asset('assets/images/phonics_l2/eea/eea.png') }}" class="mx-auto d-block" />
        </a>
