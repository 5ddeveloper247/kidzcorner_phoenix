...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/k2/mybody/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi1.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/mybody/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi2.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/home/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi3.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/home/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi4.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/plant/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi5.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/plant/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi6.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/family/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi7.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/family/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi8.png') }}" />
        </a>
    ...
    <div id="slide-board" class="first grid grid-cols-4 gap-[2vw] mb-[2vw] hidden">
        ...
        <a href="{{ url('/micet/k2/animals/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi13.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi14.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi15.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi16.png') }}" />
        </a>
    ...
    <div id="slide-board" class="forth grid grid-cols-2 gap-[2vw] mb-[2vw] hidden text-center justify-content-center">
        ...
        <a href="{{ url('/micet/k2/weather/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi17.png') }}" class="mx-auto d-block" />
        </a>

        <a href="{{ url('/micet/k2/weather/index') }}">
            <img src="{{ asset('assets/images/micet/global/k2/mi18.png') }}" class="mx-auto d-block" />
        </a>
