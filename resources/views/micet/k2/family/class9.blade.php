...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 9: Let’s Sing and Dance</h1>
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Learn some simple dance movements</li>
            <li>Use their imagination and work as a team to create a set of dance steps</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[3vw]">
        ...
        <div>
            ...
            <ol class="list-disc panel-ul w-[45vw]">
                ...
                <li>Choreograph the dance, comprising simple dance steps</li>
                <li>You may use the "Family concert" dance movements in the computer activity for reference</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Invite the groups to perform for the class.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to perform some simple dance movements.</li>
                <li>Able to use their imagination and cooperate with others to create a set of dance steps.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[4vw]">
        ...
        <div class="text-start flex flex-col h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Encourage the children to perform the song and dance for their family at home.</li>
            </ul>
        </div>
    </div>
