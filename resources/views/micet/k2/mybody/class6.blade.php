...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <div class="flex ">
        <img src="{{ asset('assets/images/micet/k2/mybody/class6/c1.png') }}" class="h-[8vw]" />
    </div>
    ...
    <ul class="list-disc panel-ul">
        ...
        <li>Identify the various body parts</li>
    </ul>
</div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="6">
        <li>Organise the children in pairs and let them face each other while listening and singing the song. The children can check each other's actions to see if the actions correspond to the contents of the song. The partner can point out if there are any mistakes.</li>
    </ol>
</div>
