...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        ...
        <ol class="list-decimal panel-ul w-[45vw]">
            <li>Tell the "Crime scene" story (starting from the next slide) and let the children infer how the police solved the case.</li>
        </ol>
    </div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="5">
        <li>Then let the children print their left and right thumbprints on a drawing paper or in the Thematic Activity Book using the ink pad.</li>
    </ol>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="6">
        <li>Distribute the magnifying glass and invite children to observe the shape of their thumbprints. For example: Loops: Lines start from one side of the finger pad, make a loop and end on the same side of the finger pad.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="7">
        <li>Distribute the magnifying glass and invite children to observe the shape of their thumbprints. For example: Arches: Lines start from one side of the finger pad, make an arch and end on the opposite side of the finger pad.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="8">
        <li>Distribute the magnifying glass and invite children to observe the shape of their thumbprints. For example: Whorls: Lines start at the side of the finger pad and spiral inward ending at the centre of the finger pad.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="9">
        <li>Distribute the magnifying glass and invite children to observe the shape of their thumbprints. For example: Accidental: This is made up of a combination of the other three patterns.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="12">
        <li>Ask the children to identify scenarios where fingerprints can be useful, e.g. bank accounts, legal documents.</li>
    </ol>
...
<div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
    ...
    <div class="text-start flex flex-col justify-between h-full">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Invite the children to tell the differences between their fingerprints and that of their friends in class.</li>
        </ul>
...
<div class="phonics-panel flex flex-col items-center h-full">
    ...
    <div class="text-start flex flex-col">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Have the children observe their fingerprints to see if the prints are different from their thumbprints. Get them to compare their left and right fingerprints.</li>
