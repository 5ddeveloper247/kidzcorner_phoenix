...
<div class="phonics-panel flex flex-col items-center h-full">
    ...
    <div class="text-start">
        ...
        <ol class="list-decimal panel-ul w-[45vw]">
            ...
            <li>Invite a child to stand in front of the class to name and point out the important parts of his/her body in sequence from head to toe.</li>
        </ol>
    </div>
</div>
...
<div class="phonics-panel flex flex-col items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>Let the children draw different parts of the body on a drawing paper or in the Thematic Activity Book.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="23">
        <li>Let children stick the different origami body parts together to create an origami man. Encourage the children to use their imagination to come up with a special posture for the origami man, e.g. kicking a ball, dancing.</li>
...
<div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
    ...
    <div class="text-start flex flex-col justify-between h-full">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Invite the children to display their origami man and name the various body parts of their origami man.</li>
        </ul>
