...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/k1/playtime/class1') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class1.png') }}" />
        </a>

        <a href="{{ url('/micet/k1/playtime/class2') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class2.png') }}" />
        </a>

        <a href="{{ url('/micet/k1/playtime/class3') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class3.png') }}" />
        </a>

        <a href="{{ url('/micet/k1/playtime/class4') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class4.png') }}" />
        </a>

        <a href="{{ url('/micet/k1/playtime/class5') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class5.png') }}" />
        </a>

        <a href="{{ url('/micet/k1/playtime/class6') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class6.png') }}" />
        </a>

        <a href="{{ url('/micet/k1/playtime/class7') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class7.png') }}" />
        </a>

        <a href="{{ url('/micet/k1/playtime/class8') }}">
            <img src="{{ asset('assets/images/micet/k1/playtime/class8.png') }}" />
        </a>
