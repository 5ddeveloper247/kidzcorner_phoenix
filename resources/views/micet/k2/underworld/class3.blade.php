...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <div class="text-start">
        ...
        <ol class="list-decimal panel-ul w-[45vw]">
            <li>Click to play the video. Let the children recall the characteristics of a bony fish (it has bones, scales, breathes through gills, swims with the help of fins, etc).</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="6">
        <li>Click to play the video. Guide children to understand that: <ul class="list-disc">
                <li>
                    A shark looks sleek and smooth, but its skin is actually covered with scales that are different from bony fishes.
                </li>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="9">
        <li>Click to play the video. Let the children observe how a shark breathes in the water. (It breathes through gill slits.)
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="10">
            <li>Conclude with children: Sharks have scales that are very different from bony fishes and sharks do not breathe through gills. Hence sharks are not bony fishes.</li>
        </ol>
    </div>
    <img src="{{ asset('assets/images/micet/k2/underworld/class3/c4.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="12">
        <li>Guide children to understand that: <ul class="list-disc">
                ...
                <li>Cartilage is different from bones. Bone is hard and not flexible whereas cartilage is soft and flexible like a rubber tube.</li>
            </ul>
        </li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="13">
            <li>Conclude with the children: Fishes with a skeleton made of cartilage are called cartilaginous fishes. Hence, a shark is a cartilaginous fish.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="14">
            <li>Inform children that cartilaginous fishes and bony fishes have one thing in common and that is they have fins.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="15">
            <li>A shark swims in the same way as a bony fish, moving its tail fin from side to side to move through water.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="16">
        <li>Click to play the video. Let the children observe how a shark swims in the water. (moves its tail fin from side to side to move forward)
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="17">
            <li>Ask children: What is this? Guide children to understand that some sharks lay eggs and their babies hatch from the eggs.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="18">
        <li>Click to play the video. Let the children observe a newly laid shark egg (the developing baby shark is protected by the egg case).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="19">
        <li>Click to play the video. Let the children observe a 5 to 6 weeks old shark egg (the baby shark is moving inside the egg case).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="20">
        <li>Click to play the video. Let the children observe a shark egg after 9 weeks (the baby shark is now grey in colour, like an adult shark).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="25">
            <li>Guide children to understand that a whale does not have scales. It has a thick layer of fat under its skin to protect it from the cold water.</li>
        </ol>
    </div>
    <img src="{{ asset('assets/images/micet/k2/underworld/class3/c13.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="29">
            <li>Guide the children to know that a whale has no gill slits and it uses its lungs to breathe just like us.</li>
        </ol>
    </div>
    <img src="{{ asset('assets/images/micet/k2/underworld/class3/c13.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="31">
            <li>Guide children to understand that whales like us cannot breathe underwater. Whales can hold their breath for hours underwater but when they need to breathe, they come up to the surface of the water and breathe using their lungs, through their blowholes.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="32">
            <li>Ask children: Why is a blowhole on a whale's head? (convenient for the whale to rise to the surface of water to breathe)</li>
        </ol>
    </div>
    <img src="{{ asset('assets/images/micet/k2/underworld/class3/c18.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="33">
        <li>Click to play the video. Let the children observe how a whale breathes (Whales rise to the surface of the water. They open their blowholes and breathe air using their lungs, through blow holes).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="37">
            <li>Explain to the children that whales, like us, give birth to their young ones alive, instead of laying eggs.</li>
        </ol>
    </div>
    <img src="{{ asset('assets/images/micet/k2/underworld/class3/c14.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="39">
            <li>Help children understand that humans are grouped as mammals, and whales are grouped as marine mammals.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="40">
            <li>Ask children: How does the tail fin of whales differs from that of the bony fish and the cartilaginous fish?</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="40">
            <li>Explain to the children: A whale has a horizontal tail fin that moves up and down to help the whale move through water, while the bony and cartilaginous fishes have vertical tail fins that move side to side to help them move through water.</li>
        </ol>
    </div>
    <img src="{{ asset('assets/images/micet/k2/underworld/class3/c16.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="41">
            <li>Ask children: Do you think that the pectoral and tail fins of a whale are similar to the hands and feet of humans? Inform the children that the bones of the whales' pectoral and tail fins are like the bones of human hands and feet, but much bigger.</li>
        </ol>
    </div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="42">
        <li>Click to play the video. Let the children observe how the whale breathes (it rises to the surface of water to breath through its blowhole) and swims (its tail fin moves up and down).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
        <source src="{{ asset('assets/images/micet/k2/underworld/class3/v8.mp4') }}" type="video/mp4">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="44">
        <li>Have the children examine the similarities and differences among the three types of sea creatures: <ul class="list-disc">
                <li>
                    Do they have fins?
                </li>
            </ul>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="46">
        <li>Have the children examine the similarities and differences among the three types of sea creatures: <ul class="list-disc">
                <li>
                    Do they breathe through gills? (Bony fish breathe through gills, cartilaginous fish breathe through gill slits and marine mammals breathe using lungs, through blowhole.)
                </li>
            </ul>
        </li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="47">
        <li>Have the children examine the similarities and differences among the three types of sea creatures: <ul class="list-disc">
                <li>
                    How different are their tail fins? (Bony and cartilaginous fishes have vertical tail fins while marine mammals have horizontal tail fins.)
                </li>
            </ul>
        </li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="48">
        <li>Have the children examine the similarities and differences among the three types of sea creatures: <ul class="list-disc">
                <li>
                    How do they swim? (Bony and cartilaginous fishes swim by moving their tail fins sideways while marine mammals swims by moving their tail fins up and down.)
                </li>
            </ul>
        </li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="49">
        <li>Have the children examine the similarities and differences among the three types of sea creatures: <ul class="list-disc">
                <li>
                    How are the young born? (Bony and cartilaginous fishes lay eggs and their babies hatch from the eggs whereas marine mammals give birth to their young alive and produce milk to feed them.)
                </li>
            </ul>
        </li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="52">
        <li>Click to play the video. Let the children observe how a dolphin swims in water (it moves its horizontal tail fin up and down to move through water).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="53">
        <li>Click to play the video. Let the children observe how a dolphin breathes (A dolphin cannot breathe under water, it needs to rise to the surface of water to breathe air using its lungs, through a blowhole on its head).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="53">
        <li>Click to play the video. Let the children observe how the dolphins breathe ( A Dolphin cannot breathe under water, it needs to rise to the surface of water to breathe air using its lungs, through a blowhole on its head).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="54">
        <li>Guide children to conclude: A dolphin is a marine mammal as it breathes air using its lungs, through a blowhole and swims by moving its tail fins up and down to move though water.
        </li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="56">
        <li>Click to play the video. Let the children observe how the stingray breathes (A stingray breathes through its gill slits).
        </li>
    </ol>
    <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="61">
        <li>What animal is this? Is it a bony fish or a cartilaginous fish or a marine mammal? Why? (Remind children of Chatter, the catfish in the story.)
        </li>
    </ol>
