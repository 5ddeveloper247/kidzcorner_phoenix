...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/k2/underworld/class1') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class1.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class2') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class2.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class3') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class3.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class4') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class4.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class5') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class5.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class6') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class6.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class7') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class7.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class8') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class8.png') }}" />
        </a>
...
<div id="slide-board" class="flex justify-center items-center flex-col mb-[2vw] hidden">
    ...
    <div class="grid grid-cols-2 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/k2/underworld/class9') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class9.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/class10') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/class10.png') }}" />
        </a>
    </div>

    <div class="col-span-2 grid grid-cols-3 gap-[2vw]">

        <a href="{{ url('/micet/k2/underworld/cards') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/words.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/activity') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/activity.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/underworld/tables') }}">
            <img src="{{ asset('assets/images/micet/k2/underworld/tables.png') }}" />
        </a>
