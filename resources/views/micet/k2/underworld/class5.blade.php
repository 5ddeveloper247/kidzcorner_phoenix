...
<div class="phonics-panel flex flex-col justify-between  w-[45vw] items-center">
    ...
    <ul class="list-disc panel-ul">
        ...
        <li>Understand that molluscs can be divided into molluscs with shells (one or two shells) and molluscs without shells</li>
    </ul>
</div>
...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="3">
        <li>Click to play the video. Ask children: What animal is this? Does it have a soft body or a hard body? Does it have bones inside its body?</li>
    </ol>
...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="7">
        <li>Ask children: What is the main difference between molluscs and bony fishes, cartilaginous fishes, marine mammals and crustaceans? ( Molluscs do not have bones inside them.)
        </li>
    </ol>
