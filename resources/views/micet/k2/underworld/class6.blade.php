...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li>Ask children: What are animals? What are plants? What are the differences between animals and plants?
                    Guide children to list examples of animals and plants, then compare them (animals can move around by
                    themselves to look for food; plants cannot move but can make their own food).</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>Click to play the video. Let the children observe a jellyfish to determine if it is an animal or a plant and
                then let them justify their answer. Guide children to find the correct answer through their own
                observations. ( A jellyfish is an animal as it can move around by itself.)/li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="5">
            <li>Guide children to understand that a jellyfish uses its tentacles with stinging cells to hunt for food. The
                method used is to first inject a toxin from the stinging cells of its tentacles into its prey to paralyse
                the prey and make it unable to move, then put the prey into its mouth (at the centre of its body) to eat it.
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="6">
            <li>Click to play the video. Let the children observe this jellyfish and its tentacles. This type of jellyfish
                also uses its tentacles with stinging cells to hunt for food; however, this type of jellyfish does not move
                much.</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="8">
            <li>Explain to the children that sea anemones may look like plants but they are actually animals. They attach
                themselves to rocks and do not move around . They use their tentacles with stinging cells to hunt for food.
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="10">
            <li>Guide children to understand that a sea anemone looks like an inverted jelly fish. It uses its tentacles
                with stinging cells to inject a toxin into its prey. This paralyses the prey and makes it unable to move.
                The sea anemone then put its prey into its mouth to eat it.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="13">
            <li>Click to play the video. Explain to the children: Each coral polyp is actually atiny animal that has
                tentacles, stinging cells, a mouth and a stomach. The body of a coral polyp looks like a tube. The mouth is
                at the top of this tube and is surrounded by tentacles. Coral polyps use their tentacles with their stinging
                cells to catch food.</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="15">
            <li>Guide children to understand that: Different corals have different polyps and polyps come in many different
                colours and shapes. Hence we see different types of corals.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="16">
            <li>Guide children to understand that: Many kinds of corals live in oceans all around the world. Some corals are
                soft and can sway in the current. Some corals are hard.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="17">
            <li>Conclude with the children: Jellyfish, sea anemone and coral may look like plants but they are animals. They
                are sea creatures that sting. They have a mouth surrounded by tentacles. The tentacles have stinging cells.
                These sea creatures use their tentacles with the stinging cells to hunt for food.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="18">
            <li>Invite children to make a jellyfish. Distribute the materials. Encourage children to use their creativity to
                make their jelly fish. Guide children to follow the general steps:
                <ul class="list-disc">
                    <li>Colour the body of jelly fish with colours of their choice.</li>
                    <li>Cut long strips of coloured paper and paste along the edge of their plate to form the tentacles of
                        the jellyfish.</li>
                    <li>Draw eyes and mouth of the jellyfish.</li>
                </ul>
            </li>
            <li>Use a stapler to attach a fine thread to the middle of each plate. Display the jellyfish by hanging them up
                in the classroom.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul">
                <li>Let the children name some sea creatures that sting and state their common characteristics and describe
                    how they hunt for food.</li>
            </ul>
