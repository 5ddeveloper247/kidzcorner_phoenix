...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>Encourage the children to recall from the story what the apple tree ate to grow. Guide the children to
                    conclude the uses of roots - They absorb water and nutrients from the soil.</li>
            </ol>
        </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>Have the children discuss how water and nutrients, after being absorbed by the roots, are transported to the
                entire tree.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex items-center gap-2">
            ...
            <svg class="w-8 h-8 text-white stroke-current" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
                stroke="currentColor">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="9">
            <li>Explain that there are many tiny straws inside the celery stem. Water gets absorbed and travels up these
                straws. Ask the children to point to the straws.</li>
        </ol>
        <div class="flex items-center gap-2">
            <img src="{{ asset('assets/images/micet/k2/plant/class4/c4.png') }}" class="h-[17vw]" />
            <svg class="w-8 h-8 text-white stroke-current" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="10">
            <li>Guide the children to understand that all plants have many tiny straws inside their stems to absorb and
                transport water to all parts of the plant.</li>
        </ol>
        <div class="flex items-center gap-2">
            <img src="{{ asset('assets/images/micet/k2/plant/class4/c4.png') }}" class="h-[17vw]" />
            <svg class="w-8 h-8 text-white stroke-current" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="14">
            <li>Tell the children that we are going to do another experiment. Click on the video to show white carnations
                being placed in blue and red coloured water.</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="15">
            <li>Ask the children to look at the photo and guess what will happen to the white carnations after some time.
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                ...
                <li>Able to say that many small tubes in stems are responsible for transporting water and nutrients to the
                    entire plant.</li>
