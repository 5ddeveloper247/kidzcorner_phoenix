...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Help the children understand that the bee is sucking nectar from the flower and at the same time, pollen
                will become stuck to its body and the fine hairs on its legs. In this way, the bee will transport the pollen
                to another flower when it flies to the other flower to gather nectar.</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="8">
            <li>Click on the video. Let the children observe how the bee is sucking nectar from the flower and at the same
                time, pollen will become stuck to its body and the fine hairs on its legs. In this way, the bee will
                transport the pollen to another flower when it flies to the other flower to gather nectar.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="9">
            <li>Ask the children what else, other than bees, can transport pollen. Guide the children to understand that
                butterflies can transport pollen just like bees.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="11">
            <li>Click on the video. Ask the children what the butterflies are doing (sucking nectar and transporting
                pollen).</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="12">
            <li>Encourage the children to think about why bees and butterflies like flowers. Help the children understand
                that flowers use their colours and fragrance to attract bees and butterflies. In this way, the flowers can
                receive pollen from other flowers to complete the pollination process and bear fruits.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="13">
            <li>Click on the video. Ask the children to observe how to use a cotton-swab to simulate the bees' hairy legs to
                pick up pollen.</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="15">
            <li>(Optional activity) Distribute fresh flowers and cotton-swabs. Have the children observe the different types
                of flowers and pollen. Ask the children to imitate the bees by using the cotton-swabs to gather pollen from
                flowers.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Invite the children to display the pollens they have gathered and describe the differences among pollen
                    of these flowers.</li>
            </ul>
