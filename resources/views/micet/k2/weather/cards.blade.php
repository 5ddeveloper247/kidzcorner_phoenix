...
@section('content')
    ...
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c1.png') }}" class="h-[25vw]" />
    </div>
    ...
    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c2.png') }}" class="h-[25vw]" />
    </div>
    ...
    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c3.png') }}" class="h-[25vw]" />
    </div>
    ...
    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c4.png') }}" class="h-[25vw]" />
    </div>
    ...
    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c5.png') }}" class="h-[25vw]" />
    </div>
    ...
    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c6.png') }}" class="h-[25vw]" />
    </div>


    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <h1 class="cardtitle">rainfall</h1>
    </div>


    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c7.png') }}" class="h-[25vw]" />
    </div>
    ...
    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c8.png') }}" class="h-[25vw]" />
    </div>


    {{-- panel 3 --}}
    <div class="phonics-panel flex justify-center h-full items-center">
        <h1 class="cardtitle">wind direction</h1>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k2/weather/cards/c9.png') }}" class="w-[30vw]" />
    </div>
