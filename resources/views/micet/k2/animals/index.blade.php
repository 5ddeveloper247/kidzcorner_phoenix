...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/k2/animals/class1') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class1.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/class2') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class2.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/class3') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class3.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/class4') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class4.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/class5') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class5.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/class6') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class6.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/class7') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class7.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/animals/class8') }}">
            <img src="{{ asset('assets/images/micet/k2/animals/class8.png') }}" />
        </a>
    ...
    <div id="slide-board" class="flex justify-center items-center flex-col mb-[2vw] hidden">
        ...
        <div class="grid grid-cols-2 gap-[2vw] mb-[2vw]">
            ...
            <a href="{{ url('/micet/k2/animals/class9') }}">
                <img src="{{ asset('assets/images/micet/k2/animals/class9.png') }}" />
            </a>

            <a href="{{ url('/micet/k2/animals/class10') }}">
                <img src="{{ asset('assets/images/micet/k2/animals/class10.png') }}" />
            </a>
        </div>
        
        <div class="col-span-2 grid grid-cols-3 gap-[2vw]">

            <a href="{{ url('/micet/k2/animals/cards') }}">
                <img src="{{ asset('assets/images/micet/k2/animals/cards.png') }}" />
            </a>

            <a href="{{ url('/micet/k2/animals/activity') }}">
                <img src="{{ asset('assets/images/micet/k2/animals/activity.png') }}" />
            </a>

            <a href="{{ url('/micet/k2/animals/tables') }}">
                <img src="{{ asset('assets/images/micet/k2/animals/tables.png') }}" />
            </a>
