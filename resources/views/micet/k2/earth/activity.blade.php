...
<div class="phonics-panel flex flex-col justify-start h-full items-center">
    ...
    <div class="text-start">
        ...
        <ol class="list-decimal panel-ul w-[45vw]">
            ...
            <li>
                Elicit answers from children; continue with the following questions to focus children's attention on the key points of the courseware.
                <ol class="list-[lower-alpha] pl-[2vw]">
    ...
    <div class="text-start space-y-[2vw]">
        ...
        <div class="flex justify-center items-center gap-[3vw]">
            ...
            <div>
                ...
                <ul class="panel-ul w-[25vw]">
                    <li>Use the directional keys on the keyboard to control the spaceship to get to the planets in the solar system.</li>
                    <li>First choose a level of the activity: Level one: Children travel to planets that are nearer to the Earth. Level two: Children travel to planets that are further away from the Earth.</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="flex justify-center items-center gap-[3vw]">
            ...
            <div>
                ...
                <ul class="panel-ul w-[25vw]">
                    ...
                    <li>Choose the animal's head, body, ears, limbs, tail and colour from the left and assemble them on the canvas.</li>
        ...
        <div class="flex justify-center items-center gap-[3vw]">
            ...
            <div>
                ...
                <ul class="panel-ul w-[25vw]">
                    ...
                    <li>Group one - select four items that belong to the lake (fish, duck, river crab and lotus flower).</li>
                    <li>Group two - select four items that belong to the sea (sea gull, starfish, crab and coconut tree).</li>
                    <li>Group three - select four items that belong to the forest (snake, bear, woodpecker and mushroom).</li>
                </ul>
            </div>
        </div>
    </div>
