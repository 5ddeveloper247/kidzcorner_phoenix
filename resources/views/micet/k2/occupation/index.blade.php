...
<div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
    ...
    <a href="{{ url('/micet/k2/occupation/class1') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class1.png') }}" />
    </a>

    <a href="{{ url('/micet/k2/occupation/class2') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class2.png') }}" />
    </a>

    <a href="{{ url('/micet/k2/occupation/class3') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class3.png') }}" />
    </a>

    <a href="{{ url('/micet/k2/occupation/class4') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class4.png') }}" />
    </a>

    <a href="{{ url('/micet/k2/occupation/class5') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class5.png') }}" />
    </a>

    <a href="{{ url('/micet/k2/occupation/class6') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class6.png') }}" />
    </a>

    <a href="{{ url('/micet/k2/occupation/class7') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class7.png') }}" />
    </a>

    <a href="{{ url('/micet/k2/occupation/class8') }}">
        <img src="{{ asset('assets/images/micet/k2/occupation/class8.png') }}" />
    </a>
...
<div id="slide-board" class="flex justify-center items-center flex-col mb-[2vw] hidden">
    ...
    <div class="grid grid-cols-2 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/k2/occupation/class9') }}">
            <img src="{{ asset('assets/images/micet/k2/occupation/class9.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/occupation/class10') }}">
            <img src="{{ asset('assets/images/micet/k2/occupation/class10.png') }}" />
        </a>
    </div>

    <div class="col-span-2 grid grid-cols-3 gap-[2vw]">

        <a href="{{ url('/micet/k2/occupation/cards') }}">
            <img src="{{ asset('assets/images/micet/k2/occupation/words.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/occupation/activity') }}">
            <img src="{{ asset('assets/images/micet/k2/occupation/activity.png') }}" />
        </a>

        <a href="{{ url('/micet/k2/occupation/tables') }}">
            <img src="{{ asset('assets/images/micet/k2/occupation/tables.png') }}" />
        </a>
