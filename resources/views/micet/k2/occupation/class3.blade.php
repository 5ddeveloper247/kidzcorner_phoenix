    ...
    <ul class="list-disc panel-ul w-[45vw]">
        ...
        <li>Hospital props box (recommended materials):
            <ul>
                ...
                <li>-pictures of body parts, stretcher, patient's clothes, electrocardiogram, surgical knives (toy knives), medical records, x-ray picture, blank papers and pens. (Ideally use real tools if available. Otherwise, substitute with toys or other items).</li>
            </ul>
        </li>
        ...
        <li>Invite people working in a hospital (including parents) to the kindergarten to explain their job duties to the children. It is ideal to get them to wear their uniforms and carry their tools.</li>
    </ul>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="2">
        <li>If any child has recently been to a hospital, get them to describe their experiences of seeing a doctor. Encourage the children to say why they went to the hospital, who they saw, what happened, and how they feel now. Help the children to minimise their fears of hospitals. Help them understand that they have to inform their parents if they are sick and to see a doctor immediately. Doctors can help them recover from their illness.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="5">
        ...
        <li>Explain to them that the doctor can diagnose by using a special machine and ask the children to identify the machine.</li>
    </ol>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="12">
        <li>Explain to the children what the doctor will do to help mend the broken bone. In severe cases, a screw may be used.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="16">
        ...
        <li>Explain that by using a special machine, the doctor can see and diagnose the condition of the baby in the womb. Ask the children if they can name the machine.</li>
    </ol>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="19">
        <li>Explain that an ultrasound machine can help the doctor see the baby inside the womb. This helps the doctor to make a diagnosis.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="21">
        ...
        <li>Explain that by using a special tool, the doctor can hear and diagnose the condition of the heart. Ask children if they can name the tool.</li>
    </ol>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="27">
        <li>Ask the children why an operation needs to be carried out in a sterile environment of an operating theatre.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="29">
        <li>Explain that a surgeon needs to sterilise himself, use items such as a surgical mask and gloves, etc. to prevent infection.</li>
    </ol>
    <img src="{{ asset('assets/images/micet/k2/occupation/class3/c14.png') }}" class="w-[25vw] h-[17vw]" />
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="39">
        <li>Explain that the medical examination usually entails the use of a thermometer to measure the body temperature.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="52">
        <li>When children understand that there are many reasons why people go to the hospital, get them to identify and name the occupations of the people in the picture and describe what they do. For example, the doctors see patients; nurses attend to patients; pharmacists dispense medicines; surgeons perform surgeries, etc.</li>
    </ol>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="53">
        <li>Display the hospital prop box in an orderly way, show the tools such as a stethoscope, syringes, medicine bottles, surgical knives, etc. Help the children to identify these tools. Encourage children to explain who use these tools, their functions and also to demonstrate how they are used.</li>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="55">
        <li>For those occupations which children are not familiar with (e.g. surgeons), get children with some knowledge of them to role play. Teacher facilitates the role play by being one of the hospital staff. She will help the children with the use of language and actions in their role play, so that other children will have a better idea of what these occupations do.</li>
    </ol>
</div>
...
<div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
    ...
    <div class="text-start flex flex-col justify-between h-full">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            ...
            <li>Display children's art on the wall. Show children different ways to appreciate the work of others. Help children to establish good healthy habits and help them minimise their fear of hospitals.</li>
        </ul>
...
<div class="phonics-panel flex flex-col items-center h-full">
    ...
    <div class="text-start flex flex-col">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Help the children to create some tools used in a hospital like stethoscopes, syringes, nurses' cap, drips and display them at the designated "Our hospital" activity area.</li>
