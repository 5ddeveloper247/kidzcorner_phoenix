...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>To understand different occupations in a space-port and the nature of various jobs including the exploration
                of outer space.</li>
    ...
    <div class="phonics-panel flex flex-col h-full items-center space-y-[5vw]">
        ...
        <div>
            ...
            <ul class="list-disc panel-ul">
                ...
                <li>Distribute letters to parents, requesting for materials related to the theme of "Out in space" such as
                    books or photographs.
                    "Out in Space" props box (refer to Activity 8).</li>
                <li>Invite people working in aerospace (including parents) to the kindergarten to explain briefly their job
                    duties to the children. It is ideal to get them to wear their uniforms and carry their tools or
                    instruments if any.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Help the children understand that astronauts require stringent trainings before they go into space, such as:
                <ul class="list-disc">
                    <li>
                        Since there is zero gravity in space, astronauts float in space. Thus, astronauts learn to float in
                        water first which simulates floating in space.
                    </li>
                </ul>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Help the children understand that astronauts require stringent trainings before they go into space, such as:
                <ul class="list-disc">
                    <li>
                        Space food are usually compressed in tubes like toothpastes. Astronauts squeeze the food into their
                        mouths so the food will not "fly" away in zero gravity.
                    </li>
                </ul>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>Discuss the process of how a spaceship is launched into space, such as:
                ...
                <ul class="list-disc">
                    <li>Before launch, mission control will start a "countdown" to check that the rocket, spaceship and all
                        instruments are working properly before lift-off.</li>
                </ul>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>Discuss the process of how a spaceship is launched into space, such as:
                A spaceship is mounted on top of a rocket.
                <ul class="list-disc">
                    <li>A rocket consists of stages, when the fuel in each stage is used up, the stage is separated and
                        falls away. The next stage of the rocket is then ignited and pushes the spaceship further into
                        space.</li>
                </ul>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>As there is no air in space, an astronaut wears an air tight space suit with a space helmet, an oxygen-tank,
                gloves etc. when they spacewalk.
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Help the children understand that a team of space scientists, aerospace engineers, mission control staff,
                work together to have a successful space mission. Describe their job duties:
                <ul class="list-disc">
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Help the children understand that a team of space scientists, aerospace engineers, mission control staff,
                work together to have a successful space mission. Describe their job duties:
                <ul class="list-disc">
                    <li>The staff at mission control communicate with the astronauts in the spaceship, provide guidance on
                        navigation, exchange information and updates, and ensure the astronauts do not feel alone.</li>
                </ul>
            </li>
        </ol>
        <img src="{{ asset('assets/images/micet/k2/occupation/class4/c14.png') }}" class="w-[30vw] h-[17vw]" />
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Help the children understand that a team of space scientists, aerospace engineers, mission control staff,
                work together to have a successful space mission. Describe their job duties:
                <ul class="list-disc">
                    <li>The staff of mission control have different roles ranging from checking of equipment, monitoring of
                        the astronauts' health, and communicating with the astronauts so on.</li>
                </ul>
            </li>
        </ol>
        <img src="{{ asset('assets/images/micet/k2/occupation/class4/c14.png') }}" class="w-[30vw] h-[17vw]" />
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Help the children understand that a team of space scientists, aerospace engineers, mission control staff,
                work together to have a successful space mission. Describe their job duties:
                <ul class="list-disc">
                    <li>The staff of mission control also use computers to calculate the position of the spaceship, its
                        altitude, direction, speed and expected time and location of landing.</li>
                </ul>
            </li>
        </ol>
        <img src="{{ asset('assets/images/micet/k2/occupation/class4/c14.png') }}" class="w-[30vw] h-[17vw]" />
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="8">
            ...
            <li>Help them understand that there are different types of spaceships for different missions. We will now learn
                about some of them.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="10">
            <li>Teacher asks: "What is this?"; "What's the difference between this and the spaceship we talked about
                earlier?"; "What does this look like?".</li>
            <li>Help the children understand that this is a space shuttle. It looks like an aeroplane. It launches like a
                rocket but lands like an aeroplane.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="16">
            ...
            <li>Click on the video to help children understand that the earth is rotating all the time in space and each
                round is one day.</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="18">
            ...
            <li>Explain that we have just arrived at the space station which enables astronauts to stay in space for many
                months.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="21">
            ...
            <li>Help children understand that there is no air in space. The space suit allows the astronaut to breathe and
                to move about in space.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="23">
            ...
            <li>Click on the video for the children to observe and experience how the space shuttle glides back to earth
                like a plane.</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="27">
            ...
            <li>Explain that this is a lunar module, a spaceship which carries astronauts to the moon. Direct children's
                attention to its spider-like appearance.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="29">
            ...
            <li>Click on the video to help children understand that the moon is rotating all the time in space and each
                round made is one month.</li>
        </ol>
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="33">
            <li>Click on the video for the children to observe what the surface of the moon is like when the lunar module
                lands on the moon.</li>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="35">
            ...
            <li>Help the children understand that the astronaut is getting out of the lunar module, climbing down the ladder
                onto the moon's surface.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Children to role-play how the personnel at mission control communicate with the astronauts during count
                    down to rocket launch.</li>
            </ul>
    ...
    <div class="phonics-panel flex flex-col items-center h-full">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Children to discuss what astronauts do in space. They will pretend to be astronauts performing space
                    walk, eating space food, etc.</li>
            </ul>
        </div>
    </div>
