...
<div class="phonics-panel flex flex-col justify-start h-full items-center">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[50vw]" start="20">
            <li>Guide the children to discuss about how people live on boat houses. Encourage them to draw the boat dwellers' life or other decorative designs on the origami boat houses.</li>
        </ol>
    </div>
</div>
