...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>Encourage the children to identify the materials used to build the teepees (many wooden poles and a piece of
                cloth).</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="4">
            <li>Ask the children to identify the shape of the teepee. Introduce the term 'cone shape' to the children.
                Encourage them to give examples of objects that are cone shaped (ice cream cone, party hat etc.).</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="13">
            <li>Organise the children into groups and distribute the materials. Let the children use the wooden sticks and
                sheets of tissue paper to build their teepees.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="14">
            <li>Guide the children in observing the colour and design of the Red Indians' teepees and encourage them to use
                crayons to design their tent.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="15">
            <li>Encourage the children to compare the differences between the Red Indians' tents and the tents we see
                nowadays. For example, the tents used nowadays are built using four flexible metal rods instead of many
                wooden poles.</li>
        </ol>
