...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/n2/school/class1') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class1.png') }}" />
        </a>

        <a href="{{ url('/micet/n2/school/class2') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class2.png') }}" />
        </a>

        <a href="{{ url('/micet/n2/school/class3') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class3.png') }}" />
        </a>

        <a href="{{ url('/micet/n2/school/class4') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class4.png') }}" />
        </a>

        <a href="{{ url('/micet/n2/school/class5') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class5.png') }}" />
        </a>

        <a href="{{ url('/micet/n2/school/class6') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class6.png') }}" />
        </a>

        <a href="{{ url('/micet/n2/school/class7') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class7.png') }}" />
        </a>

        <a href="{{ url('/micet/n2/school/class8') }}">
            <img src="{{ asset('assets/images/micet/n2/school/class8.png') }}" />
        </a>
    ...
    <div id="slide-board" class="first grid grid-cols-2 gap-[2vw] mb-[2vw] hidden">
        ...
        <a href="{{ url('/micet/n2/school/class10') }}">
