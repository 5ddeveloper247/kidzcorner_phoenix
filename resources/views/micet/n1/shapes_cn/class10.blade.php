...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-around h-full items-center">
        <h1 class="panel-title stroke">课堂活动 10：形状伙伴</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div class="space-y-[2vw]">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>主题活动书</li>
                <li>形状卡片——每个孩子一张（四种已学形状，每种形状必须成对）。</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>展示形状卡片，告诉孩子们他们将用这些卡片玩游戏。</li>
            <li>示范如何玩"找伙伴"游戏：
                <ul>
                    <li>i. 将所有卡片放入袋中并打乱。</li>
                    <li>ii. 让孩子们轮流抽取一张卡片。</li>
                    <li>iii. 当每个人都拿到卡片后，让他们根据卡片上的形状找到伙伴。</li>
                    <li>iv. 对于每种形状（圆形、正方形、长方形、三角形），孩子们必须找到彼此，手拉手并将卡片交还给老师。最快完成的一对获胜。</li>
                    <li>v. 重复游戏。</li>
                </ul>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>让孩子们在主题活动书中将相同形状的贴纸贴到正确的方框中。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>让孩子们分享玩这个游戏的体验和看法（如何最快找到伙伴）。</li>
            </ul>
