...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 5：丢沙包</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>展示沙包，问孩子们："这些是什么？""你们玩过吗？""你们怎么玩？"</li>
                <li>请一个孩子帮忙示范如何玩"丢沙包"游戏。</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul" start="3">
            <li>邀请孩子们两人一组，学习如何玩这个游戏：
                <ul class="list-disc">
                    <li>让玩家们盘腿而坐，相距三步面对面。让他们轮流把沙包丢到对方脚前，看谁最准确。</li>
                    <li>几轮之后，让每个玩家后退一步，继续玩游戏。</li>
                    <li>问孩子们："把沙包丢给离自己近的朋友容易，还是离得远的朋友容易？当两人坐得较远时，丢沙包需要更少还是更多的力气？"</li>
                    <li>让孩子们练习准确地把沙包丢到同伴腿前。</li>
                </ul>
            </li>
        </ol>
    </div>
