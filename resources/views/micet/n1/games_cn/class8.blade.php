...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 8：障碍赛</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ul class="list-disc panel-ul">
            <li>小旗子、2个大纸箱、2条绳子、沙包、篮子、
                一些障碍物（例如玩具、桌子、椅子）</li>
            <li>课前，设置2条障碍赛道（室内或室外）：在
                赛道起点和终点各放一面小旗子；把纸箱两侧
                打开，像隧道一样放在起点几步之外；把绳子
                像蛇一样放在纸箱约5步之外；把沙包放在绳子
                约2步之外；把篮子放在沙包约10步之外；在赛道
                末端放置一些障碍物 <br>
                [注意：如需要，可在每个挑战的赛道起点放置
                标记；可根据幼儿能力改变赛道设置]</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li>告诉孩子们，今天我们要玩"障碍赛"游戏。</li>
                <li>让孩子们观察赛道，并谈论用来设置赛道的物品。</li>
            </ol>
        </div>
    </div>
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>示范如何玩游戏：
                <ul class="list-disc">
                    ...
                    <li>接下来，把沙包放在头上，走向篮子，
                        然后低头让沙包掉进篮子里。</li>
                    <li>最后，穿过障碍物到达赛道终点。</li>
                </ul>
            </li>
            <li>让孩子们分成两组；让每组的孩子排队
                练习通过障碍赛道。</li>
        </ol>
