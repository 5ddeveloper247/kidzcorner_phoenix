...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/n1/games_cn/class1') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn1.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class2') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn2.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class3') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn3.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class4') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn4.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class5') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn5.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class6') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn6.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class7') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn7.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class8') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn8.png') }}" />
        </a>
    ...
    <div id="slide-board" class="first grid grid-cols-3 gap-[2vw] mb-[2vw] hidden">
        ...
        <a href="{{ url('/micet/n1/games_cn/class9') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn9.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/class10') }}">
            <img src="{{ asset('assets/images/micet/n1/games/cn10.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/games_cn/tables') }}">
            <img src="{{ asset('assets/images/micet/n1/games/t-cn.png') }}" />
        </a>
