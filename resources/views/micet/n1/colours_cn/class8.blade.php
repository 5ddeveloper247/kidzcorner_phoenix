...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>展示颜色卡片，告诉孩子们我们要用这些卡片玩游戏。</li>
            <li>示范如何玩"找伙伴"游戏：
                <ol class="list-[lower-roman] pl-6">
                    <li>洗牌并将卡片分发给每个孩子一张。</li>
                    <li>当每个人都拿到卡片后，请他们找到持有相同颜色卡片的伙伴。</li>
                    <li>对于每种颜色（红色、黄色、蓝色和绿色），孩子们必须找到彼此，手牵手，并将卡片交还给老师。最快完成的配对即为游戏的获胜者。</li>
                    <li>重复游戏。</li>
                </ol>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>让孩子们分享玩这个游戏的经验和看法（如何在最短时间内找到伙伴）。</li>
            </ul>
