...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 4：水果的颜色</h1>
        <div class="flex ">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div class="text-center space-y-[2vw]">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>主题活动书</li>
                <li>如有可能，准备活动中展示的水果，让幼儿运用感官进行探索</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>引导幼儿说出这些是苹果，外皮是红色的。请幼儿指出红色。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>问幼儿："切开苹果后，果肉会是红色还是绿色？"（不会，既不是红色也不是绿色）</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>引导幼儿说出这些是香蕉，成熟后外皮是黄色的。请幼儿指出黄色。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="7">
            <li>问幼儿："剥掉外皮后，香蕉的果肉会是黄色的吗？"（不会）</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="9">
            <li>引导幼儿说出这些是西瓜，外皮是绿色的。请幼儿指出绿色。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="10">
            <li>问幼儿："切开西瓜后，西瓜的果肉会是绿色的吗？"（不会）"西瓜的果肉是什么颜色？"（红色或黄色）</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="12">
            <li>引导幼儿说出这些是葡萄，外皮是红色的。请幼儿指出红色。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="13">
            <li>引导幼儿说出这些是葡萄，外皮是绿色的。请幼儿指出绿色。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="14">
            <li>问幼儿："剥掉外皮后，葡萄的果肉会是红色还是绿色？"（不会，既不是红色也不是绿色）</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="16">
            <li>引导幼儿说出这些是蓝莓，外皮是蓝色的。请幼儿指出蓝色。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>让幼儿列举一些外皮为红色、黄色、蓝色和绿色的水果。</li>
            </ul>
