...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-around h-full items-center">
        <h1 class="panel-title stroke">课堂活动 10：我喜欢音乐</h1>
    ...
    {{-- panel 4 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h1 class="panel-title stroke">我喜欢音乐</h1>

        <h3 class="p-title">主题：音乐</h3>
    ...
    {{-- panel 6 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">有时，她和朋友们手拉着手，一边唱歌一边围成圈走动。</h3>
        <img src="{{ asset('assets/images/micet/n1/music/class10/c3.png') }}" class="w-[30vw]" />

        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-left">
                你有没有和朋友手拉着手，一边唱歌一边围成圈走动？ <br>
                <span class="text-[#f7b94a]">引导幼儿谈谈他们的经历。</span>
            </h3>
            <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
        </div>
    </div>
    ...
    {{-- panel 7 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">有时，她和朋友们一起唱歌并拍手。</h3>
        <img src="{{ asset('assets/images/micet/n1/music/class10/c4.png') }}" class="w-[30vw]" />

        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-left">
                你会唱歌并拍手吗？示范一下你是怎么做的。 <br>
                <span class="text-[#f7b94a]">帮助幼儿培养音乐和节奏感。</span>
            </h3>
            <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
        </div>
    </div>
    ...
    {{-- panel 8 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">有时，她和朋友们随音乐节奏跳舞。</h3>
    ...
    {{-- panel 10 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">看，Jingle 正和朋友们在音乐会上表演！有2个孩子唱歌，2个孩子跳舞，4个孩子演奏不同的打击乐器。他们的表演真的很棒！</h3>
        <img src="{{ asset('assets/images/micet/n1/music/class10/c7.png') }}" class="w-[25vw]" />

        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-left">
                Jingle 和朋友们在音乐会上做了什么？使用了哪些打击乐器？<br>
                <span class="text-[#f7b94a]">引导幼儿根据他们的观察来回答。</span>
            </h3>
            <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>问幼儿：Jingle 的音乐会中使用了哪些类型的表演？</li>
            </ul>

            <h3 class="ptitle">评估</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>能够说出 Jingle 音乐会中不同类型的表演艺术。</li>
            </ul>
        </div>
    </div>
