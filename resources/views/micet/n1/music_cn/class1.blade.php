...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 1：音乐的节奏</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div>
            ...
            <ol class="list-disc panel-ul w-[45vw]">
                <li>课前练习跟着音乐的节奏拍手。[注意：前奏结束后，每次听到鼓声就拍手]</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-disc panel-ul w-[45vw]" start="5">
            <li>播放音乐；老师示范跟着音乐的节奏拍手。</li>
            <li>告诉孩子们节奏是音乐中节拍的规律，每次跟着音乐拍手就是一个节拍。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="7">
            <li>再次播放音乐；老师再次示范跟着音乐的节奏拍手。</li>
            <li>告诉孩子们一段音乐中有许多不同的节奏。</li>
        </ol>
        <button class="w-[4vw] mt-[7vw]" id="soundButton" data-letter="cat">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="9">
            <li>现在，邀请孩子们一起学习如何跟着音乐的节奏拍手</li>
            <li>重复播放音乐。让孩子们跟着老师一起跟着音乐的节奏拍手。</li>
        </ol>
        <button class="w-[4vw] mt-[7vw]" id="soundButton" data-letter="cat">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>播放孩子们熟悉的其他音乐，引导他们跟着音乐的节奏拍手。</li>
            </ul>
        </div>
    </div>
