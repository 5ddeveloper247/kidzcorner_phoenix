...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 6：一起摇一摇</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <div>
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>为每个孩子准备一个沙锤（玩具主题活动6中制作的沙锤；可用其他打击乐器或玩具替代）。</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="flex flex-col items-center">
            ...
            <h3 class="text-[1.5vw] text-[#f7b94a]">沙锤</h3>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>告诉孩子们，沙锤是一种打击乐器。摇动它时，会发出声音。</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>告诉孩子们，除了拍手、做动作、唱歌和跳舞，我们还可以随音乐的节奏摇动沙锤。</li>
            <li>邀请孩子们观看以下示范。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>问孩子们：除了拍手、做动作、唱歌和跳舞，我们还可以做什么来随音乐的节奏？</li>
                <li>播放音乐，让孩子们随音乐的节奏摇动沙锤。</li>
            </ul>

            <h3 class="ptitle">评估</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>能够说出我们可以随音乐的节奏摇动沙锤。</li>
                <li>能够随音乐的节奏摇动沙锤。</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>播放孩子们熟悉的其他音乐，带领他们随音乐的节奏摇动沙锤。</li>
            </ul>
        </div>
    </div>
