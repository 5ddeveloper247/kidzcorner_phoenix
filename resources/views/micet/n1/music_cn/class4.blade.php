...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 4：一起唱歌</h1>
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>了解我们也可以随音乐的节奏唱歌</li>
            <li>学习演唱歌曲《十只小鸭子》</li>
            <li>随音乐的节奏演唱，并模仿小鸭子走路的动作</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div class="text-center space-y-[2vw]">
            ...
            <ul class="list-disc panel-ul">
                <li>主题活动书</li>
                <li>课前练习演唱，并随音乐的节奏模仿小鸭子走路的动作</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>告诉孩子们，今天他们要学习随音乐的节奏演唱歌曲《十只小鸭子》。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center sapce-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>播放音乐，老师随音乐的节奏演唱，并模仿小鸭子走路的动作。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center sapce-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="7">
            <li>重复播放音乐。让孩子们跟着老师一起演唱，并随音乐的节奏模仿小鸭子走路的动作。提醒孩子们听到鼓声时才走一步。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center sapce-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="8">
            <li>将孩子们分成几组。让各组的孩子们练习演唱，并随音乐的节奏模仿小鸭子走路的动作。</li>
            <li>然后，让各组轮流表演歌曲。为每个人的表演鼓掌。</li>
        </ol>
    </div>
