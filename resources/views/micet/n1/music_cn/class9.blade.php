...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 9：音乐会</h1>
        ...
        <ul class="list-disc panel-ul">
            <li>在音乐会中使用不同类型的表演艺术（例如舞蹈、音乐）</li>
            <li>在音乐会中与小组成员合作</li>
            <li>表达对音乐会的喜爱或不喜欢</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div>
            ...
            <ul class="list-disc panel-ul">
                <li>不同的打击乐器</li>
                <li>根据幼儿唱歌、跳舞和演奏打击乐器的能力，将他们分成3个表演小组</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>告诉幼儿，他们将在音乐会上表演。</li>
            <li>问幼儿："你见过音乐会吗？" "那是什么样的？" "你喜欢吗？"</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>告诉幼儿，今天他们将以不同方式在音乐会上表演。其中一些人唱歌，一些人跳舞，一些人演奏不同的打击乐器。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>让幼儿轮流分享他们对音乐会的想法，并说出他们喜欢或不喜欢音乐会。</li>
            </ul>

            <h3 class="ptitle">评估</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>能够在音乐会中与小组成员合作。</li>
                <li>能够在音乐会中与小组成员合作。</li>
            </ul>
        </div>
    </div>
