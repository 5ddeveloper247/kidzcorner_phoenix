...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 5：一起跳舞</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>播放视频，让孩子们说出视频中的孩子在做什么（跳舞）。</li>
            </ol>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul" start="2">
            <li>问孩子们："你以前跳过舞吗？""你在哪里跳舞？""你和谁一起跳舞？""你喜欢跳舞吗？"</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="10">
            <li>现在，老师带领孩子们做四个舞步，并重复它们组成完整的舞蹈。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="11">
            <li>重复播放音乐，让孩子们跟着老师一起随音乐的节奏跳舞。</li>
        </ol>
        <button class="w-[4vw] mt-[7vw]" id="soundButton" data-letter="cat">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>播放音乐，让孩子们随音乐的节奏跳舞。</li>
                <li>让孩子们说出他们是喜欢还是不喜欢跳舞。</li>
            </ul>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>再编四个简单的舞步。老师引导孩子们随音乐的节奏跳舞。</li>
            </ul>
        </div>
    </div>
