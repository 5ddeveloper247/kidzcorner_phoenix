...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 8：打击乐表演</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ul class="list-disc panel-ul">
            <li>每个孩子一件打击乐器（例如沙锤、鼓、
                三角铁、钹；可用其他打击乐器替代）
                [注意：在课程中，观察每个幼儿演奏不同打击乐器的表现，以便根据他们的能力为活动9的表演做出合适的选择。]</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li>问幼儿："这些是什么打击乐器？" 引导幼儿
                    说出每种打击乐器的名称，并描述演奏方式（摇晃、敲击、击打）。</li>
            </ol>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="4">
            <li>问幼儿："你觉得我们能像沙锤一样，随音乐节奏演奏其他打击乐器吗？"</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>能够知道我们可以随音乐节奏演奏打击乐器。</li>
                <li>能够随音乐节奏演奏不同的打击乐器。</li>
            </ul>
        </div>
    </div>
