...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 1: Little Butterfly Looks For Mummy</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <h3 class="p-title">Enjoy listening to a story</h3>
        <img src="{{ asset('assets/images/micet/n1/colours/class1/c1.1.png') }}" class="w-[25vw]" />
    </div>

    {{-- panel 4 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">Fly, the little butterfly flies. It flies here and there <br>
            to look for mummy.</h3>

        <img src="{{ asset('assets/images/micet/n1/colours/class1/c1.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                Why is the little butterfly flying around? <br>
                <span class="text-[#f7b94a]">Help children to develop listening skills.</span>
            </h3>
    ...
    {{-- panel 5 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">It meets a red butterfly, but it is not its mummy.</h3>

        <img src="{{ asset('assets/images/micet/n1/colours/class1/c2.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                Who did the little butterfly meet? Was it its mummy?<br>
                <span class="text-[#f7b94a]">Help children to develop listening and observation skills.</span>
            </h3>
    ...
    {{-- panel 6 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">It meets a yellow butterfly, but it is not its mummy.</h3>
    ...
    {{-- panel 7 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">It meets a blue butterfly, but it is not its mummy.</h3>
    ...
    {{-- panel 8 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">It meets a green butterfly, but it is not its mummy.</h3>
    ...
    {{-- panel 9 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">Finally, it meets a colourful butterfly. It is its mummy!</h3>

        <img src="{{ asset('assets/images/micet/n1/colours/class1/c6.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                How did the little butterfly know that the colourful butterfly is its mummy?<br>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Have children recall who the little butterfly met before it found its mummy.
                    [Note: if children have difficulty, turn story pages to help.]</li>
            </ul>
