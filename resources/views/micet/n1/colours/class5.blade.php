...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 5: Odd One Out</h1>
        <div class="flex ">
        ...
        <ul class="list-disc panel-ul">
            ...
            <li>Find the object that is different from the others through
                observation</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div>
            ...
            <ul class="list-disc panel-ul w-[42vw]">
                ...
                <li>Based on the references in the lesson development,
                    prepare a few sets of objects (such as pencils, toys, erasers,
                    etc); each set should contain two identical objects and
                    one object that is different only in terms of colour</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>Point to the different colours one at a time, have children name each colour.</li>
            </ol>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>Ask children: "What are these?" (lollipops) "Which lollipop is different? Why?"</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Ask children: "What are these?" (balls) "Which lollipop is different? Why?"</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>Ask children: "What are these?" (teddy bears) "Which lollipop is different? Why?"</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>Ask children: "What are these?" (chairs) "Which lollipop is different? Why?"</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw] items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Ask children: "What are these?" (tables) "Which lollipop is different? Why?"</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Display each set of objects, one set at a time. Ask children to point out
                    the different object in each set. Guide them to name the colour that makes
                    it different from the rest in the set.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to find the object that is different from the others through observation.</li>
            </ul>
        </div>
    </div>
