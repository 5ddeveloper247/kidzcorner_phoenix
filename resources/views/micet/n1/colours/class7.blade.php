...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 7: Dough Shapes</h1>
        ...
        <ul class="list-disc panel-ul w-[42vw]">
            <li>Promote interpersonal relationship between children through sharing of dough</li>
            <li>Develop imagination and creativity skills</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div>
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                ...
                <li>2 pre-moulded dough shapes (one in single colour,
                    another in many colours)</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li> Display a dough shape of a single colour, have children name it and talk
                    about the colour that was used to form the shape. [Note: If a child is unable to
                    name the colour, allow him/her to point to the colour and the teacher can
                    assist the child to name it.]</li>
            </ol>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Tell children that we can use different tools and coloured dough to form a
                variety of dough shapes. Show them some samples.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>Have children look at the different dough shapes, name each of the shapes
                and colours used to form it. [Note: If a child is unable to name the colour, allow
                him/her to point to the colour and teacher can assist the child to name it.]</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>Ask children: "After looking at the different dough shapes, would you like to
                make a colourful one on your own? If you do, share some dough with your
                friends, so that you can have dough of different colours !"</li>
            <li>Give children some time to share their dough with friends. Remind children to
                place the different coloured dough away from each other, so that the
                different dough won't stick together.</li>
            <li>Encourage children to use their imagination and creativity to form a dough
                shape. Suggest to children to form one of their favourite items.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Have children take turns to display their dough shapes and talk about it.
                    Have them explain why they chose to form the object and name the
                    colours used to form it.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to share dough with friends.</li>
                <li>Able to form a dough shape.</li>
                <li>Able to name the colours used to form a dough shape.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Get children to work together to form a big dough shape.</li>
            </ul>
        </div>
    </div>
