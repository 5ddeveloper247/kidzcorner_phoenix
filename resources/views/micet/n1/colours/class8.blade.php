...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul">
            <li>To find a partner based on a colour</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            ...
            <li>Colour cards (4 colours that children have learnt; quantity
                depends on the number of children in class but each
                colour must be in pairs)</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li>Point to the different colours, guide children to name each colour.</li>
            </ol>
        </div>
        <img src="{{ asset('assets/images/micet/n1/colours/class8/c1.png') }}" class="w-[25vw]" />
    </div>
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="2">
            <li>Ask children:
                <ul class="list-disc">
                    ...
                    <li>Do you have any newfriends in school?</li>
                </ul>
            </li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            ...
            <li>Demonstrate how to play the "Find a Partner" game:
                <ol class="list-[lower-roman] pl-6">
                    <li>Shuffle the cards and distribute one card to each child.</li>
                    <li>When everyone has a card, ask them to find a partner with the same colour card.</li>
                    <li>For each colour (red, yellow, blue, and green), the children must find each other, hold hands, and
                        return their cards to the teacher. The fastest pairs are the winners of the game.</li>
                    <li>Repeat the game.</li>
                </ol>
            </li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Have children share their experience and views in playing this game (how to
                    find partner in shortest time).</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to find a partner based on a colour.</li>
