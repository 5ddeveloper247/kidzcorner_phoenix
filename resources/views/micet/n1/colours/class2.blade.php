...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 2: Find Colours</h1>
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            ...
            <li>Find things based on a given colour</li>
            <li>Choose a favourite colour among the four basic colours</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start space-y-[1vw]">
            ...
            <ul class="list-decimal panel-ul w-[45vw]">
                <li>Display the four basic colours, ask children: "Have you ever seen these
                    colours?" "Do you like them?"</li>
            </ul>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>Point and introduce the colour red. Tell children that there are many red things
                in our surroundings.</li>
            <li>Have children find red things in the classroom.</li>
        </ol>
        <img src="{{ asset('assets/images/micet/n1/colours/class2/c2.png') }}" class="w-[20vw]" />
        <h5 class="text-[2vw] text-[#f7b94a]">red</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>Point and introduce the colour yellow. Tell children that there are many yellow
                things in our surroundings.</li>
            <li>Have children find yellow things in the classroom.</li>
        </ol>
        <img src="{{ asset('assets/images/micet/n1/colours/class2/c3.png') }}" class="w-[20vw]" />
        <h5 class="text-[2vw] text-[#f7b94a]">yellow</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Point and introduce the colour blue. Tell children that there are many blue
                things in our surroundings.</li>
            <li>Have children find blue things in the classroom.</li>
        </ol>
        <img src="{{ asset('assets/images/micet/n1/colours/class2/c4.png') }}" class="w-[20vw]" />
        <h5 class="text-[2vw] text-[#f7b94a]">blue</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="8">
            <li>Point and introduce the colour green. Tell children that there are many green
                things in our surroundings.</li>
            <li>Have children find green things in the classroom.</li>
        </ol>
        <img src="{{ asset('assets/images/micet/n1/colours/class2/c5.png') }}" class="w-[20vw]" />
        <h5 class="text-[2vw] text-[#f7b94a]">green</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Have children take turns to choose a favourite colour among the four
                    basic colours and then talk about it.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to find things based on a given colour.</li>
                <li> Able to choose a favourite colour among the four basic colours.</li>
            </ul>
        </div>
    </div>
