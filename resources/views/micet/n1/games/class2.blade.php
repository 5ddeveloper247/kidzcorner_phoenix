...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 2: Musical Chairs</h1>
        ...
        <ul class="list-disc panel-ul ">
            <li>Learn how to play the "Musical Chairs" game</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div class="space-y-[1vw] text-center">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Catchy music (can use musical instruments as replacement)</li>
                <li>Arrange chairs in a circle; the number of chairs should be
                    one less than the number of the children playing in the game</li>
                <li>[Note: You may use other things like hula hoops or mats to
                    replace chairs]</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start space-y-[1vw]">
            ...
            <ul class="list-decimal panel-ul w-[45vw]">
                <li>Have children look at the chairs arranged in a circle, ask them: "What are
                    these?" "Why are they arranged in a circle?" Accept all logical guesses</li>
                <li>Tell children that we are going to use these chairs to play the game
                    "Musical Chair" today.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Have children assist in demonstrating how to play the game (indoors or
                outdoors):
                <ul class="list-disc">
                    <li>Play music, have children walk around the chairs in a clockwise
                        direction.</li>
                    <li>When the music stops, the children have to find a chair to sit down.</li>
                </ul>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-disc panel-ul w-[45vw]">
            <li>The child without a chair will be out of the game, he/she then takes a
                chair away.</li>
            <li>The game continues until only 2 children are left with the last chair.
