...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 7: Thinking Games (2)</h1>
        ...
        <ul class="list-disc panel-ul w-[42vw]">
            <li>Learn to play games, such as mazes, hidden images and
                spot the differences</li>
            <li>Practise drawing lines and circles, and colouring</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>Ask children: "What is this game?" "Have you ever seen or played it
                    before?" "How do you play it?"</li>
            </ol>
        </div>
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/n1/games/class7/c1.png') }}" class="w-[25vw]" />
            <h4 class="text-[#f7b94a] text-[2vw]">maze</h4>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>Have children "walk" through the maze: use a pointer to follow the path
                chosen by the children.</li>
        </ol>
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/n1/games/class7/c1.png') }}" class="w-[25vw]" />
            <h4 class="text-[#f7b94a] text-[2vw]">maze</h4>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Let’s see how we can “”walk”” through the maze!</li>
        </ol>
        <div class="flex items-center gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex items-center gap-[1vw]">
            ...
            <h4 class="text-[#f7b94a] text-[2vw]">hidden <br>
                image</h4>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>Have children guess what image is hidden in this picture.</li>
        </ol>
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/n1/games/class7/c3.png') }}" class="w-[25vw]" />
            <h4 class="text-[#f7b94a] text-[2vw]">hidden <br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Let’s find out what image is hidden in this picture.</li>
        </ol>
        <div class="flex items-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/n1/games/class7/c3.png') }}" class="w-[25vw]" />
            <h4 class="text-[#f7b94a] text-[2vw]">hidden <br>
