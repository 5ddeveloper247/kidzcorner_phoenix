...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 7：制作木偶</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>展示预先制作好的木偶，问孩子们："这是什么？它是什么颜色的？它漂亮吗？"</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>告诉孩子们，他们将用一些回收材料来制作木偶。</li>
            <li>引导他们认真听老师的说明，仔细观察示范，这样他们就能跟着制作自己的木偶。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>首先，给每个孩子发一个纸盘。让孩子们用自己喜欢的颜色给纸盘上色，然后晾干。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>然后老师示范如何用胶水粘贴不同的材料（例如种子、豆子、沙子）来制作木偶的五官（例如眼睛、鼻子）。</li>
            <li>让孩子们选择自己喜欢的材料来制作木偶的五官。鼓励他们用想象力和创造力来制作五官，让每只木偶都独一无二。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="7">
            <li>最后，老师用胶带把筷子粘贴在纸盘中间（背面）。</li>
            <li>让孩子们也这样做，完成木偶的制作。</li>
            <li>然后老师帮孩子们在木偶背面写名字。</li>
        </ol>
    </div>
