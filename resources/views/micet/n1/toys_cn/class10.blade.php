...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 10：玩具的特点</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul" start="2">
            <li>展示一件玩具，通过引导性问题帮助孩子们谈论玩具的
                特点（例如颜色、形状、有没有轮子、有没有声音、
                能不能扔）。</li>
            <li>指向另一件玩具，重复第 2 步。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul" start="4">
            <li>告诉孩子们，他们将分组玩一个有趣的玩具游戏。</li>
            <li>示范如何玩游戏：
                <ul class="list-disc">
                    <li>将孩子们分成 4 组进行比赛。</li>
                    <li>老师说出一个玩具的特点（例如有轮子的玩具），让
                        每组的孩子轮流从教室中找出具有该特点的玩具。[允许
                        组内孩子互相口头帮助。]</li>
                    <li>当孩子找到正确的玩具时，他/她必须将玩具带回
                        自己的小组。只有当组内每个人都找到正确的玩具，
                        并一起演唱玩具歌后向老师报告，任务才算完成。</li>
                    <li>比赛过程中，老师须关注各组的进度。</li>
                </ul>
            </li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-disc panel-ul">
            <li>当一组向老师报告时，老师须检查所选玩具是否正确。最快
                正确完成任务的组该轮得 2 分。其余成功完成任务的组得 1 分。
                未能完成任务的组不得分。
            </li>
            <li>记录各组得分后，让孩子们将玩具放回教室的不同位置，然后
                重复游戏。
            </li>
            <li>最后一轮游戏结束后，得分最高的组获胜。</li>
        </ol>
    </div>
