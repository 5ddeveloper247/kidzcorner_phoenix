...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 1：快乐的玩具日</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul">
            <li>运用建议的问题和活动讲述故事，以巩固故事中的教学要点。</li>
        </ol>
    ...
    {{-- panel 4 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">今天是苹果班的玩具日。看，所有孩子都带来了<br>
            他们最喜欢的玩具。</h3>

        <img src="{{ asset('assets/images/micet/n1/toys/class1/c2.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                你喜欢玩具吗？你最喜欢的玩具是什么？<br>
                <span class="text-[#f7b94a]">帮助孩子们发展语言技能。</span>
            </h3>
    ...
    {{-- panel 6 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">Logi 说："这是我最喜欢的玩具。它有轮子。它跑得<br>
            很快！"</h3>

        <img src="{{ asset('assets/images/micet/n1/toys/class1/c4.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-start">
                Logi 最喜欢的玩具是什么？你玩过这种玩具吗？<br>
                <span class="text-[#f7b94a]">帮助孩子们发展观察和语言技能。</span>
            </h3>
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b3.png') }}" class="w-[5vw]" />
    ...
    {{-- panel 7 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">Lingo 说："这是我最喜欢的玩具。它是不是很可爱？"</h3>

        <img src="{{ asset('assets/images/micet/n1/toys/class1/c5.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                Lingo 最喜欢的玩具是什么？你玩过这种玩具吗？<br>
                <span class="text-[#f7b94a]">帮助孩子们发展观察和语言技能。</span>
            </h3>
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
    ...
    {{-- panel 8 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">Peace 说："这是我最喜欢的玩具。它能发出美妙的声音！"</h3>

        <img src="{{ asset('assets/images/micet/n1/toys/class1/c6.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                Peace 最喜欢的玩具是什么？你玩过这种玩具吗？<br>
                <span class="text-[#f7b94a]">帮助孩子们发展观察和语言技能。</span>
            </h3>
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
    ...
    {{-- panel 9 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">Dex 说："这是我最喜欢的玩具。我把它扔出去，它能飞得很远！"</h3>

        <img src="{{ asset('assets/images/micet/n1/toys/class1/c7.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                Dex 最喜欢的玩具是什么？你玩过这种玩具吗？<br>
                <span class="text-[#f7b94a]">帮助孩子们发展观察和语言技能。</span>
            </h3>
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
    ...
    {{-- panel 9 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">Doodle 说："这是我最喜欢的玩具。我自己做的！"</h3>

        <img src="{{ asset('assets/images/micet/n1/toys/class1/c7.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                Doodle 最喜欢的玩具是什么？你玩过这种玩具吗？<br>
                <span class="text-[#f7b94a]">帮助孩子们发展观察和语言技能。</span>
            </h3>
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
    ...
    {{-- panel 10 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">老师说："我们这里有很多不同类型的玩具。现在，和<br>
            朋友们分享吧！记得好好爱护它们！"</h3>

        <img src="{{ asset('assets/images/micet/n1/toys/class1/c8.png') }}" class="w-[25vw]" />
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title">
                Logi 对 Dex 说了什么？你会用同样的方式说吗？<br>
                <span class="text-[#f7b94a]">培养分享和爱护玩具的习惯。</span>
            </h3>
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b1.png') }}" class="w-[5vw]" />
                <img src="{{ asset('assets/images/micet/n1/colours/class1/b3.png') }}" class="w-[5vw]" />
    ...
    {{-- panel 11 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        <h3 class="p-title">现在每个人都能玩一个"新"玩具。所有孩子<br>
            都非常开心！</h3>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>让孩子们回忆故事并回答问题：孩子们为什么把最喜欢的玩具带到课堂？你有没有玩过故事中不同类型的玩具？</li>
            </ul>
