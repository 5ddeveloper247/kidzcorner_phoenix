...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Learn how to play the "Mirror Dance" game</li>
            <li>Create three actions for a partner to imitate</li>
            <li>Imitate the actions of a partner and do them together at
                the same time</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center sapce-y-[1vw]">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>Display the mirror and ask children: "What is this?" "What is its use?" Guide
                    children in understanding that a mirror allows us to see ourselves as others
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>Have children stand in front of the mirror and do an action, at the same
                time observe the reflected image. Then have children talk about their
                observations. Guide children in understanding that the reflected image will
                act according to our actions.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center sapce-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Tell children that they are going to learn to be the reflected image by
                playing the "Mirror Dance" game.</li>
        </ol>
        <img src="{{ asset('assets/images/micet/n1/games/class4/c2.png') }}" class="w-[25vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul" start="3">
            <li>Invite children to form groups of two to start learning how to play the game:
                <ul class="list-disc">
                    <li>Have the players think of three actions.</li>
                    <li>Have the players face each other. The first player does three actions while the second
                        player imitates the actions accordingly. Then have them practise doing the actions together</li>
                    <li>Now it is the second player's turn to do three actions while the first player imitates
                        the actions accordingly. Then have them practise doing the actions together.</li>
                    <li>Now it is the second player's turn to do three actions while the first player imitates
                        the actions accordingly. Then have them practise doing the actions together.</li>
                </ul>
            </li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center sapce-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>After the players are familiar with each other's actions, have them do
                and imitate the actions in a continuous sequence to look like a dance.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                ...
                <li>Able to imitate the actions of a partner and do the actions together with the partner.</li>
