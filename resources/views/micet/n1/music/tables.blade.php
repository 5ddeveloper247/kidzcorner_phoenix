...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[3vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]">
            <li>To identify some games and their rules</li>
            <li>To know that different games require different numbers of people to play</li>
            <li>To enjoy playing games</li>
            <li>To develop gross and fine motor skills</li>
            <li>To learn to follow rules of games</li>
        </ol>
    </div>
