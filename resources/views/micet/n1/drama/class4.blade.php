...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">Classroom Activity 4: Animals That Move In The Water</h1>
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Identify some animals that move in water and know their characteristics</li>
            <li>Observe and imitate the actions of some animals that move in water</li>
            <li>Know that most animals that move in water have fins</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center sapce-y-[1vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">clown fish</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="11">
            ...
            <li>Ask children: "How do these animals move on water? Do they move in the
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Have children name some animals that move in water, then use their
                    imagination to imitate the actions of these animals.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to name some animals that move in water.</li>
                <li>Able to use imagination to imitate the actions of some
                    animals that move in water.</li>
                <li>Able to know that most animals that move in water have fins.</li>
            </ul>
        </div>
    </div>
