...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul ">
            <li>Learn to sing the songs from the story</li>
            <li>Sing and clap to the rhythm of the music</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <div class="space-y-[1vw] text-center">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                ...
                <li>Before lesson, practise singing and clapping to the rhythm
                    of the music [Note: After prelude, clap every time you
                    hear the sound of the drum.]</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start space-y-[1vw]">
            ...
            <ul class="list-decimal panel-ul w-[45vw]">
                <li>Play music, ask children: "Have you heard this music before?" "Do you like
                    it?" "Can you feel the rhythm of the music?"</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>Play music, have children clap along with the teacher to the rhythm of the music.</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="5">
            <li>Song 1: Play music, teacher sings to the rhythm of the music.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>Song 1: Teacher explains the meaning of the lyrics to children.</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="7">
            <li>Song 1: Repeat playing music, have children sing along with teacher to the
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="8">
            <li>Song 1: After children are familiar with the song, play music, have children
                sing and clap along with the teacher to the rhythm of the music.</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="10">
            <li>Song 2: Teacher explains the meaning of the lyrics to children.</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="11">
            <li>Song 2: Repeat playing music, have children sing along with teacher to the
                rhythm of the music.</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="12">
            <li>Song 2: After children are familiar with the song, play music, have children
                sing and clap along with the teacher to the rhythm of the music.</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="13">
            <li>Ask children: "What animal is this?" "What colour is it?" "Can you describe
                it?" (physical features) "How does it move on land?" "How many legs does
                it have?"</li>
            <li>After that, have each group take turns to perform the song.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Swap the song, have each group take turns to perform the other song.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to sing the songs from to the story.</li>
                <li>Able to sing and clap to the rhythm of the music.</li>
            </ul>
        </div>
    </div>
