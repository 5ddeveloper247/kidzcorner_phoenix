...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动8:身体部位之歌</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="2">
            <li>播放音乐并唱这首歌。</li>
            <li>向孩子们解释歌词的意思,然后让孩子们指出
                歌曲中提到的不同身体部位。</li>
            <li>再次播放音乐,邀请孩子们一起唱这首歌。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="5">
            <li>当孩子们熟悉这首歌后,引导他们学习如何根据
                歌词做动作:
                <ul class="list-disc">
                    <li>第1、2、4行:双手摸头,拥抱身体,摆动双手,
                        然后双腿一起跳。</li>
                    <li>第3行:双手指向眼睛,拉耳朵,摸嘴巴,然后摸
                        鼻子。</li>
                </ul>
            </li>
        </ol>
