...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动9:动作游戏</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li>告诉孩子们今天他们将学习玩一个动作游戏。</li>
                <li>示范如何玩这个游戏:
                    <ul class="list-disc">
                        <li>首先,老师给出一个动作指令,例如:"听好,用你的手
                            摸摸你的头。"</li>
                        <li>然后孩子们根据给出的指令做动作。第一个正确
                            做出动作的孩子获胜。</li>
                        <li>重复这个游戏。 <br>
                            [注意:指令中提到的身体部位必须是孩子们已经
                            学过的;示例指令:眨眨眼睛、拉拉耳朵、
                            指指鼻子、摸摸嘴巴、摇摇头、摆动身体、
                            伸伸腿]
                        </li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>将孩子们分成2组进行比赛:每组听老师的
                指令,然后做出相应的动作。第一个正确做出
                动作的孩子将获得一分。得分最高的一组获胜。</li>
        </ol>
    </div>
