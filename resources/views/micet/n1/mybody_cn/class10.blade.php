...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动10:让我们做一个姜饼人</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]">
            <li>主题活动手册</li>
            <li>为每个孩子准备一张姜饼人的轮廓图</li>
            <li>彩色铅笔或蜡笔</li>
            <li>合适的美术手工材料(如毛线、彩纸、大纽扣等)</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="2">
            <li>询问孩子们:"你想成为故事中的面包师,做一个
                姜饼人吗?"</li>
            <li>告诉孩子们,他们将成为一名出色的面包师,因为他们
                即将做一个特别的姜饼人。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="4">
            <li>让孩子们运用想象力制作一个独特的姜饼人。
                他们可以给它上色,并使用美术手工材料来制作姜饼人
                不同的身体部位以及衣服。(使用轮廓图
                或主题活动手册。)</li>
        </ol>
    </div>
