...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Identify some animals that move on land and know their characteristics</li>
            <li>Observe and imitate the actions of some animals that move on land</li>
            <li>Know that most animals that move on land have legs</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">dog</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">cat</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">horse</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">squirrel</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">zebra</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">rhinoceros</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="15">
            <li>Ask children: "Do you think all animals that move on land have four legs?"</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">people</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">ant</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">caterpillar</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="22">
            <li>Ask children: "What are these?" "Where do they live?" [on land, in water or
                in the air] Tell children that all these animals move on land.</li>
            <li>Ask children: "How do these animals move on land? Do they move in the
                same way?" Guide children to understand that most animals that move on
                land have legs.</li>
        </ol>
