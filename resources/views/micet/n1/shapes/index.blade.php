...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/n1/shapes/class1') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class1.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class2') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class2.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class3') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class3.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class4') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class4.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class5') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class5.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class6') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class6.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class7') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class7.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class8') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class8.png') }}" />
        </a>
    ...
    <div id="slide-board" class="first grid grid-cols-3 gap-[2vw] mb-[2vw] hidden">
        ...
        <a href="{{ url('/micet/n1/shapes/class9') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class9.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/class10') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/class10.png') }}" />
        </a>

        <a href="{{ url('/micet/n1/shapes/tables') }}">
            <img src="{{ asset('assets/images/micet/n1/shapes/tables.png') }}" />
        </a>
