...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <ul class="list-disc panel-ul">
        <li>Understand that our tongue enables us to taste food</li>
        <li>Express likes and dislikes of the food tasted</li>
    </ul>
</div>
...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <div class="text-start">
        ...
        <ol class="list-decimal panel-ul w-[50vw]">
            <li>Ask children: “”Where is the mouth of the gingerbread man?”” Have the children
