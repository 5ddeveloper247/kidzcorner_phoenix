...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between items-center">
        <h1 class="panel-title">Classroom Activity 1: The Gingerbread Man</h1>
        <img src="{{ asset('assets/images/phonicsl1/global/btns/return-btn.png') }}" class="w-[4vw]" />
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // URLs for navigation
            const returnURL = "{{ url('/phonics_l1/letter_b') }}";
            const doneURL = "{{ url('/phonics_l1/letter_b') }}";
