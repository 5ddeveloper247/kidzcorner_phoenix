...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 7：打击乐表演</h1>
        ...
        <div>
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>每个孩子一件打击乐器（例如沙锤、鼓、
                    三角铁、钹；可用其他打击乐器替代）
                    [注意：在课程中，观察每个幼儿演奏不同打击乐器的表现，以便为活动8-10的小型戏剧做出合适的选择。]</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>点击视频，让幼儿观看打击乐器（鼓和沙锤）如何随音乐节奏演奏。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>给每个幼儿一件打击乐器。播放音乐，让幼儿在随音乐节奏演奏打击乐器的同时，跟随老师的拍手。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="6">
            <li>现在，让幼儿交换打击乐器。重复播放音乐，让幼儿练习随音乐节奏演奏不同的打击
                乐器。</li>
        </ol>
        <button class="mt-[7vw] w-[4vw]" id="sound-btn">
            <img src="{{ asset('assets/images/pptimages/sound-btn.png') }}" />
