...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 2：故事歌曲（1）</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start space-y-[1vw]">
            ...
            <ul class="list-decimal panel-ul w-[45vw]">
                <li>播放音乐，问孩子们："你们以前听过这段音乐吗？" "你们喜欢吗？" "你们能感受到音乐的节拍吗？"</li>
                <li>邀请孩子们跟着音乐的节拍拍手。</li>
            </ul>
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="3">
            <li>播放音乐，让孩子们跟着老师一起跟着音乐的节拍拍手。</li>
            <li>告诉孩子们，今天他们将用这段音乐来学习演唱故事《兔子和狼》中的两首歌曲。</li>
        </ol>
        <button class="w-[4vw]" id="soundButton">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="7">
            <li>歌曲 1：重复播放音乐，让孩子们跟着老师一起跟着音乐的节拍演唱。</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="8">
            <li>歌曲 1：孩子们熟悉歌曲后，播放音乐，让孩子们跟着老师一起唱着拍着音乐的节拍。</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="11">
            <li>歌曲 2：重复播放音乐，让孩子们跟着老师一起跟着音乐的节拍演唱。</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[.5vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="12">
            <li>歌曲 2：孩子们熟悉歌曲后，播放音乐，让孩子们跟着老师一起唱着拍着音乐的节拍。</li>
        </ol>
        <div class="flex items-start gap-[1vw]">
