...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 8：练习（1）</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>不同的乐器</li>
            <li>兔子和狼的头饰/面具</li>
            <li>根据孩子们在唱歌、角色扮演、讲故事和演奏乐器方面的能力，将他们分成4个表演小组。[注：如果没有其他讲故事的人，由老师担任旁白；老师可以选择不同的孩子唱不同的歌；所有表演细节可根据老师的要求进行调整。]</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li>告诉孩子们，他们将一起表演一个小型戏剧，所以接下来会花时间练习小型戏剧《兔子和狼》。</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="2">
            <li>问孩子们："你们看过戏剧表演吗？""那是什么样的表演？""你们喜欢吗？""有讲故事或唱歌吗？""他们用了乐器吗？"</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>告诉孩子们，戏剧可以用多种方式表演，例如讲故事、唱歌、跳舞和演奏不同的乐器。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="6">
            <li>播放声音，问孩子们："这是什么动物发出的声音？""这种动物有腿、鳍还是翅膀？"</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>让每组轮流表演他们的角色。老师鼓励所有孩子。</li>
                <li>问孩子们：小型戏剧表演有趣吗？你们喜欢吗？</li>
            </ul>
