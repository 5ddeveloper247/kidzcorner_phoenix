...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 10：我最喜欢的动物</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li>让孩子们围成一圈，展示他们最喜欢的动物玩具。</li>
                <li>让他们轮流说出最喜欢的动物玩具并说明理由，然后用简单的词语描述它们（外形特征、特点等）。</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal text-white text-[1.35vw] text-left" start="2">
            <li>提出以下问题，让孩子们举手回答。
                <ul class="list-disc">
                    <li>谁最喜欢的动物可以在陆地上移动？</li>
                    <li>谁最喜欢的动物可以在水中移动？</li>
                    <li>谁最喜欢的动物可以在空中移动？</li>
                    <li>谁最喜欢的动物有腿？</li>
                    <li>谁最喜欢的动物有鳍？</li>
                    <li>谁最喜欢的动物有翅膀？ </li>
                    <li>谁最喜欢的动物有腿和翅膀？</li>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal text-white text-[1.35vw] text-left" start="2">
            <li>问孩子们："你们想玩不同的动物玩具吗？"邀请孩子们分享玩具，这样他们就可以玩不同的动物玩具。
            </li>
            <li>让孩子们把最喜欢的玩具传给右边的朋友，让他们玩5-10分钟。重复此步骤，直到每个人都拿回自己最喜欢的玩具。</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>让孩子们轮流把最喜欢的玩具放在教室里合适的地方——陆地动物王国、水族馆或飞行动物王国。</li>
            </ul>

            <h3 class="ptitle">评估</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>能够说出最喜欢的动物并说明理由。</li>
                <li>能够用简单的词语介绍最喜欢的动物。</li>
                <li>能够与朋友们分享玩具。</li>
            </ul>
        </div>
    </div>
