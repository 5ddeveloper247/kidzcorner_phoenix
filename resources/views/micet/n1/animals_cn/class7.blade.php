...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 7：飞行动物王国</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div>
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                ...
                <li>课前在教室一角布置一个飞行动物王国
                    ［如有可能，可将这一角的
                    天花板或墙壁装饰成蓝天］</li>
                <li>收集孩子们从家里带来的所有玩具，将
                    合适的动物玩具放入飞行动物王国中</li>
                <li>胶水、彩色铅笔</li>
                <li>一只预先制作好的白头海雕</li>
                <li>打印白头海雕的不同身体部位（如课程开展中所示），
                    每个孩子一套</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[45vw]">
                <li>让幼儿观察教室里布置的飞行动物王国。
                    问幼儿："你们在这个飞行动物王国里看到了哪些动物？"</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="4">
            <li>根据下面的图片，让幼儿将不同的身体部位
                拼合在一起，组成一只白头海雕。</li>
            <li>让幼儿用胶水将各部位粘贴起来，完成白头海雕的制作。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>能够制作一只白头海雕。</li>
                <li>能够说出一种最喜欢的在空中移动的动物，并说明理由。</li>
            </ul>
        </div>
    </div>
