...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        <h1 class="panel-title stroke">课堂活动 6：在空中移动的动物</h1>
        ...
        <ul class="list-disc panel-ul">
            <li>认识一些在空中移动的动物，并了解它们的特点</li>
            <li>观察并模仿一些在空中移动的动物的动作</li>
            <li>知道大多数在空中移动的动物都有翅膀</li>
        </ul>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">蝴蝶</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">鹅</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">蜂鸟</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <h5 class="text-[2vw] text-[#f7b94a]">鹈鹕</h5>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="13">
            <li>问幼儿："这些是什么？" "它们在哪里飞？"［在陆地、在水中或在空中］
                告诉幼儿，所有这些动物都在空中移动。</li>
            <li>问幼儿："这些动物在空中如何移动？它们的移动方式相同吗？"
                引导幼儿理解，大多数在空中移动的动物都有翅膀。</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>能够说出一些在空中移动的动物。</li>
                <li>能够发挥想象力，模仿一些在空中移动的动物的动作。</li>
                <li>能够知道大多数在空中移动的动物都有翅膀。</li>
            </ul>
        </div>
    </div>
