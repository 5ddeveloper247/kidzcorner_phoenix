...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[3vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]">
            ...
            <li>Understand the main characteristics of birds.</li>
            <li>Imitate the calls and actions of some birds.</li>
            <li>Learn about some bird world records.</li>
            <li>Understand the differences between the life cycle of birds and the life cycle of humans.</li>
            <li>Use recycled and arts-and-crafts materials to make birds and set up a bird sanctuary.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/birds/tables/t1.png') }}" class="w-[28vw]" />
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/birds/tables/t2.png') }}" class="h-[25vw]" />
