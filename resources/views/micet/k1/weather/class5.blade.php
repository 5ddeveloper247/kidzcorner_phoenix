...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <div class="flex ">
        <img src="{{ asset('assets/images/micet/k1/weather/class5/b1.png') }}" class="h-[7vw]" />
    </div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="2">
        <li>Have the children identify and describe the modern windmills. Ask if they have ever seen modern windmills. Discuss with the children what the characteristics and functions are of a modern windmill. Explain that modern windmills are commonly called wind turbines. A wind turbine is an engine powered by the wind to generate electricity.</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="4">
        <li>Have the children identify and describe the toy pinwheel. Ask if they have ever seen a toy pinwheel. Discuss with the children what the characteristics and functions are of a toy pinwheel.</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="6">
        <li>Display the ready-made small pinwheel. Inform the children that they aregoing to make a small pinwheel today.</li>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="9">
        <li>After the demonstration, help the children in making the pinwheels. Have the children draw their favourite patterns and colour them on the pinwheel paper from activity 5 in the Thematic Activity Book before making the pinwheels.</li>
...
<div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
    ...
    <div class="text-start flex flex-col justify-between h-full">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Have the children share their experiences in playing with their pinwheels, include discoveries which they have made.</li>
            <li>Ask the children under what weather condition would a pinwheel spin fast and if there is no wind, what can be done to make the pinwheel spin.</li>
        </ul>
...
<div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
    ...
    <div class="text-start flex flex-col">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Have the children place their pinwheels near the window to examine how the changes in wind speed affects the spinning speed of the pinwheels.</li>
        </ul>
    </div>
</div>
