...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <div class="flex ">
        <img src="{{ asset('assets/images/micet/k1/weather/class5/b1.png') }}" class="h-[8vw]" />
    </div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <div class="text-start">
        ...
        <ol class="list-decimal panel-ul w-[50vw]">
            <li>Have the children recall the content in the courseware and explain why Jojo likes cloudy days. (Ans: Because she feels that the clouds are amazing because one moment it can look like a horse and the next moment it looks like a sled). Take the children outside, encourage them to observe if there are any clouds on that day.</li>
        </ol>
    </div>
</div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="2">
        <li>Click on the video to observe the clouds changing. Ask the children why the clouds are constantly changing. (Because of the wind.)</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="4">
        <li>Have the children describe the different forms and shapes of clouds which they have seen. Encourage the children to express their ideas.</li>
    </ol>
</div>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="5">
        <li>Guide the children to complete activity 6 in the Thematic Activity Book. Explain to the children that the blue coloured page represents the blue sky. Distribute the cotton and explain that the cotton represents the clouds which look soft like cotton. Have the children know that they are going to use the cotton to make clouds.</li>
        <li>Have the children use the cotton and make them into "clouds" of various shapes before pasting them onto the page.</li>
        <li>Upon completion, have the children display their work and have the others guess what each child has made. Guide the children to appreciate the work of their friends.</li>
    </ol>
</div>
