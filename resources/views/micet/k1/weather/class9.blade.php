...
<div class="phonics-panel flex flex-col justify-start h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="5">
        <li>Ask the children: "What will the weather be like tomorrow?"; "How can we find out about the weather in advance?". Guide the children in understanding about weather forecasts and their uses.</li>
        <li>Have the children name places where they can find a weather forecast. Guide the children in understanding that weather forecasts are available on television, radio, the newspapers and on the internet.</li>
    </ol>
</div>
...
<div class="phonics-panel flex flex-col justify-between h-full items-center space-y-[1vw]">
    ...
    <ol class="list-decimal panel-ul w-[50vw]" start="7">
        <li>Guide the children to complete activity 9 in the Thematic Activity Book. Explain what is needed to complete the table (fill in the weather forecast and the actual weather for the day in the appropriate column). Have the children indicate the weather by using the weather symbols.</li>
        <li>Have the children fill in the actual weather for today and the weather forecast for the next day. This is to be done for a week.</li>
    </ol>
...
<div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
    ...
    <div class="text-start flex flex-col justify-between h-full">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>Have the children compare the weather forecast and the actual weather. Discuss whether the 2 weather conditions are the same after completing the table. Have the children evaluate the accuracy of the weather forecast.</li>
        </ul>
