...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c3.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c4.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c5.png') }}" class="h-[25vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c6.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c7.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c8.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c9.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c10.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c11.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c12.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c13.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c14.png') }}" class="w-[35vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/class5/c19.png') }}" class="h-[22vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="21">
            <li>Distribute the survey forms (or use Thematic Activity Book). Explain the content of the form to the
                children.</li>
        </ol>
        <img src="{{ asset('assets/images/micet/k1/home/class5/c24.png') }}" class="h-[22vw]" />
    </div>
