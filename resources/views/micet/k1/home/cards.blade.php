...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-center h-full items-center">
        <p class="text-[#f7b94a] text-[3.5vw]">home</p>
    </div>
    ...
    {{-- panel 5 --}}
    <div class="phonics-panel flex flex-col justify-center h-full items-center">
        <p class="text-[#f7b94a] text-[3.5vw]">living room</p>
    </div>
    ...
    {{-- panel 5 --}}
    <div class="phonics-panel flex flex-col justify-center h-full items-center">
        <p class="text-[#f7b94a] text-[3.5vw]">dining room</p>
    </div>
    ...
    {{-- panel 5 --}}
    <div class="phonics-panel flex flex-col justify-center h-full items-center">
        <p class="text-[#f7b94a] text-[3.5vw]">kitchen</p>
    </div>
    ...
    {{-- panel 5 --}}
    <div class="phonics-panel flex flex-col justify-center h-full items-center">
        <p class="text-[#f7b94a] text-[3.5vw]">bedroom</p>
    </div>
    ...
    {{-- panel 5 --}}
    <div class="phonics-panel flex flex-col justify-center h-full items-center">
        <p class="text-[#f7b94a] text-[3.5vw]">bathroom</p>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/home/word/c7.png') }}" class="w-[30vw]" />
    </div>
