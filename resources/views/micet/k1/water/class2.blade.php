...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <div class="text-start">
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>Record children's answers on the white board. Guide the children in stating the following key points: <ul class="list-disc">
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="3">
        <li>Have the children discuss where water comes from. Guide the children to understand that water comes from rain. (Click on the video)</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="4">
        <li>Have the children discuss where water comes from. Guide the children to understand that water comes from rivers.</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="7">
        <li>Ask the children: What would happen if you didn't drink water for a day (two days, a week, etc.)? Guide the children to conclude that water is very important for our survival.</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="8">
        <li>Ask the children: What would happen if animals did not have water to drink. Guide them to understand that water is the basic necessity for all animals.</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="11">
        <li>Ask the children: What would happen if plants did not get water. Guide them to understand that water is the basic necessity for all plants.</li>
    </ol>
...
<div class="phonics-panel flex flex-col items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="13">
        <li>Ask the children: Where do fishes and other sea creatures live? What would happen to them if the seas, rivers and lakes dried up? Guide them to understand that water provides the living environment for these creatures.</li>
    </ol>
...
<div class="phonics-panel flex flex-col h-full items-center">
    ...
    <ol class="list-decimal panel-ul w-[45vw]" start="15">
        <li>Have the children discuss the other uses of water. Guide them to understand that water is not only required for our basic survival but also has many other important uses.
             <ul class="list-disc">
