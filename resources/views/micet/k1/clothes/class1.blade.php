...
<div class="phonics-panel flex flex-col justify-start h-full items-center">
    ...
    <div class="flex items-center justify-around w-[45vw]">
        ...
        <div class="flex items-center gap-[0.5vw]">
            <img src="{{ asset('assets/images/micet/n1/toys/b3.png') }}" class="h-[5vw]" />
            <img src="{{ asset('assets/images/micet/n1/toys/b6.png') }}" class="h-[5vw]" />
        </div>
    </div>
</div>
...
<div class="phonics-panel flex flex-col justify-start h-full items-center">
    ...
    <div class="flex items-center justify-between w-[45vw]">
        ...
        <img src="{{ asset('assets/images/micet/n1/toys/b4.png') }}" class="h-[5vw]" />
    </div>
</div>
