...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul w-[45vw]">
            <li>To perform tasks that are appropriate for one's age, develop
                sense of responsibility and independence</li>
            <li>Describe the changes that occur in the process of growing</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center mt-[-4vw]">
        ...
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-left">
                What time do you wake up everyday? Do you wake up by yourself?<br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-left">
                Do you put on your clothes by yourself everyday?<br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-left">
                How does a big brother or big sister behave?<br>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[1vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Ask the children what a big brother or big sister does.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to describe the changes observed in the process of
                    growing.</li>
                <li>Able to describe how we show care towards one's family
                    members and perform tasks that are appropriate to one's age.</li>
            </ul>
        </div>
    </div>
