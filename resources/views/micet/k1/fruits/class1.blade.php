...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">One day, two little white round seeds, Tinny and Whinny, pop out of a <br>
            rubbish bin in the park. They do not know who their mother is. So, they <br>
    ...
    {{-- panel 6 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">Susie Swallow takes them to an orchard. The Little Seeds think that Mrs. <br>
            Banana is their mother, but she tells them that banana seeds are small <br>
    ...
    {{-- panel 7 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">Just then, a fruit fairy appears. She gives five treasure boxes to the Little <br>
            Seeds to help them find their mother. "Do not worry. Have patience <br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center mt-[-3vw]">
        <h3 class="p-title">"Your mummy is round", says the first treasure box. So, the Little Seeds <br>
            find a watermelon. But their mother is not a watermelon because <br>
    ...
    {{-- panel 9 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center mt-[-3vw]">
        <h3 class="p-title">"Your mummy grows on trees", says the second treasure box. So, the <br>
            Little Seeds find an orange. But their mother is not an orange because <br>
    ...
    {{-- panel 10 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">"Your mummy is red", says the third treasure box. So, the Little Seeds <br>
            find an apple. But their mother is not an apple because apples have <br>
            brown seeds.</h3>
        ...
        <div class="flex items-center justify-between w-[45vw]">
            <h3 class="p-title text-left">
                ...
                <span class="text-[#f7b94a]">Encourage the children to eat more fruits as they are a good sourceof
                    vitamins.</span>
            </h3>
            <div class="flex">
    ...
    {{-- panel 11 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">"Your mummy is small", says the fourth treasure box. So, the Little <br>
            Seeds find a rambutan. But their mother is not a rambutan because <br>
            rambutans have big white seeds.</h3>
        <img src="{{ asset('assets/images/micet/k1/fruits/class1/c9.png') }}" class="w-[25vw]" />

        <div class="flex items-center justify-center w-[45vw]">
            <h3 class="p-title text-left">
    ...
    {{-- panel 11 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center mt-[-3vw]">
        <h3 class="p-title">"Your mummy has smooth skin", says the fifth treasure box. So, the <br>
            Little Seeds find a cherry. This time, they find their mother. The fruit fairy <br>
            appears and congratulates them.</h3>
        <img src="{{ asset('assets/images/micet/k1/fruits/class1/c9.png') }}" class="w-[25vw]" />

        <div class="flex items-center justify-center w-[55vw]">
            <h3 class="p-title text-left">
                ...
                <span class="text-[#f7b94a]">Deepen the children's understanding of the story and help them to <br>
