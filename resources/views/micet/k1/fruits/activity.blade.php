...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw] hidden">
        ...
        <div class="text-start">
            ...
            <p class="panel-ul w-[50vw]">Tinny and Whinny are two small seeds looking for their mother. Susie
            ...
            <div class="flex gap-[3vw]">
                ...
                <div class="flex-1 text-white">
                    ...
                    <div class="panel-ul text-[1.05vw]">
                        ...
                        <p><strong>Level 1:</strong> Select the correct fruit that corresponds to the sequence of fruits
                            shown.</p>
                        <p><strong>Level 2:</strong> Select the fruits and put them in the right sequence on the conveyor
                            belt.</p>
                    </div>
                </div>
            </div>
    ...
    {{-- panel 9 --}}
    <div class="phonics-panel flex flex-col items-center h-full hidden">
        <h1 class="panel-title stroke">Computer Activities: The Secret in the Orchard</h1>
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                ...
                <li>Encourage the children to describe the characteristics of some common fruits they know and draw them.
                </li>
            </ul>
