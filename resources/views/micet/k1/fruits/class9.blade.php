...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <h2 class="text-white text-[2vw] mt-[2vw] text-justify">
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <div class="flex items-start gap-[2vw]">
            <button class="w-[3vw] inline-flex items-center align-middle" id="soundButton"
                data-slide-audio="{{ asset('assets/audio/micet/k1/sing-chant.mp3') }}">
                <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
            </button>
            <h2 class="text-white text-[2vw] text-justify">
                In this place of many fruits, <br>
                There are secrets hidden here and there. <br>
                Little seeds searching everywhere,<br>
                For their lost mummy.<br>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <div class="text-start">
            <ol class="list-decimal panel-ul w-[45vw]" start="4">
                <li>Invite the children to listen to the "Watermelon" rap. Let them guess the fruit and describe its
                    characteristics.</li>
            </ol>
        </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <div class="flex items-start gap-[2vw] mt-[3vw]">
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="7">
            <li>Encourage the children to substitute words in the "Watermelon" rap to create other fruit raps, such
                as:
            </li>
        </ol>
        <h2 class="text-white text-[2vw] mt-[3vw] text-justify">
            In this place of many fruits, <br>
            I am the prettiest one of all,<br>
            With a round body, big and bright,<br>
            And dressed in a green patterned robe<br>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                ...
                <li>Able to create a new rap according to the characteristics of a fruit by substituting words in the
                    original rap.</li>
            </ul>
        </div>
    </div>
