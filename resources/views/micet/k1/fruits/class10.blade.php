...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="2">
            <li>Invite the children to a game where they will help the little seeds find their mummies. Tell the children
                that they are going to be given some clues and they have to find the fruit mummy, based on the clues.</li>
            <li>Reveal the clues ,one at a time, to describe the characteristics of a mystery fruit. Guide children to think
                of the possible answers. Let them use their deductive reasoning skills to get to the right answer.</li>
        </ol>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <h2 class="text-white text-[1.5vw] text-justify">
            Fruit I <br>
            Clue I: It is round.
        </h2>
    </div>
...
ga
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="5">
            <li>Reveal the second clue. Guide the children to use the process of elimination: after each clue, eliminate
                fruits that do not meet the criteria.</li>
        </ol>
        <h2 class="text-white text-[1.5vw] text-justify">
            Fruit I <br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="6">
            <li>Reveal the third clue. Guide the children to use the process of elimination: after each clue, eliminate
                fruits that do not meet the criteria.</li>
        </ol>
        <h2 class="text-white text-[1.5vw] text-justify">
            Fruit I <br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="7">
            <li>Reveal the fourth clue. Guide the children to use the process of elimination: after each clue, eliminate
                fruits that do not meet the criteria.</li>
        </ol>
        <h2 class="text-white text-[1.5vw] text-justify">
            Fruit I <br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="8">
            <li>Reveal the fifth clue. Guide the children to use their deductive reasoning skills and come to the final
                answer.</li>
        </ol>
        <h2 class="text-white text-[1.5vw] text-justify">
            Fruit I <br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <div class="flex items-center justify-around w-[45vw]">
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('assets/images/micet/k1/fruits/class10/c2.png') }}" class="w-[20vw]" />
                <h2 class="text-white text-[1.5vw]">(orange)</h2>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <div class="flex items-center justify-around w-[45vw]">
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('assets/images/micet/k1/fruits/class10/c3.png') }}" class="w-[20vw]" />
                <h2 class="text-white text-[1.5vw]">(apple)</h2>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <div class="flex items-center justify-around w-[45vw]">
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('assets/images/micet/k1/fruits/class10/c4.png') }}" class="w-[20vw]" />
                <h2 class="text-white text-[1.5vw]">(grape)</h2>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <div class="flex items-center justify-around w-[45vw]">
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('assets/images/micet/k1/fruits/class10/c5.png') }}" class="w-[20vw]" />
                <h2 class="text-white text-[1.5vw]">(watermelon)</h2>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <div class="flex items-center justify-around w-[45vw]">
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('assets/images/micet/k1/fruits/class10/c6.png') }}" class="w-[20vw]" />
                <h2 class="text-white text-[1.5vw]">(lychee)</h2>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full space-y-[1vw]">
        ...
        <div class="flex items-center justify-around w-[45vw]">
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('assets/images/micet/k1/fruits/class10/c7.png') }}" class="w-[20vw]" />
                <h2 class="text-white text-[1.5vw]">(honey melon)</h2>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Let the children list out five clues of their favourite fruit and then have their friends guess the
                    answer.</li>
            </ul>
