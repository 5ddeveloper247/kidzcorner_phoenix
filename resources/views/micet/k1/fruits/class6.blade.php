...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <div class="flex">
            <img src="{{ asset('assets/images/micet/k1/fruits/class6/c2.png') }}" class="h-[20vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class6/c3.png') }}" class="h-[17vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class6/c4.png') }}" class="w-[25vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class6/c7.png') }}" class="h-[18vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class6/c10.png') }}" class="w-[25vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class6/c11.png') }}" class="h-[15vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class6/c12.png') }}" class="h-[17vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class6/c13.png') }}" class="h-[17vw]" />
    </div>
    ...
    {{-- panel 19 --}}
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        <h1 class="panel-title stroke">Classroom Activity 6: Fruit Family</h1>
