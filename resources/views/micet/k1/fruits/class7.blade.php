...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[5vw]">
        ...
        <ul class="list-disc panel-ul w-[40vw]">
            ...
            <li>Some edible seeds (watermelon seeds, pumpkin seeds, sunflower seeds, peanuts, rice grains, peas, corn
                kernels, walnuts, chestnuts, cashew nuts, pine nuts, almonds)</li>
            <li>Prior to this activity, find out from your children's parents if their child is allergic to any form of
                seeds</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="text-start">
            ...
            <ol class="list-decimal panel-ul w-[50vw]">
                <li> Display the edible seeds one by one. Encourage the children to answer the given questions and talk
                    about the information provided.</li>
            </ol>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="2">
            <li>Display the edible seeds one by one. Encourage the children to answer the given questions and talk about the
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            <li>These are watermelon seeds. We usually eat them cooked, without the shells.</li>
        </ol>
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c4.png') }}" class="h-[18vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="4">
            <li>Watermelon seeds come from the watermelon vine. The vines bear the watermelon fruit. The seeds are inside
                the watermelon fruit.</li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c2.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c8.png') }}" class="h-[16vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c12.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c13.png') }}" class="h-[17vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c14.png') }}" class="h-[18vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c18.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c19.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c15.png') }}" class="w-[15vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c22.png') }}" class="h-[18vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c24.png') }}" class="w-[20vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c25.png') }}" class="w-[20vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c26.png') }}" class="h-[14vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c28.png') }}" class="h-[14vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c24.png') }}" class="w-[18vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c30.png') }}" class="w-[28vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c30.png') }}" class="w-[18vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c31.png') }}" class="w-[18vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="20">
            <li>Peas come from the pea plant. The plant bears the pea pods. Peas are the seeds found inside the pea pods.
            </li>
        </ol>
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c27.png') }}" class="h-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c29.png') }}" class="h-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c30.png') }}" class="w-[18vw]" />
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c32.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            ...
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c35.png') }}" class="w-[15vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c36.png') }}" class="h-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c37.png') }}" class="h-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c33.png') }}" class="h-[13vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c38.png') }}" class="h-[20vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c34.png') }}" class="h-[20vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c39.png') }}" class="h-[17vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c39.png') }}" class="h-[14vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c42.png') }}" class="h-[14vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="27">
            <li>Walnuts come from the Walnut tree. The tree bears the walnut fruit. The seeds are found inside the fruit.
            </li>
        </ol>
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c46.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c43.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c41.png') }}" class="w-[15vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c49.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c49.png') }}" class="w-[18vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c55.png') }}" class="w-[18vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c47.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c44.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c49.png') }}" class="w-[15vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c52.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c52.png') }}" class="w-[20vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c56.png') }}" class="w-[20vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c48.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c45.png') }}" class="w-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c52.png') }}" class="w-[15vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c58.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c58.png') }}" class="h-[15vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c57.png') }}" class="w-[22vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c59.png') }}" class="h-[17vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c61.png') }}" class="h-[17vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c58.png') }}" class="w-[15vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c63.png') }}" class="w-[27vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c63.png') }}" class="w-[22vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c66.png') }}" class="w-[22vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="39">
            <li>Almonds come from the Almond tree. The tree bears the Almond fruit. The almonds, which are the seeds, are
                found inside a hard shell, in the fruit.</li>
        </ol>
        <div class="flex flex-row items-center justify-center gap-[1vw]">
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c60.png') }}" class="h-[17vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c62.png') }}" class="h-[17vw]" />
            <svg class="w-[3vw] h-[3vw]" viewBox="0 0 100 100">
                <polygon points="25,15 85,50 25,85" fill="#f5af23" />
            </svg>
            <img src="{{ asset('assets/images/micet/k1/fruits/class7/c66.png') }}" class="w-[15vw]" />
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="40">
            <li>Ask the children to identify the various edible seeds in the picture. Ask them if they have ever eaten them
            </li>
        </ol>
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c64.png') }}" class="w-[27vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class7/c65.png') }}" class="w-[27vw]" />
    </div>
