...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class5/c4.png') }}" class="h-[23vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class5/c7.png') }}" class="h-[23vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/k1/fruits/class5/c8.png') }}" class="h-[20vw]" />
    </div>
