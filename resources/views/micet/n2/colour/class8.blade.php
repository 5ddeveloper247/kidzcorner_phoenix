...
<div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
    ...
    <img src="{{ asset('assets/images/micet/n2/colour/class8/c5.png') }}" class="w-[35vw] h-[15vw]" />
</div>
...
<div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
    ...
    <img src="{{ asset('assets/images/micet/n2/colour/class8/c6.png') }}" class="w-[20vw] h-[16vw]" />
</div>
...
<div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
    ...
    <img src="{{ asset('assets/images/micet/n2/colour/class8/c7.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
    ...
    <img src="{{ asset('assets/images/micet/n2/colour/class8/c8.png') }}" class="w-[25vw]" />
</div>
...
<div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[2vw]">
    ...
    <img src="{{ asset('assets/images/micet/n2/colour/class8/c9.png') }}" class="w-[25vw]" />
</div>
