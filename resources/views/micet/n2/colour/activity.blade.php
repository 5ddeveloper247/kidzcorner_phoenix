...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="text-start">
            ...
            <p class="panel-ul w-[50vw]">
                Every one of the Rainbow Fairies is very beautiful. However, they
        ...
        <div class="flex gap-[2vw]">
            ...
            <div class="text-start">
                ...
                <ul class="panel-ul w-[30vw]">
                    ...
                    <li>Level one: Children listen and then fill a space with
                        red, yellow or blue accordingly.Children
                        will be given a hint if the colour is wrong
                        and rewarded with an animation if correct.
                    </li>
                    <li>Level two: Children mix primary colours to obtain a
                        secondary colour. They add to the given
                        colour to obtain the required colour.</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="flex gap-[1vw]">
            ...
            <div class="text-start">
                ...
                <ul class="panel-ul w-[30vw]">
                    <span>There are 2 levels of difficulties in this game.</span>
                    <li>Level one: <span>Children match and click on
                            butterflies of one colour.</span>
                    </li>
                    <li>Level two: <span> Children match and click on
                            butterflies with the same
                            colours and patterns.</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full ">
        ...
        <div class="text-start flex flex-col justify-center h-full">
