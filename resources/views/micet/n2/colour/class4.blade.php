...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <video class="h-[20vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/colour/class4/v2.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-flow">
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c11.png') }}" class="h-[19vw]" />
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c12.png') }}" class="h-[19vw]" />
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-flow">
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c11.png') }}" class="h-[19vw]" />
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c13.png') }}" class="h-[19vw]" />
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-flow">
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c11.png') }}" class="h-[19vw]" />
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c14.png') }}" class="h-[19vw]" />
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-flow">
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c11.png') }}" class="h-[19vw]" />
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c15.png') }}" class="h-[19vw]" />
        </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <div class="flex flex-flow">
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c11.png') }}" class="h-[19vw]" />
            <img src="{{ asset('assets/images/micet/n2/colour/class4/c16.png') }}" class="h-[19vw]" />
        </div>
