...
<div class="phonics-panel flex flex-col justify-between h-full items-center">
    ...
    <div class="flex flex-center">
        <img src="{{ asset('assets/images/micet/n2/colour/class3/c1.png') }}" class="h-[12vw]" />
        <img src="{{ asset('assets/images/micet/n2/colour/class3/c2.png') }}" class="h-[11.5vw] w-[10.5vw]" />
        <img src="{{ asset('assets/images/micet/n2/colour/class3/c3.png') }}" class="h-[12vw]" />
    </div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c4.png') }}" class="w-[22vw]"></div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c5.png') }}" class="w-[25vw]"></div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[1vw] items-center h-full">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c6.png') }}" class="w-[25vw]"></div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[2vw] justify-start h-full items-center">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c7.png') }}" class="w-[25vw]"></div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[2vw] justify-start h-full items-center">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c8.png') }}" class="w-[22vw]"></div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[2vw] justify-start h-full items-center">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c9.png') }}" class="w-[32vw]"></div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[2vw] justify-start h-full items-center">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c10.png') }}" class="w-[25vw] h-[17vw]"></div>
</div>
...
<div class="phonics-panel flex flex-col space-y-[2vw] justify-start h-full items-center">
    ...
    <div class="justify-center justify-items-center"><img src="{{ asset('assets/images/micet/n2/colour/class3/c11.png') }}" class="w-[25vw] h-[17vw]"></div>
</div>
