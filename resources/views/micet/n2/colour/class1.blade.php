...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <div class="flex items-center">
            ...
            <img src="{{ asset('assets/images/micet/n2/colour/class1/c3.png') }}" class="h-[7vw]" />
        ...
        <ul class="list-disc panel-ul">
            <li>To be aware of the beautiful colours around us </li>
            <li>To learn the names of the seven colours of a rainbow </li>
            <li>To find out more about rainbows </li>
            <li>To see the need to work as a team </li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">Each of the rainbow fairies thinks that she is the most beautiful. <br>
            They invite Mr Sun to be the judge.</h3>
        <img src="{{ asset('assets/images/micet/n2/colour/class1/c6.png') }}" class="w-[30vw]" />

        <div class="flex items-center justify-center w-full gap-[3vw]">
    ...
    {{-- panel 6 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">Red Fairy takes everyone to a place where the people are celebrating <br>
            Chinese New Year. Almost everything is red, even the mandarin oranges! <br>
        ...
        <div class="flex items-center justify-around w-full">
            ...
            <div class="flex">
                <img src="{{ asset('assets/images/micet/n1/toys/b7.png') }}" class="w-[3.5vw]" />
                <img src="{{ asset('assets/images/micet/n1/toys/b6.png') }}" class="w-[3.5vw]" />
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center mt-[-3vw]">
        <h3 class="p-title">Orange Fairy takes everyone to an orchard. The mandarin oranges and <br>
            orange peais look so delicious that all the fairies want to eat them. <br>
            Unhappy Yellow Fairy says that peais should be yellow.</h3>
        <img src="{{ asset('assets/images/micet/n2/colour/class1/c8.png') }}" class="w-[28vw]" />

        <div class="flex items-center justify-center w-full">
            <h3 class="p-title text-left">
                Which 2 colours make orange? <br>
                <span class="text-[#f7b94a]">Children recoll the c'her 2 secondary colours and how these colours are <br>
                    obtained.</span>
            </h3>
            <div class="flex">
                <img src="{{ asset('assets/images/micet/n1/toys/b6.png') }}" class="w-[3.5vw]" />
    ...
    {{-- panel 8 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">Yellow Fairy takes everyone to a desert. The cactus flowers, the sand <br>
            and even the trees are yellow. Unhappy Green Fairy says that trees <br>
            should be green.</h3>
    ...
    {{-- panel 9 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">Green Fairy takes everyone to a big green forest. There they see <br>
            morning glory crying sadly. Unhappy Violet Fairy says that the morning <br>
            glory should be violet and quickly turns it back to violet.</h3>
        <img src="{{ asset('assets/images/micet/n2/colour/class1/c10.png') }}" class="w-[27vw]" />

        <div class="flex items-center justify-between w-full">
            <h3 class="p-title text-left">
                Why did the moming glory cry? <br>
                <span class="text-[#f7b94a]">Children relate instances when they have cried. Help children be <br>
                    sensitive to the feelings of others.</span>
            </h3>
            <img src="{{ asset('assets/images/micet/n2/colour/class1/b1.png') }}" class="w-[3.5vw]" />
            <img src="{{ asset('assets/images/micet/n2/colour/class1/b2.png') }}" class="w-[3.5vw]" />
        </div>
    </div>
    ...
    {{-- panel 10 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">Violet Fairy takes everyone to a big field. The colour of the flowers, <br>
            grapes, eggplants, butterflies and even the sky is violet. Unhappy Blue Fairy says <br>
            that the sky should be blue.</h3>
        <img src="{{ asset('assets/images/micet/n2/colour/class1/c11.png') }}" class="w-[28vw]" />
        ...
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n2/colour/class1/b3.png') }}" class="w-[3.5vw]" />
                <img src="{{ asset('assets/images/micet/n2/colour/class1/b4.png') }}" class="w-[3.5vw]" />
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/colour/class1/c12.png') }}" class="w-[28vw]" />
        ...
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n2/colour/class1/b5.png') }}" class="w-[3.5vw]" />
                <img src="{{ asset('assets/images/micet/n2/colour/class1/b6.png') }}" class="w-[3.5vw]" />
            </div>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/colour/class1/c13.png') }}" class="w-[27vw]" />
        ...
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center">
                <img src="{{ asset('assets/images/micet/n2/colour/class1/b7.png') }}" class="w-[3.5vw]" />
                <img src="{{ asset('assets/images/micet/n2/colour/class1/b8.png') }}" class="w-[3.5vw]" />
            </div>
        </div>
    </div>
    ...
    {{-- panel 13 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        <h3 class="p-title">He says that it is very beautiful when we can see many different colours. <br>
            So the Rainbow Fairies must always be together to be really beautiful.</h3>
        <img src="{{ asset('assets/images/micet/n2/colour/class1/c14.png') }}" class="w-[27vw]" />
