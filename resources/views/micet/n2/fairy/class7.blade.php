...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center h-full">
        ...
        <h4 class="text-white text-start text-[1.5vw]">
            Doll and bear are dancing together, dancing, dancing, I, 2, 3. <br>
 ...
 <br>
        <h4 class="text-white text-start text-[1.5vw]">
            ...
            Let us join the dance together, dancing, dancing, I, 2, 3.
        </h4>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <button class="w-[3.5vw] mt-[3vw] inline-flex items-center align-middle" id="soundButton"
            data-slide-audio="{{ asset('assets/audio/micet/n2/sing-clap.mp3') }}">
            <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
        </button>
    </div>
