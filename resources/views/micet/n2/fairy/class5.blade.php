...
@section('content')
    ...
    <div class="phonics-panel flex flex-col items-center h-full mt-[-3vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            ...
            <li>Invite the children to sing the song along with the teacher.
        ...
        <h4 class="text-white text-start text-[1.5vw]">Doll and bear are dancing together, dancing, dancing, I, 2, 3. <br>
            They are dancing in a circle, dancing, dancing, I, 2, 3. <br>
            Little bear is nodding its head, nodding, nodding, I, 2, 3. <br>
            Little doll is laughing merrily, laughing, laughing, ha, ha, ha.
        </h4>
        <br>
        <h4 class="text-white text-start text-[1.5vw]">Doll and bear are dancing together, dancing, dancing, I, 2, 3. <br>
    ...
    <div class="phonics-panel flex flex-col items-center h-full mt-[-3vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="5">
            ...
            <li>Let the children sing and dance to the song.
                ( Note: Don't sing during the prelude part of the tune.)
                <button class="w-[3vw] inline-flex items-center align-middle" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/micet/n2/sing-clap.mp3') }}">
                    <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
