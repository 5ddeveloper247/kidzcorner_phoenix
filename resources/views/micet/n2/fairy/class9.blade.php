...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <div class="flex flex-col">
            <img src="{{ asset('assets/images/micet/n2/fairy/class9/c3.png') }}" class="h-[9vw]" />
            <img src="{{ asset('assets/images/micet/n2/fairy/class9/c4.png') }}" class="h-[9vw]" />
        </div>
    </div>
    ...
    {{-- panel 3 --}}
    <div class="phonics-panel flex flex-col justify-start h-full items-center mt-[-2vw]">
        <h1 class="panel-title stroke">Classroom Activity 9: Tell a Story</h1>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fairy/class9/c5.png') }}" class="h-[20vw]" />
