...
@section('content')
    ...
    <div id="slide-board" class=" home grid grid-cols-4 gap-[2vw] mb-[2vw]">
        ...
        <a href="{{ url('/micet/n2/nutrition/index') }}">
        ...
        <a href="{{ url('/micet/n2/colours/index') }}">
    ...
    <div id="slide-board" class="first grid grid-cols-4 gap-[2vw] mb-[2vw] hidden">
        ...
        <a href="{{ url('/micet/n2/drama/index') }}">
        ...
        <a href="{{ url('/micet/n2/toys/index') }}">
        ...
        <a href="{{ url('/micet/n2/games/index') }}">
...
@push('script')
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const savedSlide = sessionStorage.getItem("micet_n2_slide");
            const cameFromLesson = sessionStorage.getItem("micet_n2_from_lesson");
            ...
            sessionStorage.removeItem("micet_n2_slide");
            sessionStorage.removeItem("micet_n2_from_lesson");
            ...
            document.querySelectorAll("#slide-board a").forEach(link => {
                link.addEventListener("click", () => {
                    sessionStorage.setItem("micet_n2_slide", currentSlide);
                    sessionStorage.setItem("micet_n2_from_lesson", "1");
                });
            });
