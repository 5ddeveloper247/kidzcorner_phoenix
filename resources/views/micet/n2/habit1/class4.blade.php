...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="5">
            <li>Play the song "Beautiful Butterflies". Have the children describe what the
                butterflies in the song look like.
                <button class="w-[3vw] inline-flex items-center align-middle" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/micet/n2/butterfly.mp3') }}">
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="6">
            <li>Have the children repeat the lyrics after the teacher and sing the song when
                they are familiar with the words.<button class="w-[3vw] inline-flex items-center align-middle"
                    id="soundButton" data-slide-audio="{{ asset('assets/audio/micet/n2/butterfly.mp3') }}">
                    <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                </button>
            </li>
        </ol>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="7">
            <li> Have the children sing the song and dance like the butterflies when gathering
                pollen and gathering nectar among flowers.
                <button class="w-[3vw] inline-flex items-center align-middle" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/micet/n2/butterfly.mp3') }}">
                    <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                </button>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Have the children draw the butterflies and dragonflies that
                    they have seen.</li>
            </ul>
        </div>
    </div>
