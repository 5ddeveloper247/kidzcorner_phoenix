...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul">
            <li>Learn to sing three songs</li>
            <li>Learn to do actions for the songs</li>
            <li>Further understand the characteristics of various fruits</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="2">
            <li>Ask the children to describe bananas. (For example: Bananas grow in a bunch;
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class7/c1.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="5">
            <li>Ask children to describe the watermelons. (For example, watermelons are
                round and big; their skin is green and the flesh is red or yellow.)</li>
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class7/c2.png') }}" class="h-[16vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <h4 class="text-white text-[2.2vw] text-start mt-[2vw]">
            ...
            durian. <br>
            Some of us grow on the ground, <br>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class7/c7.png') }}" class="w-[25vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class7/c8.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col justify-start h-full items-center space-y-[1vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="16">
            <li>Guide the children to create simple actions for the three songs. For example,
                for the line ' We are bananas that come in combs'- let the children stand in a
                row and hold each other's hands ; for the line 'I am an enormous
                watermelon'- let the children sit on the floor and curve their body to form a ball
                shape; for the line 'We are fruits that grow on trees'- let the children hold on to
                the teacher's arm, imagining the teacher to be the tree and they as the fruits.
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Let the children sing the songs and do the actions together.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to sing the three songs.</li>
                <li>Able to do actions for the songs.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full space-y-[2vw]">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Guide the children to substitute the lyrics of the songs with
                    other fruit names and sing the new songs.</li>
            </ul>
        </div>
    </div>
