...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul">
            <li>Identify some common fruits and know their characteristics</li>
            <li>Learn to count up to ten</li>
            <li>Compare sizes of fruits</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c3.png') }}" class="w-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c4.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c5.png') }}" class="w-[25vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c6.png') }}" class="w-[25vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c7.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c8.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c9.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c10.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c11.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c12.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c13.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c14.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c15.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c16.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c17.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c18.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c19.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/fruits/class2/c20.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <ol class="list-decimal panel-ul w-[45vw]" start="2">
            <li>Ask children to draw one small fruit and one big fruit (on a plain paper or in the
    ...
    <div class="phonics-panel flex flex-col items-center h-full">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Invite children to display their drawings and point out the big
                    and the small fruits.</li>
            </ul>

            <h3 class="ptitle">Evaluation</h3>

            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to name some common fruits and describe their
                    characteristics.</li>
                <li>Able to count the number of fruits accurately.</li>
                <li>Able to differentiate between the sizes of fruits.</li>
                <li>Able to draw one small fruit and one big fruit.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Encourage children to observe and compare the size of
                    different objects in the classroom or at home.</li>
            </ul>
        </div>
    </div>
