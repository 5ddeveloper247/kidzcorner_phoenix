...
@section('content')
    ...
    {{-- panel 5 --}}
    <div class="phonics-panel flex flex-col h-full items-center mt-[-3vw]">
        <h1 class="panel-title stroke">Classroom Activity 4: Let’s Exercise</h1>
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="3">
            ...
            <li>Ask children if they know how to sing the song. Invite those who know the
                song to sing along and teach the other children.
        ...
        <h4 class="text-white text-[1.8vw] text-start leading-[2.4vw]">
    ...
    <div class="phonics-panel flex flex-col h-full items-center mt-[-3vw]">
        ...
        <ol class="list-decimal panel-ul w-[50vw]" start="5">
            <li>Let children think of suitable actions for each sentence (e.g. tilt the neck up
                and down, side to side, twist the hips, stretch the legs, jump, run).
                <button class="w-[3vw] inline-flex items-center align-middle" id="soundButton"
                    data-slide-audio="{{ asset('assets/audio/micet/n2/partner.mp3') }}">
                    <img src="{{ asset('assets/images/phonicsl1/global/btns/sound-btn.png') }}" />
                </button>
