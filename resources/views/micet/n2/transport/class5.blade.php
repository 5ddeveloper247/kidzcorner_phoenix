...
@section('content')
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/transport/class5/c1.png') }}" class="w-[23vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/transport/class5/c2.png') }}" class="w-[28vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/transport/class5/c3.png') }}" class="h-[20vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[20vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v1.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[20vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v2.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v3.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v4.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v5.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v6.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v7.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v8.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v9.mp4') }}" type="video/mp4">
        </video>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <video class="h-[18vw] cursor-pointer" loop playsinline onclick="this.paused ? this.play() : this.pause();">
            <source src="{{ asset('assets/images/micet/n2/transport/class5/v10.mp4') }}" type="video/mp4">
        </video>
    </div>
