...
@section('content')
    ...
    <div class="phonics-panel flex flex-col justify-between h-full items-center">
        ...
        <ul class="list-disc panel-ul">
            ...
            <li>Improve verbal communication skills</li>
        </ul>
    </div>
    ...
    <div class="phonics-panel flex flex-col h-full items-center">
        ...
        <img src="{{ asset('assets/images/micet/n2/animals/class2/c1.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full">
        ...
        <img src="{{ asset('assets/images/micet/n2/animals/class2/c4.png') }}" class="w-[30vw]" />
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full">
        ...
        <div class="text-start flex flex-col justify-between h-full">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Invite the children to use their imagination and talk about what
                    the dolphins are performing. Encourage them to describe in
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Able to count.</li>
                <li>Able to compare the number of objects in the two sets.</li>
                <li>Able to use complete sentences to describe a picture.</li>
            </ul>
        </div>
    </div>
    ...
    <div class="phonics-panel flex flex-col items-center h-full">
        ...
        <div class="text-start flex flex-col">
            ...
            <ul class="list-disc panel-ul w-[45vw]">
                <li>Increase the number of sets of objects for the activity, for
                    example, 2 pieces of blue wooden blocks, 3 pieces of red
                    wooden blocks and 4 pieces of yellow wooden blocks.
                    Guide the children to explore the concept of "most" and
                    "least" by comparing the number of objects in the sets.</li>
            </ul>
        </div>
    </div>
